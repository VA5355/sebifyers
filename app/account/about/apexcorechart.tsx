...
import React ,  { useEffect } from 'react';
 ...
 //import {StockChartController }  from './StockChartController'
...
return (
 ...
 /*   <div id="chart-container" className="apexstock-theme-light" style={{ backgroundColor: `rgb(255, 255, 255)` }}>

              <div className="apexstock-toolbar" style ={{backgroundColor: `rgb(255, 255, 255)` , color: `rgb(51, 51, 51)`, borderColor: `rgb(233, 236, 239)` }}> 
*/
