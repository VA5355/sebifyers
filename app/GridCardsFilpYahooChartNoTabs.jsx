        ...
        <div className="w-full max-w-8xl mx-auto">
                    {hasChart ? (
                      ...
                      <div className="flex justify-center gap-2 border-b border-gray-300 mb-4"> 
                        ...
                        {/* --- Responsive Trial Button Section --- */}
                        <div className="w-[440px] flex flex-col items-center justify-center my-8 px-4">
                          <motion.div 
                          ...
                          >
                            {/* Top Label */}
                            <span className="bg-brandblue text-white text-base md:text-lg font-semibold rounded-lg px-4 py-2 shadow-md">
                            ...
                            <div className="w-full max-w-[320px] sm:max-w-none">
                              <button 
                                ...
                                className="bg-brandgreenlight group hover:bg-white border border-transparent hover:border-brandgreen transition-all duration-300 rounded-full py-2 px-4 flex items-center justify-center flex-wrap gap-2 shadow-sm"
                              >
                                <span className="text-brandgreen text-xs md:text-sm font-bold uppercase tracking-tight">
                                  Trial with Fyers ::
                                </span>
                                <span className="bg-brandblue px-3 py-1 text-white text-sm md:text-base font-bold rounded-lg group-hover:scale-105 transition-transform">
                                  Reasonable rates
                                </span>
                              </button>
                            </div>
                        ...
                        {finalQuote && (
                          <>   
                            <GridCardsQuoteView inRenderData ={inRenderData} inSymbol={inSymbol}/>
                       {/*      <div>
                    <ul className="view_list">
                        ...
                        {/*   <QuoteView quote={finalQuote} />*/} </>
                        )}
                       

                  { isKYCOpen && (<RefinedKYCModal 
                      isOpen={isKYCOpen} 
