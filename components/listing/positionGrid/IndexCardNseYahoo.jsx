...
const IndexCardNseYahoo = ({ spanId ,  statusId ,label, data, colorClass, onClickIn ,isActiveIn ,timeId="sensex-time", name, value, change }) => {
  const isUp = change >= 0;
  return (
    ...
    >
      <div className="flex justify-between items-start mb-1">
        <span className="text-xl font-bold text-slate-500 dark:text-slate-400 tracking-widest uppercase">
          {label}
        </span>
...
export default IndexCardNseYahoo;