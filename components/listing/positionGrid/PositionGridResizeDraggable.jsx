...
import React, {Suspense, useEffect , useState,useMemo, useRef, act } from "react";
 ...
 * Uses useDragControls to ensure the drag handle (header) works 
 * independently of the CSS resize handle.
 */
const ResizableDraggableCard = ({ title, children, defaultWidth = "280px", defaultHeight = "200px", className = "" }) => {
  ...
  return (
    <motion.div
      ...
      dragMomentum={false}
      dragListener={false} // Prevents clicking the content from starting a drag
      className={`relative bg-white dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-slate-800 shadow-sm flex flex-col group ${className}`}
      style={{ 
        width: defaultWidth, 
      ...
      whileDrag={{ zIndex: 50, cursor: 'grabbing', boxShadow: '0 20px 25px -5px rgb(0 0 0 / 0.1)' }}
    >
      {/* Header / Drag Handle */}
      <div 
        onPointerDown={(e) => controls.start(e)}
        className="flex items-center justify-between px-3 py-2 border-b border-slate-100 dark:border-slate-800 bg-slate-50/80 dark:bg-slate-900/80 cursor-grab active:cursor-grabbing select-none"
      >
        <div className="flex items-center gap-2">
      ...
      {/* Content Area - Clips content if card is too small */}
      <div className="flex-1 p-3 overflow-hidden select-text">
        {children}
      </div>

      {/* Visual Resize Indicator (Bottom Right) */}
      <div className="absolute bottom-0.5 right-0.5 pointer-events-none opacity-40 group-hover:opacity-100 transition-opacity">
        <Scale className="w-3 h-3 rotate-90 text-slate-400" />
      </div>
    </motion.div>
  );
};
...
const PositionGridResizeDraggable = ({   positionDataB   }) => {
  ...
  return (
   ...
   {/*  <div className="hidden md:flex relative items-center">
       ...
       {/* Real-time Indices Ticker   colorClass={`${colorSENSEXClass}`} */}
        ...
        <div className="relative flex flex-wrap gap-4 items-start min-h-[90vh]">
           <ResizableDraggableCard title="SENSEX" defaultWidth="260px" defaultHeight="160px">
          ...
          <ResizableDraggableCard title="BANKNIFTY" defaultWidth="260px" defaultHeight="160px">
         ...
         <ResizableDraggableCard title="NIFTY 50" defaultWidth="260px" defaultHeight="160px">
        ...
        {/* <br/>
          <div className="flex justify-end ">  
            <div  className="flex justify-between  gap-x-4 items-center"> 
                ...
                <div className="flex justify-end">   */ }   
                {/* SECTION 3: QUICK ORDER BOOK (Smaller side panel) */}
        <div className="col-span-12 md:col-span-4">
              <ResizableDraggableCard title="Quick Order Book" defaultWidth="320px" defaultHeight="280px">
        ...
        */} {/*  min-h-screen*/}
        ...
        <div className="col-span-12 lg:col-span-7">
           <ResizableDraggableCard title="Option Chain Analysis" defaultWidth="1200px" defaultHeight="300px"> 
      ...
      {/* SECTION 5: POSITIONS (Bottom or Side) */}
        <div className="col-span-12 lg:col-span-5"> 
          <ResizableDraggableCard title="Open Positions" defaultWidth="950px" defaultHeight="220px">
...
export default PositionGridResizeDraggable;
