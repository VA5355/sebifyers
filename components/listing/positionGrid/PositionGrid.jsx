...
import { startFyersIndicesProviderSocketIO  } from "./loginFeed.actions";
...
import { FyersIndicesSoketProvider } from '@/providers/FyersIndicesSoketProvider';
...
const PositionGrid = ({   positionDataB   }) => {
 ...
 // SET the default INDICES 
  ...
  if (socket && socket.connected) {
    console.log("PostionGrid FyersIndiceSoketProvider Socket ready ✅");
  }
}, [socket]); 
                  ...
                  //      console.log("fyers login called ");
                    ...
                    //            console.log("User is Authorized ");
                                ...
                                if(socket !== undefined && socket !== null){
                                   console.log("Starting Fyers Indices feed");
                                   ...
                                   console.log("FyersIndicesSoketProvider socket not available");

                                }

                               clearInterval(globalUserCheck);
                               dispatch(startEventSource(false , tickerMap,callBackFeedData));
                               dispatch( startFyersIndicesProviderSocketIO(false , socket , callBackFeedData));
                 ...
                 //    console.log("fyers login called ");
                    ...
                    res.then((values) => {
                        StorageUtils._save(CommonConstants.fyersToken,values)
                          if(socket !== undefined && socket !== null){
                                   console.log("Popup center Starting Fyers Indices feed");
                                      socket.emit("start_feed", {
                                      accessToken: auth_code,
                                      tickers: [ "BSE:SENSEX-INDEX",
                                          "NSE:NIFTY50-INDEX",
                                   ...
                                   console.log("Popup center FyersIndicesSoketProvider socket not available");
