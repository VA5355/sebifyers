...
const handleDeskClosePosition = (row, e) => {
  ...
  // USE dispatch to show the Exit Position Dialog from ModalService 
  // ccannot pass setters / callbacks / functions in the dispatch function in the form of payload 
  // will have to discard the approach
  /* dispatch(modalShow({ title: 'Exit Position', message: ` `, payload : {
        modalType: 'existposition',
        showSymbolModal: "", 
        symAvgPrice: avgPrice , 
        boughtQty:  netQty, 
        qtySold :  netQty, 
        setButtonSell : true, 
        ...
        productMode: "MARGIN",
        orderType: "LIMIT",
        positionQuantity : netQty,
        setShowSymbolModal : setShowSymbolModal,
        setIsScheduled : setIsScheduled,
        setSelectedSymbol : setSelectedSymbol,
        setIsVisible : setIsVisible,
        sellPlusSymbol: symbol,
        isScheduled: isScheduled,
        isVisible : true,
        selectedSymbol : selectedSymbol,
        dispatchSellSelected :dispatchSellSelected,
         lotSize :lotSize,
...
// <div className="relative flex flex-col sm:flex-row p-1 bg-gray-100/80 rounded-xl gap-1">
  return (
   ...
   <>
        ...
        {/* TAB NAVIGATION */}
        {/*   Position Label or Live Streaming Label  */}
          {tabs.map((tab) => {
            ...
            return (
              ...
              >
                ...
                {/* Content stays above the background pill z-10*/}
        ...
        <div className="static  inset-0 mt-6 min-h-[300px] z-[-10] px-2">
