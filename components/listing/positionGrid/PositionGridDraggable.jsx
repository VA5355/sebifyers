...
const PositionGridDraggable = ({   positionDataB   }) => {
   ...
   {/*  <div className="hidden md:flex relative items-center">
      ...
      {/* SECTION 2: INDEX CARDS (Draggable) */}
        ...
        <div className="col-span-12 md:col-span-4">
             <DraggableCard title="Quick Order Book" className="h-full min-h-[150px]"> 
        ...
        */} {/*  min-h-screen*/}
        ...
        <div className="col-span-12 lg:col-span-7">
          <DraggableCard title="Option Chain Analysis">    
      ...
      {/* SECTION 5: POSITIONS (Bottom or Side) */}
        <div className="col-span-12 lg:col-span-5"> 
            <DraggableCard title="Active Positions"> 
...
export default PositionGridDraggable;
