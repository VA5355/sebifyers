...
const FetchChart = ({ item, onSelect }: any) => {
    ...
    const fetchChart = async (symbol: string) => {
        ...
        try {
            ...
            const res = await fetch(
                `https://feedsmain.onrender.com/api/equity/${symbol}`
            );
                    ...
                    <div className="w-[120px] h-[60px]">
                        {loadingChart ? (
                            <p className="text-xs">Loading...</p>
                             ...
                             <button  className={`  bg-brandgreen  p-1 px-3  transition-all rounded-full mx-2 dark:bg-white`} >
