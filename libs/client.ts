...
const FYERSAPIGETCQUOTE = 'https://onedinaar.com/.netlify/functions/netlifystockfyersticker/api/fyersgetquote'
...
const FYERSPYTONAPIBASEMONGO = 'https://fyers-auto-register-onedinaar.onrender.com'
...
const RAZORORDERANDPAYMENTURL="https://onedinaar.com"; // `https://192.168.1.5:8888`;
