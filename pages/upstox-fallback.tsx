...
export default function UpstoxFallback(props: Props) {
  ...
  useEffect(() => {
    ...
    try {
      if (!auth_code) {
        window.location.replace("/upstox-auth-dialog");
        return;
      }
        ...
        >
          ...
          >
            <CheckCircle className="w-16 h-16 text-brandgreen-500" />
              ...
              <h1  className="text-2xl font-bold mt-4 text-brandgreen--800">UPSTOX LOGGED IN</h1>
