...
export default function UpstoxAuthDialog({ clientId, redirectUri }: Props) {
...
/*
   ...
   */
      // 🟢 First-time OAuth initiation encodeURIComponent(redirectUri)
     // localStorage.setItem("upstox-auth-attempted", "true");
      ...
      const params = new URLSearchParams({
        ...
        response_type: "code",  // must be always code 
