(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
    [1298], {
        ...
        185934: (e, o, t) => {
            ...
            function a(e, o = 2, t) {
                return l(r().logo, r()[e], t, 0 === o || 1 === o ? l(i.skeletonTheme.wrapper, r().skeleton) : r().letter, 1 === o && i.skeletonTheme.animated)
            }
        ...
        718736: (e, o, t) => {
            "use strict";
            t.d(o, {
                useFunctionalRefObject: () => n
            });
            var l = t(50959),
                i = t(855393);

            function n(e) {
                const o = (0, l.useMemo)((() => function(e) {
                        const o = t => {
                            e(t), o.current = t
                        };
                    ...
                    a = (0, l.useRef)(n);
                return a.current = n, (0, i.useIsomorphicLayoutEffect)((() => {
        ...
        778199: (e, o, t) => {
            ...
            function l(e, o, t, l, i) {
                ...
                return i.click && l.addEventListener("click", n, !1), i.mouseDown && l.addEventListener("mousedown", n, !1), i.touchEnd && l.addEventListener("touchend", n, !1), i.touchStart && l.addEventListener("touchstart", n, !1), () => {
                    l.removeEventListener("click", n, !1), l.removeEventListener("mousedown", n, !1), l.removeEventListener("touchend", n, !1), l.removeEventListener("touchstart", n, !1)
                }
            }
            t.d(o, {
                addOutsideEventListener: () => l
            })
        },
        183787: (e, o, t) => {
            "use strict";
        ...
        361701: (e, o, t) => {
            ...
            function a(e) {
                ...
                return (0, l.useEffect)((() => n(r.current ? .complete ? ? !o ? 2 : 1)), [o]), o && 3 !== t ? l.createElement("img", {
                    ref: r,
                    className: a,
                    crossOrigin: "",
                    src: e.logoUrl,
        ...
        297265: (e, o, t) => {
            ...
            const i = (e, o = !1, t = []) => {
                ...
                return (o ? l.useLayoutEffect : l.useEffect)((() => {
                    if (i) {
                        a(i.value());
                        const e = e => a(e);
        ...
        192063: (e, o, t) => {
            ...
            function v(e) {
                const {
                    ...
                    trackRightClick: _,
                    ...G
                } = e, $ = (0, l.useRef)(null), X = (0,
                    l.useMemo)((() => function(e) {
                    function o(o) {
                        const {
                            reference: t,
                            ...i
                        } = o, n = e ? ? (i.href ? "a" : "div"), r = "a" === n ? i : function(e) {
                            const {
                                download: o,
                                href: t,
                                hrefLang: l,
                ...
                return l.createElement(Y, { ...G,
                    ...
                    onContextMenu: function(e) {
                        U && _ && (0, n.trackEvent)(U.category, U.event, `${U.label}_rightClick`)
                    },
                    ...
                    onKeyDown: V,
                    tabIndex: I
                }, Z && l.createElement(a.CircleLogo, { ...Q,
                ...
                }, M)), (void 0 !== w || f) && l.createElement("span", {
                    className: R.shortcut
                }, (ee = w) && ee.split("+").join(" + ")), void 0 !== E && l.createElement("span", {
                    role: F,
                    onClick: N ? d : void 0,
        ...
        624216: (e, o, t) => {
            ...
            function v(e) {
                const {
                    ...
                    ...L
                } = e, x = (0, l.useContext)(s.CloseDelegateContext), T = l.useContext(d), b = (0, l.useContext)(c), z = (0, h.useOutsideEvent)({
                    handler: function(e) {
                        m && m(e);
                        if (!u) return;
                ...
                return v ? l.createElement(r.Portal, {
                    top: "0",
                    left: "0",
                    right: "0",
                    bottom: "0",
        ...
        46305: (e, o, t) => {
            ...
            function h(e) {
                const {
                    className: o,
                    ...t
                } = e, [i, h] = (0, a.useRovingTabindexElement)(null);
                return l.createElement(s.PopupMenuItem, { ...t,
        ...
        898828: (e, o, t) => {
            ...
            const a = (0, l.forwardRef)(((e, o) => {
                ...
                return l.createElement(x, {
                    ...
                    className: m.bg
                }, h && ("string" == typeof h ? l.createElement(n.Icon, {
                    className: m.icon,
                    icon: h
                }) : l.createElement("span", {
                    className: m.icon
        ...
        16509: (e, o, t) => {
            ...
            const v = (0, h.humanReadableModifiers)(h.Modifiers.Shift, !1).trim(),
                ...
                m = {
                    keys: [v],
                    text: i.t(null, void 0, t(623369))
                },
                w = {
                    keys: [v],
                    text: i.t(null, void 0, t(313798))
                },
                f = {
                    keys: [v],
        ...
        909434: (e, o, t) => {
            ...
            ! function(e) {
                function o() {
                    ...
                    s.forEach(((l, i) => {
                        const n = l.tool || l;
                        t(n) ? r.includes(n) ? o = !0 : e.favorites.push(n) : a && a.includes(n) && e.hiddenToolsPositions.set(n, i)
                ...
                e.favorites = [], e.favoritesSynced = new l.Delegate, e.hiddenToolsPositions = new Map, e.favoriteIndex = function(o) {
                    return e.favorites.indexOf(o)
                }, e.isValidLineToolName = t, e.saveFavorites = i, o(), n.onSync.subscribe(null, o)
            }(s || (s = {})),
            function(e) {
                function o(e) {
                ...
                e.favoriteAdded = new l.Delegate, e.favoriteRemoved = new l.Delegate, e.favoriteMoved = new l.Delegate, e.favoritesSynced = s.favoritesSynced, e.favorites = function() {
                        return s.favorites.slice()
                    }, e.isValidLineToolName = o, e.favoritesCount = t, e.favorite = function(e) {
                        return e < 0 || e >= t() ? "" : s.favorites[e]
                    }, e.addFavorite = function(t, l) {
                        return !(i(t) || !o(t) || "performance" === t) && (s.favorites.push(t), s.saveFavorites(l), e.favoriteAdded.fire(t), !0)
                    },
                    e.removeFavorite = function(o, t) {
                        ...
                        return i.forEach(((e, o) => {
                            e > l && i.set(o, e - 1)
                        })), s.saveFavorites(t), e.favoriteRemoved.fire(o), !0
                    }, e.isFavorite = i, e.moveFavorite = function(l, i, n) {
                        ...
                        })), s.favorites.splice(r, 1), s.favorites.splice(i, 0, l), s.saveFavorites(n), e.favoriteMoved.fire(l, r, i), !0
                    }
            }(c || (c = {}))
        },
        454780: e => {
