(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
    [3805], {
        ...
        185934: (e, t, n) => {
            ...
            function i(e, t = 2, n) {
                return o(a().logo, a()[e], n, 0 === t || 1 === t ? o(r.skeletonTheme.wrapper, a().skeleton) : a().letter, 1 === t && r.skeletonTheme.animated)
            }
        ...
        718736: (e, t, n) => {
            ...
            function l(e) {
                const t = (0, o.useMemo)((() => function(e) {
                    ...
                    i = (0, o.useRef)(l);
                return i.current = l, (0, r.useIsomorphicLayoutEffect)((() => {
        ...
        778199: (e, t, n) => {
            ...
            function o(e, t, n, o, r) {
                ...
                return r.click && o.addEventListener("click", l, !1), r.mouseDown && o.addEventListener("mousedown", l, !1), r.touchEnd && o.addEventListener("touchend", l, !1), r.touchStart && o.addEventListener("touchstart", l, !1), () => {
        ...
        227570: (e, t, n) => {
            ...
            function l(e, t = []) {
                const [n, l] = (0, o.useState)(!1), a = (0, r.useFunctionalRefObject)(e);
        ...
        361701: (e, t, n) => {
            ...
            function i(e) {
                ...
                return (0, o.useEffect)((() => l(a.current ? .complete ? ? !t ? 2 : 1)), [t]), t && 3 !== n ? o.createElement("img", {
                    ref: a,
                    className: i,
                    crossOrigin: "",
                    src: e.logoUrl,
        ...
        611005: (e, t, n) => {
            ...
            const T = () => [{
                ...
                emojis: [],
                content: o.createElement(i.IconItem, {
                    icon: c
                })
            }, {
                title: r.t(null, {
        ...
        198412: (e, t, n) => {
            ...
            function d(e) {
                ...
                if (t === s.EMPTY_EMOJI) return o.createElement(a.Icon, {
        ...
        920709: (e, t, n) => {
            ...
            function i(e) {
                const {
                    ...
                    leadingEmoji: c,
                    processedText: s
                } = (0, o.useMemo)((() => (0, r.processTextWithLeadingEmoji)({
                    text: t,
                    textRender: n,
                    firstSegmentOnly: i
                })), [t, n, i]);
                return c ? o.createElement(o.Fragment, null, o.createElement("span", {
                    className: a.emojiWrap
                }, " ", o.createElement(l.EmojiItem, {
                    className: a.emoji,
                    emoji: c
                })), "" !== s && o.createElement(o.Fragment, null, " ", s)) : o.createElement(o.Fragment, null, s)
            }
        },
        574871: (e, t, n) => {
            "use strict";
            ...
            function u(e) {
                ...
                } = e, i = (0, o.getFirstSegmentOrCodePointString)(t), c = null !== i && (0,
                    r.isSupportedEmoji)(i) ? i : l.EMPTY_EMOJI, u = a ? i || "" : t;
                if (!s || c === l.EMPTY_EMOJI) return {
                    leadingEmoji: "",
                    processedText: n(u)
                };
                return {
                    leadingEmoji: c,
                    processedText: n(u.replace(c, ""))
                }
            }
            ...
            function m(e) {
                ...
                if (!n) return r;
                return `${function(e){const t=(0,i.getTwemojiUrl)(e,"png");return`<span class=${c.tooltipEmojiWrap}>&nbsp<img class=${c.tooltipEmoji} src=${t} decoding="async" width="12" height="12" alt="" draggable="false"/></span>`}(n)}&nbsp;${r}`
            }
        },
        598448: (e, t, n) => {
            "use strict";
        ...
        577687: (e, t, n) => {
            ...
            function d(e) {
                const {
                    ...
                    title: v,
                    ...h
                } = e, [p, g] = (0, c.useActiveDescendant)(null), f = v ? ? (n ? i.removeTitlesMap[i.RemoveTitleType.Remove] : i.removeTitlesMap[i.RemoveTitleType.Add]);
                return (0, o.useLayoutEffect)((() => {
                    const e = p.current;
                    e instanceof HTMLElement && f && e.dispatchEvent(new CustomEvent("common-tooltip-update"))
                }), [f, p]), o.createElement(a.Icon, { ...h,
                ...
                const {
                    ...
                    function t(t) {
                        const {
                            reference: n,
                            ...r
                        } = t, l = e ? ? (r.href ? "a" : "div"), a = "a" === l ? r : function(e) {
                            const {
                                download: t,
                                href: n,
                                hrefLang: o,
                ...
                return o.createElement(X, { ...G,
                    ...
                    onClick: function(e) {
                        ...
                        J || (e.currentTarget.dispatchEvent(new CustomEvent("popup-menu-close-event", {
                            bubbles: !0,
                            detail: {
                                clickType: (0, c.isKeyboardClick)(e) ? "keyboard" : "mouse"
                            }
                        })), (0, a.globalCloseMenu)())
                    },
                    onContextMenu: function(e) {
                    ...
                    onKeyDown: H,
                    tabIndex: Q
                }, B && o.createElement(i.CircleLogo, { ...V,
                    ...
                    className: r(S.label, h)
                }, C)), (void 0 !== g || f) && o.createElement("span", {
                    className: S.shortcut
                }, (ee = g) && ee.split("+").join(" + ")), void 0 !== F && o.createElement("span", {
                    role: T,
                    onClick: N ? m : void 0,
        ...
        624216: (e, t, n) => {
            ...
            function d(e) {
                const {
                    ...
                    ...E
                } = e, b = (0, o.useContext)(c.CloseDelegateContext), w = o.useContext(m), M = (0, o.useContext)(s), L = (0, u.useOutsideEvent)({
                    handler: function(e) {
                        p && p(e);
                        if (!v) return;
                ...
                return d ? o.createElement(a.Portal, {
                    top: "0",
                    left: "0",
                    right: "0",
                    bottom: "0",
        ...
        72621: (e, t, n) => {
            ...
            function m(e) {
                const {
                    ...
                    icon: g,
                    ...f
                } = e, [x, E] = (0, c.useActiveDescendant)(null);
                return r.createElement(i.Icon, { ...f,
                    "data-name": p,
        ...
        46305: (e, t, n) => {
            ...
            function u(e) {
                const {
                    className: t,
                    ...n
                } = e, [r, u] = (0, i.useRovingTabindexElement)(null);
                return o.createElement(c.PopupMenuItem, { ...n,
