(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
    [4876], {
        ...
        270762: (t, e, i) => {
            ...
            (0, s.forwardRef)(((t, e) => {
                const {
                    ...
                    "aria-label": a,
                    ...r
                } = t, h = n ? ? d.CustomComponentDefaultLink;
        ...
        15378: (t, e, i) => {
            ...
            function(t) {
                t.Brand = "brand", t.Blue = "blue", t.Gray = "gray", t.LightGray = "light-gray", t.Green = "green", t.Red = "red", t.Black = "black", t.Gradient = "gradient", t.BlackFriday = "black-friday", t.CyberMonday = "cyber-monday"
            }(a || (a = {})),
            function(t) {
        ...
        732219: (t, e, i) => {
            ...
            function c(t) {
                ...
                let m;
                m = !("xxsmall" === n || "xxxsmall" === n) && i ? s && i >= 100 ? "99+" : r && i > 0 ? `+${i}` : i : "";
                const _ = o()(e, d().counter, d()[`size-${n}`], d()[`color-${a}`], "none" !== h && d()[`borderColor-${h}`]);
                return l.createElement("span", { ...p,
                    className: _,
                    "aria-label": c,
                    "aria-hidden": u
                }, m)
            }! function(t) {
                t.XXXSmall = "xxxsmall", t.XXSmall = "xxsmall", t.XSmall = "xsmall", t.Small = "small", t.Medium = "medium", t.Large = "large", t.XLarge = "xlarge"
            }(s || (s = {})),
            function(t) {
                t.Danger = "danger", t.Accent = "accent", t.AccentLight = "accent-light", t.NeutralBold = "neutral-bold", t.Neutral = "neutral"
            }(n || (n = {})),
            function(t) {
                t.Primary = "primary", t.Secondary = "secondary", t.Tertiary = "tertiary", t.None = "none"
            }(a || (a = {}))
        },
        718736: (t, e, i) => {
            "use strict";
        ...
        664332: (t, e, i) => {
            ...
            function r(t, e = []) {
                ...
                }(t), o = (0, s.useRef)(null), l = (0, s.useRef)(i);
                l.current = i;
                const h = (0, a.useFunctionalRefObject)(r),
                    d = (0, s.useCallback)((t => {
                        h(t), null !== o.current && (o.current.disconnect(), null !== t && o.current.observe(t))
                    }), [h, o]);
                return (0, n.useIsomorphicLayoutEffect)((() => (o.current = new ResizeObserver(((t, e) => {
                    l.current(t, e)
        ...
        32349: (t, e, i) => {
            "use strict";
            i.r(e), i.d(e, {
                DataWindowRenderer: () => a
            });
            var s = i(48547),
                n = i(329452);
            class a extends s.WidgetbarWidgetRenderer {
                constructor(t) {
                    super(t), this._mounted = !1, this._contentRenderer = null, this._updateDelegate = new n.Delegate, this.fullUpdate = () => {
                        this._updateChartWidget(), this._mounted && this._contentRenderer ? .()
                    }, this._activityChangeHandler = t => {
                        t ? this._chartWidgetCollection.activeChartWidget.subscribe(this.fullUpdate, {
                            callWithLast: !0
                    ...
                    this._chartWidgetCollection = e, this._chartWidget = this._chartWidgetCollection.activeChartWidget.value(), this._props.active.subscribe(this._activityChangeHandler, {
                        callWithLast: !0
                    })
                }
                mount() {
                    ...
                    this._mounted = !0;
                    const t = this._loadModulePromise = Promise.all([Promise.resolve().then(i.t.bind(i, 50959, 19)), Promise.resolve().then(i.t.bind(i, 632227, 19)), Promise.all([i.e(8245), i.e(7384), i.e(7431), i.e(8473), i.e(5758), i.e(9221), i.e(1205)]).then(i.bind(i, 792199))]).then((([e, i, s]) => {
                        this._loadModulePromise === t && (this._contentRenderer = () => {
                            i.render(e.createElement(s.DataWindow, {
                ...
                unmount() {
                    this._mounted && (this._mounted = !1, super.unmount(), this._loadModulePromise = null)
                }
                unmountBody() {
                    this._mounted && (this._mounted = !1, super.unmountBody(), this._loadModulePromise = null)
                }
                destroy() {
                    this._props.active.unsubscribe(this._activityChangeHandler), super.destroy()
                }
                update() {
        ...
        658475: (t, e, i) => {
            ...
            class c {
                constructor(t) {
                    ...
                    this.isActive = new h.WatchedValue(e.isActive), this.notificationsCount = new h.WatchedValue(e.notificationCount), this.notificationCounterAriaLabel = new h.WatchedValue(e.notificationCounterAriaLabel), this.icon = new h.WatchedValue(e.icon), this.hint = new h.WatchedValue(e.hint), this.onClick = new h.WatchedValue(e.onClick), this.TabButtonComponent = t.TabButtonComponent
                }
            ...
            const _ = parseInt(m["css-value-widgets-margin"]),
                v = {
                    ...
                    market_summary: {
                        title: a.t(null, void 0, i(176937)),
                        ctor: null
                    },
                    object_tree: {
            ...
            class L {
                constructor(t) {
                    this._settingsKey = null, this._value = null, this._watchedValue = new h.WatchedValue(null), t && t.settingsKey && (this._settingsKey = t.settingsKey, this._value = E.getJSON(this._settingsKey, null), this._watchedValue = new h.WatchedValue(this._value)), t && t.widgetBarWidget && Object.defineProperty(this, "widgetBarWidget", {
                ...
                setValue(t, e) {
                    return this._value = t, this._watchedValue.setValue(this._value), this._settingsKey && (null == t ? ((0, x.trackEvent)("Settings debug", "WigdetProperties.setValue: " + this._settingsKey, window.user.username), E.remove(this._settingsKey)) : E.setJSON(this._settingsKey, t, e)), this._value
                }
                readonly() {
            ...
            const M = new((T = class {
                ...
                onMessage(t) {
                    "function" == typeof t && T._handlers.push({
                        handler: t,
                        widget: this
                    })
                }
                offMessage(t) {
                    if ("function" == typeof t) {
                        const e = T._handlers.findIndex((e => e.handler === t)); - 1 !== e && T._handlers.splice(e, 1)
                    }
                }
                offWidget(t) {
            ...
            class P {
                constructor(t) {
                    this.heightRatio = P.heightRatio, this.minHeight = 0, this.widgetConfig = null, this.widgetActive = new h.WatchedValue, this.widgetMaximized = new h.WatchedValue, this.widgetVisible = null, this.symbolLinking = null, this.intervalLinking = null, this._header = null, this._widget = null, this._headerIcon = null, this._headerspace = null, this._title = null, this._resizehandle = null, this._widgetStarted = new C.Delegate, this._resizer = null, this._internalState = {
                    ...
                    }, t && t.widgetBarPage && (this.widgetBarPage = t.widgetBarPage), this._rdState = new y.ResizerDetacherState(this._internalState), this._rdState.owner.subscribe((t => {
                ...
                destroy() {
                    this.widgetObject && "destroy" in this.widgetObject && this.widgetObject.destroy(), this.remove(), this.symbolLinking && (this.symbolLinking.destroy(), this.symbolLinking = null), this.intervalLinking && (this.intervalLinking.destroy(), this.intervalLinking = null), this.widgetVisible && (this.widgetVisible.unsubscribe(), this.widgetVisible = null), this.widgetActive && (this.widgetActive.unsubscribe(), this.widgetActive = null), this.widgetMaximized && (this.widgetMaximized.unsubscribe(), this.widgetMaximized = null), this.properties && (this.properties.destroy(), delete this.properties), this._header ? .remove(), this._widget ? .remove(), this._headerIcon ? .remove(), this._headerspace ? .remove(), this._title ? .remove(), this._resizehandle ? .remove(), this._header = null, this._widget = null, this._headerIcon = null, this._headerspace = null, this._title = null, this._resizehandle = null, M.offWidget(this), this._preloadTimeout && clearTimeout(this._preloadTimeout)
                }
                rdState() {
                ...
                onActiveStateChange(t) {
                    ...
                    t && !e.doNotClearNotifications && this.clearNotifications(), this.updateVisibleWatchedValue(), this.widgetActive ? .setValue(!!t)
                }
                toggleMaximize(t) {
                    const e = "boolean" != typeof t ? !this.widgetMaximized ? .value() : t;
                    e !== this.widgetMaximized ? .value() && (this.widgetMaximized ? .setValue(e), this.widgetBarPage && this.widgetBarPage.widgetBarLayout && this.widgetBarPage.widgetBarLayout.widgetBar && this.widgetBarPage.widgetBarLayout.widgetBar.saveToTVSettings(), this.widgetBarPage && this.widgetBarPage.updateWidgetsHeight())
                }
                startWidget() {
                    ...
                    const i = e.ctor;
                    if (!i) return;
                    if (this.widgetVisible = this.widgetVisible || new h.WatchedValue, this.updateVisibleWatchedValue(), e.lazyLoad && !this.widgetVisible.value()) return this.widgetStartDelayed = !0, this.widgetVisible.when((() => {
                        delete this.widgetStartDelayed, this.startWidget(), clearTimeout(this._preloadTimeout)
                    })), void(e.preloadDelay && (this._preloadTimeout = setTimeout((() => {
                        i.preload && i.preload()
                    }), e.preloadDelay)));
                    this.symbolLinking = B.linking.proSymbol.spawn(), this.intervalLinking = B.linking.interval.spawn();
                    ...
                    void 0 !== this.readonly ? this.readonly && (a.readonly = !0) : this.getWidgetBarOption("readonly") && (a.readonly = !0), void 0 !== e.options && (a.options = e.options), null != this.stateData ? a.data = this.stateData : null != e.data && (a.data = e.data);
                    const r = this.widgetObject = new i(a);
                    "hasLifecycle" in r && this.widgetActive ? .readonly().subscribe((t => {
                        t ? r.mount() : r.unmount()
                    }), {
                ...
                getTitle(t) {
                    const e = function(t, e) {
                        try {
                            e = e || v;
                            let i = e[t] ? .title;
                            return !i && t && (i = String(t).match(/[A-Z]{2,}|\d+(?:\.\d+)?|[A-Z]?[a-z]+/g) ? .join(" ").replace(/^.|\s./g, (t => t.toUpperCase()))), i || void 0
                        } catch {
                            return
                        }
                    }(this.type, this.getWidgetBarOption("widgetConfig"));
                    return t && this.customTitle && e ? this.customTitle.substring(0, e.length) === e ? this.customTitle : e + ": " + this.customTitle : this.customTitle || e || a.t(null, void 0, i(103898))
                }
                createHTML() {
                    ...
                    o.dataset.testIdWidgetType = this.type, o.classList.value = f()(n, "widgetbar-widget", "widgetbar-widget-" + this.type);
                    ...
                    if (l.classList.value = a || "widgetbar-widgetheader", l.addEventListener("contextmenu", (t => {
                        ...
                        e.classList.value = "widgetbar-widgetheader-icon widgetbar-widgetheader-icon-" + t, e.appendChild((0, S.parseHtml)(w[t])), l.appendChild(e)
                    }
                    if (!s) {
                    ...
                    if (!e) {
                        ...
                        t.classList.value = f()("widgetbar-widgettitle", r), t.dataset.name = this.type + "_header", t.textContent = this.getTitle(), l.prepend(t)
                    }
                    ...
                    })), null !== this._resizer && this._resizer.destroy(), this._resizer = new z.PointerBackend({
                        handle: d,
                        onDragStart: t => {
                ...
                demarshal(t) {
                    ...
                    let e;
                    if ("id" in t ? (this.id = String(t.id), this.type = this.id.replace(/\..*/, "")) : "type" in t ? (this.type = String(t.type), this.id = this.type + "." + (0, H.randomHash)()) : (delete this.type, delete this.id),
                        null != t.readonly ? this.readonly = !!t.readonly : delete this.readonly, this.stateData = t.data, isFinite(Number(t.heightRatio)) && Number(t.heightRatio) >= 0 ? this.heightRatio = Number(t.heightRatio) : this.heightRatio = P.heightRatio, !0 === t.maximized && (this.maximized = !0), !0 === t.unAuthEditable && (this.unAuthEditable = !0), t.settingsKey) e = String(t.settingsKey);
                    else if (this.id) {
                        const t = this.getWidgetBarOption("_settingsPrefix");
                        t && (e = t + ".widget." + this.id)
                    }
                    if (this.properties = new L({
                ...
                marshal() {
                    const t = {};
                    return this.id && (t.id = this.id), this.type && (t.type = this.type), this.heightRatio !== P.heightRatio && (t.heightRatio = this.heightRatio), this.widgetMaximized ? .value() && (t.maximized = !0), t
                }
            }
            P.heightRatio = 1;
            class V {
                ...
                onActiveStateChange(t) {
                    t = !!t, this._page ? .classList.toggle("active", !!t), (0, n.ensure)(this.tab).onActiveStateChange(t), t && this.updateWidgetsHeight({
                ...
                getAvailableHeight() {
                    let t = this.widgetBarLayout ? .widgetBar ? .resizerBridge.height.value() || 0;
                    if (!t) return 0;
                    let e = 0;
                    return this.widgets.forEach(((i, s) => {
                ...
                updateWidgetsHeight(t = {}) {
                    ...
                    for (let t = r.length; t--;) {
                        const e = r[t],
                            n = e.element("header");
                        n && (void 0 === i && (i = (0, W.outerHeight)(n, !0)), s -= i, a += e.heightRatio)
                    }
                    const h = s / a;
                ...
                handleWidgetResizeChange(t, e) {
                    ...
                    const {
                        current: s,
                        initial: n
                    } = e.detail, a = s.pageY - n.pageY, r = Math.max(i.topWidget.minHeight, Math.min(i.startTopWidgetHeight + a, i.summaryHeight - i.bottomWidget.minHeight));
                    i.prevTopWidgetHeight !== r && (i.prevTopWidgetHeight = r, i.topWidget.heightRatio = r / i.summaryHeight * i.summaryRatio, i.bottomWidget.heightRatio = i.summaryRatio - i.topWidget.heightRatio, i.topWidget.setHeight(r), i.bottomWidget.setHeight(i.summaryHeight - r))
                }
                handleWidgetResizeStop(t, e) {
                    const i = this._resizeOperations.get(t);
                    void 0 !== i && (this._resizeOperations.delete(t), this._page ? .classList.remove("widget-resize-mode"), i.prevTopWidgetHeight !== i.startTopWidgetHeight && (this.normalizeRatios(), this.widgetBarLayout && this.widgetBarLayout.widgetBar && this.widgetBarLayout.widgetBar.saveToTVSettings()))
                }
                normalizeRatios() {
                    let t = 1 / 0;
                ...
                attachWidget(t, e) {
                    e = Number(e);
                    const i = this.widgets.indexOf(t); - 1 !== i ? this.widgets.splice(i, 1) : t.widgetBarPage && t.widgetBarPage !== this && t.widgetBarPage.removeWidget(t), e < this.widgets.length ? e < 0 && (e = 0) : e = this.widgets.length, delete t.widgetBarPage, Object.defineProperty(t, "widgetBarPage", {
                        value: this,
                        configurable: !0
                    }), this.widgets.splice(e, 0, t);
                    const s = this.widgets[e + 1],
                        n = t.element("widget");
                    s ? n && n.insertAdjacentElement("beforebegin", s.element("widget")) : n && this._page ? .appendChild(n), this.updateWidgetsHeight(), t.updateVisibleWatchedValue()
                }
                removeWidget(t) {
                    const e = this.widgets.indexOf(t); - 1 !== e && (delete t.widgetBarPage, this.widgets.splice(e, 1), t.element("widget") ? .remove(), this.updateWidgetsHeight())
                }
                remove() {
                ...
                clearNotifications() {
                    this.notificationCounter = 0, (0, n.ensure)(this.tab).updateNotifications(this.notificationCounter), this._clearNotificationsCounterAriaLabel()
                }
                updateNotifications(t) {
                    const e = "number" == typeof t ? t : this.notificationCounter;
                    (0, n.ensure)(this.tab).updateNotifications(e), this._updateNotificationsCounterAriaLabel(e)
                }
                getWidgets(t) {
                    const e = [];
                ...
                demarshal(t) {
                    ...
                    return e.splice(0, e.length), this._gaEvent = t._gaEvent, this.title = t.title, this.name = t.name, this.icon = t.icon, this.spaceBottom = t.spaceBottom, this.spaceBottomText = t.spaceBottomText, this.onBottom = t.onBottom, this.TabButtonComponent = t.TabButtonComponent, this._createNotificationCounterAriaLabel = t.createCounterAriaLabel, this.createTabButtonViewModel(), t.widgets.forEach((t => {
                        const i = new P({
                            widgetBarPage: this
                        }).demarshal(t);
                        i && e.push(i)
                ...
                _updateNotificationsCounterAriaLabel(t) {
                    this._createNotificationCounterAriaLabel && (this.notificationCounterAriaLabel = this._createNotificationCounterAriaLabel(t), (0, n.ensure)(this.tab).updateNotificationCounterAriaLabel(this.notificationCounterAriaLabel))
                }
                _clearNotificationsCounterAriaLabel() {
                    this.notificationCounterAriaLabel = "", (0, n.ensure)(this.tab).updateNotificationCounterAriaLabel(this.notificationCounterAriaLabel)
                }
            }
            var I = i(440891),
                N = i(719036),
            ...
            function X(t, e) {
                return class extends o.PureComponent {
                    ...
                    componentDidMount() {
                        ...
                        t.notificationsCount.subscribe(this._bindedForceUpdate), t.notificationCounterAriaLabel.subscribe(this._bindedForceUpdate), t.isActive.subscribe(this._bindedForceUpdate)
                    }
                    componentWillUnmount() {
                        const {
                            viewModel: t
                        } = this.state;
                        t.notificationsCount.unsubscribe(this._bindedForceUpdate), t.notificationCounterAriaLabel.unsubscribe(this._bindedForceUpdate), t.isActive.unsubscribe(this._bindedForceUpdate)
                    }
                    render() {
                        const {
                            viewModel: e
                        } = this.state, i = e.notificationsCount.value(), s = e.notificationCounterAriaLabel.value();
            ...
            const $ = (0, o.forwardRef)((function(t, e) {
                const {
                    ...
                    ...g
                } = t, [p, m] = (0, G.useRovingTabindexElement)(e), _ = b(s, i.button, d && i.isActive, l && "apply-common-tooltip common-tooltip-vertical"), v = o.createElement(o.Fragment, null, o.createElement("div", {
                    className: i.hoverMask
                ...
                return o.createElement("button", { ...g,
                    "aria-label": l,
                    ref: p,
                    type: "button",
            ...
            class ot extends o.PureComponent {
                constructor(t, e) {
                    super(t, e), this._pages = {}, this._isOpeningTradingPanelAvailable = null, this._tradingActivePage = null, this._isTradingPanelOpened = null, this._handleMouseOver = t => {
                        (0, et.hoverMouseEventFilter)(t) && this.setState({
                            isHovered: !0
                        })
                    ...
                    }, (0, it.validateRegistry)(e, {
                        widgetBar: N.any.isRequired
                    });
                    const {
                        widgetBar: i
                    } = this.context;
                    if (this._isMinimized = (0, n.ensureDefined)(i.layout).isMinimized.spawn(), this._isFullscreen = i.resizerBridge.fullscreen.spawn(), i.tradingPanelAccessor) {
                        ...
                        this._isOpeningTradingPanelAvailable = t.isOpeningAvailable.spawn(), this._tradingActivePage = t.activePage.spawn(), this._isTradingPanelOpened = t.isOpened.spawn()
                    }
                    this.state = {
                        isHovered: !1,
                        isFullscreen: this._isFullscreen.value()
                    }, (0, n.ensureDefined)(i.layout).pages.forEach((t => {
                        void 0 === t.name && at.logWarn('Page does not provide required field "name"');
                        const e = t.tab;
                ...
                componentWillUnmount() {
                    this._isFullscreen.destroy(), this._isMinimized.destroy(), null !== this._isOpeningTradingPanelAvailable && this._isOpeningTradingPanelAvailable.destroy(), null !== this._tradingActivePage && this._tradingActivePage.destroy(), null !== this._isTradingPanelOpened && this._isTradingPanelOpened.destroy()
                }
                render() {
                    const {
                        className: t
                    ...
                    }, o.createElement(st.Toolbar, {
                        className: b(t, nt.toolbar),
                        onContextMenu: tt.preventDefaultForContextMenu,
                        orientation: "vertical",
                        "data-name": "right-toolbar"
                    }, s.adaptive && i && o.createElement(O, {
                        name: "close-button",
                        onClick: this._handleCloseClick
                    }), this._renderPages(), o.createElement(Z, null), this._renderPages(!0), n.ScreenerDialogBtn && o.createElement(n.ScreenerDialogBtn, {
                        name: "screener-dialog-button"
                    }), n.CalendarDialogBtn && o.createElement(n.CalendarDialogBtn, {
                        name: "calendar-dialog-button"
                    }), n.OptionsBuilderDialogBtn && o.createElement(n.OptionsBuilderDialogBtn, {
                        name: "options-builder-dialog-button"
                    }), n.CommunityFeedCurtainButton && o.createElement(n.CommunityFeedCurtainButton, {
                        name: "community-feed-curtain-dialog-button"
                    }), n.SupportTicketButton && o.createElement(n.SupportTicketButton, {
                        name: "bug-report-button"
                    }), n.NotificationsButton && o.createElement(n.NotificationsButton, {
                        name: "notifications-button"
                    }), n.HelpButton && o.createElement(n.HelpButton, {
                        name: "help-button"
                    })))
                }
                _renderPages(t) {
                    ...
                    return s.forEach((i => {
                        ...
                        if (s in this._pages && Boolean(i.onBottom) === Boolean(t)) {
                            ...
                            e.push(o.createElement(t, {
                                name: s,
                                key: s
                            })), i.spaceBottom && e.push(o.createElement(q, {
                ...
                _createToolset() {
                    const {
                        widgetBar: t
                    } = this.context, e = (t.calendarDialogBtnViewModel(), t.optionsBuilderDialogBtnViewModel(), t.screenerDialogBtnViewModel(), t.communityFeedCurtainButtonViewModel()), i = t.notificationsButtonViewModel();
                    return {
                        CalendarDialogBtn: void 0,
                        OptionsBuilderDialogBtn: void 0,
                        ScreenerDialogBtn: void 0,
                        SupportTicketButton: this.props.isSupportTicketButtonAvailable ? X($, t.ensureSupportTicketButtonViewModel()) : void 0,
                        HelpButton: this.props.isHelpButtonAvailable ? X($, t.ensureHelpButtonViewModel()) : void 0,
                        CommunityFeedCurtainButton: this.props.isCommunityFeedCurtainButtonAvailable && e ? X($, e) : void 0,
                        NotificationsButton: this.props.isNotificationsButtonAvailable && i ? X($, i) : void 0
                    }
                }
            }
            ot.contextType = rt;
            ...
            class ht extends o.PureComponent {
                ...
                render() {
                    return o.createElement(it.RegistryProvider, {
                        validation: lt,
            ...
            class ct {
                constructor(t, e, i) {
                    this._widgetBar = t, this._container = e, this._options = i, dt || this._render()
                }
                updateOptions(t) {
                ...
                _render() {
                    l.render(o.createElement(ht, {
                        ...
                        isCalendarDialogBtnAvailable: this._options.isCalendarDialogBtnAvailable,
                        isOptionsBuilderDialogBtnAvailable: this._options.isOptionsBuilderDialogBtnAvailable,
                        isScreenerDialogBtnAvailable: this._options.isScreenerDialogBtnAvailable,
                        isCommunityFeedCurtainButtonAvailable: this._options.isCommunityFeedCurtainButtonAvailable,
                        isNotificationsButtonAvailable: this._options.isNotificationsButtonAvailable
                    })), this._container)
                }
            }
            var ut = i(167645);
            ...
            class _t {
                constructor(t = {}) {
                    this.MIN_WIDTH = 200, this.MINIMIZE_THRESHOLD = 50, this.activeIndex = _t.activeIndex, this.activeName = _t.activeName, this.minimized = _t.minimized, this.visible = _t.visible, this.width = _t.width, this.version = _t.version, this.pages = [], this.isMinimized = new h.WatchedValue, this.activePageIndex = new h.WatchedValue(this.activeIndex), this.tabRenderer = null, this.rightToolbarOptions = {
                    ...
                    }, this._tabs = null, this._pages = null, this._pagescontent = null, this._handle = null, this._deviceButton = null, this._hider = null, this._draggable = null, this._shouldHideWidgetBar = I.enabled("hide_right_toolbar"), this._shouldHideWidgetBarTabs = I.enabled("hide_right_toolbar_tabs"), this.widgetBar = t.widgetBar, this._rightToolbar = Boolean(t.rightToolbar)
                }
                element(t) {
                    switch (t) {
                        case "tabs":
                ...
                tabsWidth() {
                    return this._shouldHideWidgetBarTabs ? 0 : this._rightToolbar ? 45 : this.minimized ? 5 : 0
                }
                borderWidth() {
                ...
                updateResponsiveness() {
                    ...
                    this._tabs ? .classList.toggle("js-hidden", t), this._pages ? .classList.toggle("js-hidden", t)
                }
                ...
                onTabClick(t, e) {
                    ...
                    if (-1 !== i) {
                        if (t.preventDefault(), this._trackClick(e.name), i !== this.activeIndex || this.minimized) {
                            const t = e.gaEvent();
                            t && (0, x.trackEvent)("Platform Widgets", t), this.switchPage(i), this.minimized && this.setMinimizedState(!1)
                ...
                destroy() {
                    ...
                    this._tabs ? .remove(), this._pages ? .remove(), this._pagescontent ? .remove(), this._handle ? .remove(), this._deviceButton ? .remove(), this._hider ? .remove()
                }
                updateRightToolbar() {
                ...
                createHTML() {
                    ...
                    if (this._rightToolbar) {
                        ...
                        this._shouldHideWidgetBarTabs || (e.classList.value = "widgetbar-tabs"), this.tabRenderer && (this.tabRenderer.destroy(), this.tabRenderer = null), this._shouldHideWidgetBarTabs || (this.tabRenderer = new ct(t, e, this.rightToolbarOptions))
                    }
                    const e = this._pages = document.createElement("div");
                    this._shouldHideWidgetBarTabs ? (e.classList.value = "widgetbar-pages-no-tabs", e.setAttribute("data-name", "widgetbar-pages-no-tabs")) : (e.classList.value = "widgetbar-pages", e.setAttribute("data-name", "widgetbar-pages-with-tabs"));
                    ...
                    if (s.classList.value = "widgetbar-handle", e.appendChild(s), s.addEventListener("contextmenu", (t => {
                        ...
                        const e = () => {
                            t.classList.toggle("widgetbar-hider--closed", this.isMinimized.value()), t.classList.toggle("js-hidden", this._rightToolbar && this.isMinimized.value()), l.render(o.createElement(mt, {
                ...
                demarshal(t) {
                    ...
                    this.width = Number(t.width), !isFinite(this.width) || this.width <= 0 ? this.width = _t.width : this.width < this.MIN_WIDTH && (this.width = this.MIN_WIDTH), "minimized" in t ? (this.minimized = Boolean(t.minimized), this.isMinimized.setValue(this.minimized)) : (this.minimized = _t.minimized, this.isMinimized.setValue(this.minimized)), "version" in t && (this.version = t.version);
                ...
                marshal() {
                    ...
                    return this.minimized !== _t.minimized && (i.settings.minimized = this.minimized), this.width !== _t.width && (i.settings.width = this.width), this.activeIndex !== _t.activeIndex && (i.settings.activeIndex = this.activeIndex), this.activeName !== _t.activeName && (i.settings.activeName = this.activeName), this.version !== _t.version && (i.settings.version = this.version), i
                }
                _createDraggable(t) {
                    ...
                    this._draggable = new z.PointerBackend({
                        ...
                        onDragMove: t => {
                            ...
                            a < this.MINIMIZE_THRESHOLD ? this.setMinimizedState(!0) : (a < this.MIN_WIDTH && (a = this.MIN_WIDTH), this.width = a, this.minimized ? this.setMinimizedState(!1) : this.requestWidth(a))
                        },
                        onDragStop: t => {
                            this.widgetBar && this.widgetBar.saveToTVSettings()
                        }
            ...
            _t.width = 290, _t.minimized = !I.enabled("show_right_widgets_panel_by_default"), _t.activeIndex = 0, _t.activeName = "", _t.visible = !0, _t.version = void 0;
            var vt = i(247465),
                wt = i(344557),
                bt = i(235354),
                ft = i(61121),
            ...
            class Et {
                constructor(t) {
                    ...
                    this._configuration = Promise.race([(0, ft.delay)(null, 5e3), e]).then((() => i())).then((t => {
                        const e = this.widgetConfig;
                        return e.reuters_calendar.ctor = t.ReutersCalendarWidget, e.earnings_calendar.ctor = t.CalendarWidget, e.watchlist.ctor = t.Watchlist, e.hotlist.ctor = t.HotlistWidget, e.detail.ctor = t.Detail && t.Detail.Widget, e.news.ctor = t.NewsWidget, e.notifications_following.ctor = t.IdeasFeedWidget, e.unionchats.ctor = t.UnionChatsWidget, e.notes.ctor = t.NotesWidget, e.alerts.ctor = t.AlertsWidget, e.datawindow.ctor = t.DataWindowWidget, (0, n.ensure)(e.object_tree).ctor = t.ObjectTreeWidget, t
                    }));
                    const a = this.resizerBridge = t.resizerBridge;
                    this.adaptive = Boolean(t.adaptive), this.tradingPanelAccessor = t.tradingPanelAccessor || null, this._visible = (0, r.combine)(((t, e, i) => Boolean(t && e && i)), a.width.weakReference(), a.height.weakReference(), a.visible.weakReference()), this.widgetConfig = (0, s.default)({}, v),
                        t.widgetConfig && (this.widgetConfig = (0, s.default)(this.widgetConfig, t.widgetConfig)), this.layout = new _t({
                            widgetBar: this,
                            rightToolbar: Bt
                            ...
                            this.layout ? .onVisibilityChange(), this.layout ? .requestOptimalWidth()
                        })), this.resizerBridge.availWidth.subscribe((() => {
                            this.layout ? .requestOptimalWidth(), this.layout ? .updateResponsiveness()
                        })), this._tradingServiceCancelable = (0, vt.makeCancelable)((0, wt.waitTradingService)()), this._tradingServiceCancelable.promise.then((t => {
                ...
                destroy() {
                    if (null !== this._tradingServiceCancelable) this._tradingServiceCancelable.cancel(), this._tradingServiceCancelable = null;
                        ...
                        (0, n.ensureNotNull)((0, wt.tradingService)()).onConnectionStatusChange.unsubscribe(this, this._onBrokerConnectionStatusChanged)
                    }
                    this.layout ? .destroy()
                }
                widget(t) {
                ...
                initLayout() {
                    ...
                    })), 0 === this.layout.pages.length && (this.layout.setMinimizedState(!0), this.layout.element("handle") ? .classList.add("js-hidden")), this.layout.requestOptimalWidth(), this.layout.syncWidth(), this.layout.syncHeight(), this.layout.onVisibilityChange(), this.layout.updateResponsiveness())
                }
                loadWidgets() {
                ...
                refreshFromTVSettings() {
                    ...
                    this.layout && this.layout.destroy(), this.layout = new _t({
                        widgetBar: this,
                        rightToolbar: Bt
                ...
                loadFromTVSettings() {
                    ...
                    if (e) {
                        ...
                        i && i.forEach((e => {
                            const i = e.replace(this._settingsPrefix + ".widget.", ""); - 1 === t.indexOf(i) && 0 === e.indexOf(this._settingsPrefix + ".widget.") && ((0, x.trackEvent)("Settings debug", "loadFromTVSettings: " + e, window.user.username), E.remove(e))
                        }))
                    }
                }
                mergeProperties(t) {
                ...
                getGenericLayoutState(t) {
                    const e = (0, bt.getDefaultState)(),
                        ...
                        }, I.enabled("hide_ideas_page") || isFeatureEnabled("show_community_feed_button") ? null : {
                            _gaEvent: "My Ideas",
                            title: a.t(null, void 0, i(926647)),
                            name: "notes",
                            icon: "notes",
                        ...
                        }, I.enabled("hide_chats_page") ? null : {
                            _gaEvent: "Chats",
                        ...
                        }, I.enabled("hide_ideas_streams_page") || isFeatureEnabled("show_community_feed_button") ? null : {
                ...
                getChartingPlatformLayoutState(t, e) {
                    ...
                    if (this._customization.watchlist || this._customization.details || this._customization.news) {
                        let n = "";
                        const r = [];
                        this._customization.watchlist && (n = a.t(null, void 0, i(512504)), r.push({
                            type: "watchlist",
                            id: "watchlist." + e,
                            properties: t && t.length ? {
                                list: t
                            } : void 0
                        })), this._customization.details && (n = this._customization.watchlist ? a.t(null, void 0, i(819134)) : a.t(null, void 0, i(278892)), r.push({
                            type: "detail"
                        })), this._customization.news && (n = this._customization.watchlist && this._customization.details ? a.t(null, void 0, i(331165)) : this._customization.watchlist ? a.t(null, void 0, i(929848)) : a.t(null, void 0, i(338333)), r.push({
                            type: "news",
                            id: "news." + e
                        })), s.pages.push({
                            name: "base",
                    ...
                    }), (Bt || St && !Bt) && xt && this.chartWidgetCollection && !this.chartWidgetCollection.readOnly() && s.pages.push({
                ...
                getLayoutState() {
                    ...
                    let e;
                    e = I.enabled("trading_terminal") ? this.getChartingPlatformLayoutState(t, "terminal") : this.getGenericLayoutState(t);
                    const i = t => !(void 0 !== t.isEnabled && !t.isEnabled) && (this.chartWidgetCollection || !(0, n.ensure)(v[t.type]).chartWidgetRequired);
                ...
                ensureSupportTicketButtonViewModel() {
                    return this._supportTicketButtonViewModel || (this._supportTicketButtonViewModel = new c({
                        icon: yt,
                ...
                createHTML() {
                    ...
                    e.classList.value = "widgetbar-wrap unselectable", e.setAttribute("data-name", "widgetbar-wrap"), t.appendChild(e);
                ...
                _getSerializedStateFromSetting() {
                    return this._settingsPrefix ? E.getJSON(this._settingsPrefix + ".layout-settings", null) : null
                }
                _setSerializedStateToSettings(t) {
                    this._settingsPrefix && E.setJSON(this._settingsPrefix + ".layout-settings", t)
                }
                ...
                constructor(t) {
                    this._helper = null, this._handleDragStart = t => {
                        ...
                        const {
                            current: e,
                            initial: i
                        } = t.detail, s = this._source, n = this._helper.nextTop, a = this._helper.nextLeft, r = "y" === this._axis || !1 === this._axis || 0 !== e.movementY;
                        if (r) {
                            const t = this._helper.startTop;
                            isFinite(t) && (this._helper.nextTop = e.clientY - i.clientY + t)
                        }
                        const o = "x" === this._axis || !1 === this._axis || 0 !== e.movementY;
                        if (o) {
                            const t = this._helper.startLeft;
                            isFinite(t) && (this._helper.nextLeft = e.clientX - i.clientX + t)
                        }
                        if (null !== this._helper.containment) {
                            const [t, e, i, s] = this._helper.containment;
                            r && this._helper.nextTop && (this._helper.nextTop = Math.min(this._helper.nextTop, s), this._helper.nextTop = Math.max(this._helper.nextTop, e)), o && this._helper.nextLeft && (this._helper.nextLeft = Math.min(this._helper.nextLeft, i), this._helper.nextLeft = Math.max(this._helper.nextLeft, t))
                        }
                        null !== this._helper.raf || n === this._helper.nextTop && a === this._helper.nextLeft || (this._helper.raf = requestAnimationFrame((() => {
                    ...
                    const i = this._handle = (t.handle ? e.querySelector(t.handle) : null) ? ? e;
                    i.classList.add("ui-draggable-handle"), this._start = t.start, this._stop = t.stop, this._drag = t.drag, this._backend = new r({
                        handle: i,
        ...
        821205: (t, e, i) => {
            ...
            function o(t) {
                ...
                if ("fixed" === e.position) i = t.getBoundingClientRect();
                    ...
                    n && n !== t && 1 === n.nodeType && (s = r(n), s.top += parseFloat(getComputedStyle(n).borderTopWidth), s.left += parseFloat(getComputedStyle(n).borderLeftWidth))
                }
                return {
        ...
        479796: (t, e, i) => {
            ...
            class l extends n.WidgetbarWidgetRenderer {
                constructor(t) {
                    super(t), this._history = null, this._mounted = !1, this._contentRenderer = null, this._mindsFormState = new a.WatchedValue({
                        opened: !1
                    }), this._bridge = t, this.mount()
                }
                navigate(t, e) {
                ...
                unmount() {
                    this._mounted ? (this._mounted = !1, r.setValue(!1), this._mindsFormState.setValue({
                        opened: !1
                    }), super.unmount(), this._loadModulePromise = null) : o.logWarn("Unmount was called on already unmounted widget")
                }
                destroy() {
                    super.destroy()
                }
                openMindForm() {
                    this._mindsFormState.setValue({
                        opened: !0
                    }, !0)
                }
                _load() {
                    if (this._contentRenderer) return r.setValue(!0), void this._contentRenderer();
                    const t = this._loadModulePromise = Promise.all([Promise.all([i.e(1430), i.e(4752), i.e(2520), i.e(8985), i.e(3782), i.e(8473), i.e(9162), i.e(5758), i.e(2115), i.e(6752), i.e(9824), i.e(6991)]).then(i.bind(i, 533615)), Promise.resolve().then(i.t.bind(i, 50959, 19)), Promise.resolve().then(i.t.bind(i, 632227, 19))]).then((([e, i, s]) => {
        ...
        865266: (t, e, i) => {
            "use strict";
            i.d(e, {
                useRovingTabindexElement: () => a
            });
            var s = i(50959),
                n = i(718736);

            function a(t, e = []) {
                const [i, a] = (0, s.useState)(!1), r = (0, n.useFunctionalRefObject)(t);
                return (0, s.useLayoutEffect)((() => {
                    ...
                    return t.addEventListener("roving-tabindex:main-element", e), t.addEventListener("roving-tabindex:secondary-element", e), () => {
                        t.removeEventListener("roving-tabindex:main-element", e), t.removeEventListener("roving-tabindex:secondary-element", e)
                    }
                }), e), [r, i ? 0 : -1]
            }
        },
        704095: (t, e, i) => {
            ...
            class r {
                ...
                mount() {
                    const t = this._promise = Promise.all([Promise.resolve().then(i.t.bind(i, 50959, 19)), Promise.resolve().then(i.t.bind(i, 632227, 19)), Promise.all([i.e(323), i.e(3703), i.e(3953), i.e(4752), i.e(2520), i.e(5826), i.e(9481), i.e(4600), i.e(7384), i.e(5480), i.e(3799), i.e(4353), i.e(7849), i.e(7431), i.e(8473), i.e(7762), i.e(4510), i.e(9393), i.e(4952), i.e(3054), i.e(3847), i.e(3251), i.e(3285), i.e(9937), i.e(3010), i.e(7415), i.e(5031)]).then(i.bind(i, 420779)), Promise.all([i.e(323), i.e(3703), i.e(3953), i.e(4752), i.e(2520), i.e(5826), i.e(9481), i.e(4600), i.e(7384), i.e(5480), i.e(3799), i.e(4353), i.e(7849), i.e(7431), i.e(8473), i.e(7762), i.e(4510), i.e(9393), i.e(4952), i.e(3054), i.e(3847), i.e(3251), i.e(3285), i.e(9937), i.e(3010), i.e(7415), i.e(5031)]).then(i.bind(i, 993321)), Promise.all([i.e(323), i.e(3703), i.e(3953), i.e(4752), i.e(2520), i.e(5826), i.e(9481), i.e(4600), i.e(7384), i.e(5480), i.e(3799), i.e(4353), i.e(7849), i.e(7431), i.e(8473), i.e(7762), i.e(4510), i.e(9393), i.e(4952), i.e(3054), i.e(3847), i.e(3251), i.e(3285), i.e(9937), i.e(3010), i.e(7415), i.e(5031)]).then(i.bind(i, 69649)), (0, a.loadAllSourcesIcons)()]).then((([e, i, a, r, o]) => {
                        if (this._promise === t) {
        ...
        181436: (t, e, i) => {
            ...
            const s = [() => navigator.userAgent.includes("Win") && navigator.userAgent.includes("Chrome") ? 1 / window.devicePixelRatio : 1, () => 16, (t = () => 0) => .8 * (t() ? ? 0)];
        ...
        397062: t => {
            t.exports = {
                button: "button-c8sm3pCb"
            }
        },
        733660: t => {
            t.exports = {
                filler: "filler-GfsAWtWz"
            }
        },
        677478: t => {
            t.exports = {
                toolbar: "toolbar-S4V6IoxY"
            }
        },
        403636: t => {
            t.exports = {
                separator: "separator-gZVyfVJP"
            }
        },
        286774: t => {
            t.exports = {
        ...
        333086: (t, e, i) => {
            ...
            i.d(e, {
                    becomeMainElement: () => n,
                    becomeSecondaryElement: () => a
                }),
                function(t) {
                    t.MainElement = "roving-tabindex:main-element", t.SecondaryElement = "roving-tabindex:secondary-element"
                }(s || (s = {}))
        },
        167645: (t, e, i) => {
            "use strict";
        ...
        602069: (t, e, i) => {
            ...
            const c = (0, s.forwardRef)((function(t, e) {
                const {
                    ...
                    blurOnClick: g = !0,
                    ...p
                } = t, m = (0, h.useFunctionalRefObject)(e);
                return (0, s.useLayoutEffect)((() => {
                    const t = (0, n.ensureNotNull)(m.current),
                        e = () => {
                            const e = (0, o.queryTabbableElements)(t).sort(o.navigationOrderComparator);
                            if (0 === e.length) {
                                const [e] = (0, o.queryFocusableElements)(t).sort(o.navigationOrderComparator);
                                if (void 0 === e) return;
                ...
                }), []), s.createElement("div", { ...d.MouseClickAutoBlurHandler.attributes(g),
                    ...p,
                    role: "toolbar",
                    "aria-orientation": c,
                    ref: m,
                    onKeyDown: (0, a.createSafeMulticastEventHandler)((function(t) {
                        ...
                        if (u && 27 === e) return t.preventDefault(), void document.activeElement.blur();
                        ...
                        const a = () => {
                                ...
                                (0, l.becomeSecondaryElement)(s[n]), (0, l.becomeMainElement)(s[t]), s[t].focus()
                            },
                            h = () => {
                                const t = (n + s.length + 1) % s.length;
                                (0, l.becomeSecondaryElement)(s[n]), (0, l.becomeMainElement)(s[t]), s[t].focus()
        ...
        112295: (t, e, i) => {
            ...
            function o() {
                const t = i.c[89935];
                return t ? Promise.resolve(t.exports.lineToolsIcons) : i.e(1890).then(i.bind(i, 89935)).then((t => t.lineToolsIcons))
            }

            function l() {
                const t = i.c[50296];
                return t ? Promise.resolve(t.exports.SERIES_ICONS) : i.e(9685).then(i.bind(i, 50296)).then((t => t.SERIES_ICONS))
            }
            let h = null;
        ...
        633201: (t, e, i) => {
            ...
            class u {
                constructor(t, e, i = {}) {
                    ...
                    })(), !1 !== this._options.showTopShadow && (this._shadowTop = document.createElement("div"), this._shadowTop.classList.add("sb-inner-shadow", "top", "i-invisible"),
                ...
                updateScrollBar() {
                    ...
                    const t = (0, r.position)(this._content).top,
                        ...
                        l = i * i / e;
                    return this.isContentShort() ? (this._scrollBar.classList.add("js-hidden"), this._wrapper.classList.remove("sb-scroll-active")) : (this._scrollBar.classList.remove("js-hidden"), this._scrollBar.style.height = l + "px", this._scrollBar.style.top = n + o + "px", this._wrapper.classList.add("sb-scroll-active"), this.initDraggable()), this
                }
                scroll(t, e) {
                ...
                destroy() {
                    this._animation && this._animation.stop(), this._scrollBarWrapper && this._scrollBarWrapper.remove(), this._shadowBottom && this._shadowBottom.remove(),
                        this._shadowTop && this._shadowTop.remove(), this._draggable && (this._draggable.destroy(), this._draggable = null), this._content.style.cssText = "", this._wrapper.style.cssText = "", this._unsubscribe ? .()
                }
                _onScroll(t) {
            ...
            function _(t) {
                return function(t) {
                    ...
                    for (var s = 0; s < t.length; s++) e = t.charCodeAt(s), i = (i << 5) - i + e, i |= 0;
                    return i
                }(t.title + t.published)
            }
            var v = i(671945),
            ...
            class W {
                constructor(t) {
                    this.widgetName = "widgetbar", this._newsScrollIterator = null, this._newsDiffResolver = null, this._updateWhenVisible = null, this._pendingNewsRequest = null, this._updateIntervalHandle = null, this._needsFullUpdate = !0, this._dataProvider = null, this._resize = this.resize.bind(this), this._onSymbolChange = this.onSymbolChange.bind(this), this._quoteSymbol = null, this._quoteMetaInfo = null, this._symbolName = null, this._setNewItemsTabIndexForKeyboardNavigation = () => {
                        const t = this._data,
                            e = (0, f.queryTabbableElements)(t).sort(f.navigationOrderComparator);
                        if (0 === e.length) {
                            const [e] = (0, f.queryFocusableElements)(t).sort(f.navigationOrderComparator);
                            if (void 0 === e) return;
                        ...
                        if (27 === e) return t.preventDefault(), void document.activeElement.blur();
                        if (38 !== e && 40 !== e) return;
                        const i = (0, f.queryFocusableElements)(this._data).sort(f.navigationOrderComparator);
                        ...
                        switch ((0, f.mapKeyCodeToDirection)(e)) {
                            case "blockPrev":
                                (() => {
                                    ...
                                    (0, b.becomeSecondaryElement)(i[s]), (0, b.becomeMainElement)(i[t]), i[t].focus()
                                })();
                                break;
                            case "blockNext":
                                (() => {
                    ...
                    }, this._bridge = t, this._widgetTitle = (0, s.ensureNotNull)(this._bridge.header.querySelector(".widgetbar-widgettitle")), this._spinner = new w.Spinner, this._container = t.container, this._prepareLayout(this._container);
                ...
                update(t) {
                    ...
                    this._needsFullUpdate = t || i !== this._symbolName, this._symbolName = i, this._needsFullUpdate && (this._startLoading(), this._updateIntervalHandle && clearInterval(this._updateIntervalHandle), this._setUpdateInterval()), this._pendingNewsRequest && this._pendingNewsRequest.cancel(), this._pendingNewsRequest = (0, p.makeCancelable)(this._dataProvider.getNews(e)), this._pendingNewsRequest.promise.then((t => {
                        ...
                        if (!(0, p.isCancelled)(t)) throw this._pendingNewsRequest = null, this._stopLoading(), t
                    }))
                }
                updateData(t) {
                    var e;
                    if (t && t.length)
                        if (this._needsFullUpdate) {
                            ...
                            if (!this._newsDiffResolver) return void T.logError("Attempt to perform partial update before full update was committed");
                ...
                highlight(t) {
                    ...
                    const e = () => {
                        t.classList.remove(L["news-item--highlight"]), t.removeEventListener("animationend", e)
                    };
                ...
                _prepareLayout(t) {
                    ...
                    i.classList.add("ns-data"), i.setAttribute("data-name", "news_list"), e.appendChild(i), this._scroll = new u(this._widget, this._data), this._bridge.height.subscribe(this._resize), this._bridge.visible.subscribe(this._resize), window.addEventListener("keyboard-navigation-activation", this._setNewItemsTabIndexForKeyboardNavigation)
                }
                _setUpdateInterval() {
                    if (!this._dataProvider) return;
                ...
                _renderItems(t, e = !1) {
                    ...
                    for (const s of t) {
                        ...
                        s.clickHandler && n.addEventListener("click", s.clickHandler), n.addEventListener("keydown", this._newsItemKeyDownListener), e && this.highlight(n), i.appendChild(n)
                    }
                    e ? this._data.prepend(i) : this._data.append(i), this._setNewItemsTabIndexForKeyboardNavigation()
                }
                _onScrollToEnd() {
