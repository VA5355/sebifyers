    ...
    [2650], {
        755962: (t, e, i) => {
            ...
            class c extends n.BrokerService {
                constructor(t, e, i) {
                    super(t, "ExecutionsService"), this._allExecutionsID = new Set, this._executions = [], this._executionsAdded = new a.Delegate, this._executionsCleared = new a.Delegate, this._formatter = new o.PriceFormatter, this._symbol = "", this._dataEvents = e, this._getSymbolName = i, this._initialized = !0, this._tryToStart()
                }
                formatter() {
                ...
                startService() {
                    this.activeBroker() ? .config.supportExecutions && (this._canBeStarted = !0, this._tryToStart())
                }
                stopService() {
                ...
                _createExecutions() {
                    ...
                    t && (this._actualTradingSymbolSubscription = this.trading().makeActualSymbolObservable(t) ? .subscribe((({
                        symbol: t
                    }) => {
                        t !== this._symbol && (this._symbol = t, this._requestFormatterAndExecutions())
                    })))
                }
                _clearExecutions() {
                    this._actualTradingSymbolSubscription ? .unsubscribe(), this._allExecutionsID = new Set, this._executions = [], this._executionsCleared.fire()
                }
                ...
                _createExecutionData(t) {
                    return t.symbol !== this._symbol || this._allExecutionsID.has(t.id) ? null : (this._allExecutionsID.add(t.id), { ...t,
                        tooltip: (0, l.executionText)(t, this._formatter)
                    })
                }
            }
        },
        808779: (t, e, i) => {
            ...
            class n {
                constructor(t, e, i) {
                    this._points = [], this._existingExecutionPointsCache = null, this._offsetOfFirstExistingPoint = null, this._existingPointsChanged = new r.Delegate,
                        this._pointsets = [], this._pointsetManagerFactory = e, this._firstSeriesTimePointWV = i, this._firstSeriesTimePointWV.subscribe(this._updateExistingPoints.bind(this)), this._executionsService = t, this._addPoints(this._executionsService.executions()), this._executionsService.executionsAdded().subscribe(this, this._addPoints), this._executionsService.executionsCleared().subscribe(this, this._clearPoints)
                }
                destroy() {
                ...
                existingPoints() {
                    return null === this._offsetOfFirstExistingPoint ? [] : (null === this._existingExecutionPointsCache && (this._existingExecutionPointsCache = this._points.slice(this._offsetOfFirstExistingPoint).filter(o)), this._existingExecutionPointsCache)
                }
                ...
                _updateExistingPoints() {
                    ...
                    null !== t && (null === this._offsetOfFirstExistingPoint && (this._offsetOfFirstExistingPoint = this._points.length), t < this._offsetOfFirstExistingPoint && (this._sendPointsToServer(t, this._offsetOfFirstExistingPoint), this._offsetOfFirstExistingPoint = t))
                }
                _clearPoints() {
        ...
        933417: (t, e, i) => {
            ...
            class n extends s.CustomSourceBase {
                ...
                _isSourceShouldBeShown(t) {
                    return !!t.containsMainSeries() && !(window.TradingView.printing && !(0, o.isTradingObjVisibleOnScreenshot)())
                }
            }
            var a, l = i(650151),
                c = i(65775),
                ...
                p = i(316167);
            ! function(t) {
                t[t.OverlayTransparency = 50] = "OverlayTransparency"
            }(a || (a = {}));
            const x = d.colorsPalette["color-tv-blue-500"],
                b = d.colorsPalette["color-ripe-red-500"],
                f = {
                    textColor: d.colorsPalette["color-cold-gray-200"],
                    overlayColor: (0, _.generateColor)(d.colorsPalette["color-cold-gray-900"], 50),
                    outlineColor: d.colorsPalette["color-cold-gray-900"]
                },
                m = {
                    textColor: d.colorsPalette["color-cold-gray-900"],
                    overlayColor: (0, _.generateColor)(d.colorsPalette["color-white"], 50),
                    outlineColor: d.colorsPalette["color-white"]
                };
            ...
            function w(t) {
                const e = t ? f : m,
                    ...
                    r = (0, p.blendColors)(x, e.overlayColor),
                    o = (0, p.blendColors)(b, e.overlayColor);
                return {
                    buyArrowColor: x,
                    sellArrowColor: b,
            ...
            class P {
                ...
                _updateImpl() {
                    ...
                    const i = (0, u.lowerbound)(e, t.firstBar(), ((t, e) => t.index < e), 0),
                        s = (0, u.upperbound)(e, t.lastBar(), ((t, e) => e.index > t), i);
                    if (i >= s) return;
                    const r = e.slice(i, s),
                ...
                _getYCoordinate(t, e) {
                    ...
                    const s = this._chartModel.mainSeries(),
                        ...
                        n = (0, c.barFunction)(o),
                        a = s.nearestData(t, h.PlotRowSearchMode.NearestLeft);
                    if (void 0 !== a) {
                        const t = n(a.value);
                ...
                _styleGetter() {
                    return w(this._chartModel.dark().value())
                }
            }
            var v = i(885800),
                y = i(184114),
            ...
            class F {
                constructor() {
                    this._data = {
                        ...
                        arrowHeight: 0,
                        arrowSpacing: 0
                    }, this._textWidthCache = new S.TextWidthCache, this._font = (0, v.makeFont)(A, g.CHART_FONT_FAMILY, k)
                }
                setData(t) {
                    this._data = t
                }
                hitTest(t) {
                    for (const e of this._data.points) {
                        const i = Math.round(e.x),
                            ...
                            r = 2 * E;
                        let o, n;
                        if (e.arrowUp ? (o = s, n = s + this._data.arrowHeight + this._data.arrowSpacing) : (o = s - this._data.arrowHeight - this._data.arrowSpacing, n = s), t.x >= i - E && t.x <= i + E && t.y >= o && t.y <= n && "" !== e.tooltip) {
                            const t = {
                                activeItem: e.id,
                            ...
                            }), new y.HitTestResult(y.HitTarget.Custom, t)
                        }
                    }
                    return null
                }
                draw(t, e) {
                    ...
                    t.save(), t.lineWidth = Math.max(T, Math.floor(T * i));
                    const r = 2 * E,
                        o = Math.max(1, Math.round(r * i)),
                        n = Math.max(1, Math.round(this._data.arrowHeight * s));
                    for (const e of this._data.points) {
                        const r = Math.round((e.x - E) * i),
                            a = Math.round(e.y * s);
                        (0, C.drawArrow)(t, r, a, e.arrowColor, e.outlineColor, !e.arrowUp, n, o, !0)
                    }
                    for (const r of this._data.labels) {
                        const o = Math.round((r.x - E) * i),
                            n = Math.round(r.y * s);
                        (0, C.drawOutlinedText)(t, e, r.text, o, n, this._textYMidCorrection(t, r.text), r.color, this._font, r.outlineColor)
                    }
                    if (this._data.executionEntryPoint) {
                        const e = Math.round((this._data.executionEntryPoint.x - V / 2) * i),
                            r = Math.round(this._data.executionEntryPoint.y * s),
                            o = Math.max(1, Math.round(M * i)),
                            n = Math.max(1, Math.round(V * s));
                        (0, C.drawOutlinedArrowHead)(t, e, r, this._data.executionEntryPoint.arrowColor, this._data.executionEntryPoint.outlineColor, o, n)
                    }
                    t.restore()
                }
                _textYMidCorrection(t, e) {
                    if (!e) return 0;
                    const i = t.font;
                    t.font = (0, l.ensureNotNull)(this._font);
            ...
            class H extends P {
                constructor(t, e) {
                    super(t), this._renderer = new F, this._points = [], this._source = e
                }
                _createRenderData(t) {
                    let e;
                    this._points = [];
                    const i = this._isPriceScaleInverted(),
                        s = new Map,
                        r = w(this._chartModel.dark().value()),
                        o = t.find((t => this._source.hoveredExecution() === t.id));
                    for (const n of t) {
                        const t = s.get(n.index) || R(i, r);
                        if (void 0 === t.x) {
                            const e = this._getXCoordinate(n.index);
                            if (null === e) continue;
                            t.x = e
                        }
                        const a = n.isBuyDirection !== i,
                            c = a ? "arrowUp" : "arrowDown",
                            h = a ? 1 : -1,
                            u = t[c].y;
                        if (void 0 === u) {
                        ...
                        s.set(n.index, t), o && o === n && (e = {
                            x: (0, l.ensureDefined)(t.x),
                            y: (0, l.ensureNotNull)(this._priceToCoordinate(o.price)),
                            arrowColor: t[c].color,
                            outlineColor: r.outlineColor
                        }), this._points.push({
                            id: n.id,
                            x: (0, l.ensureDefined)(t.x),
                            y: (0, l.ensureDefined)(t[c].y),
                            arrowUp: a,
                            arrowColor: t[c].color,
                            outlineColor: r.outlineColor,
            ...
            class W extends n {
                ...
                _createPaneViews() {
                    this._paneViews = [new H(this._model, this)]
                }
                _isSourceShouldBeShown(t) {
        ...
        913793: (t, e, i) => {
            ...
            class a {
                ...
                _setItemState(t, e) {
                    ...
                    e(i, new o.HitTestResult(o.HitTarget.Custom, {
                        activeItem: {
                            id: s.id(),
                            part: 9
                        }
        ...
        586679: (t, e, i) => {
            ...
            class d extends h.PriceAxisView {
                ...
                _updateRendererData(t, e, s) {
                    ...
                    const l = this._source.properties().childs(),
                        h = 0 === this._priceType ? (0, u.resetTransparency)(l.bidLineColor.value()) : (0, u.resetTransparency)(l.askLineColor.value());
                    t.visible = !0, e.visible = !0, t.text = o.formatPriceAbsolute(a), e.text = 0 === this._priceType ? c.t(null, void 0, i(395506)) : c.t(null, void 0, i(535928)), s.coordinate = o.priceToCoordinate(a, n), s.background = h, s.textColor = this.generateTextColor(h)
                }
            }
            var _ = i(296808),
                p = i(184114);
            ...
            var b, f = i(934135);
            ! function(t) {
                t[t.Bid = 0] = "Bid", t[t.Ask = 1] = "Ask"
            }(b || (b = {}));
            class m extends n.CustomSourceBase {
                constructor(t, e, i, s) {
                    ...
                    r.symbolResolved().subscribe(this, this._createTradedSymbol), r.symbolError().subscribe(this, this._createTradedSymbol), this._hibernated = e.collapsed().spawn(), this._hibernated.subscribe((t => {
                        t ? this._clearTradedSymbol() : this._createTradedSymbol()
                    })), this._createTradedSymbol()
                }
                destroy() {
                    const t = this._model.mainSeries().dataEvents();
                    t.symbolResolved().unsubscribeAll(this), t.symbolError().unsubscribeAll(this), this._hibernated.destroy(), this._clearTradedSymbol()
                }
                paneViews(t) {
                    return this._areViewsAvailableForPane(t) ? [this._bidLinesPaneView, this._askLinesPaneView] : []
                }
                labelPaneViews(t) {
                    return this._areViewsAvailableForPane(t) ? [this._bidLabelPaneView, this._askLabelPaneView] : []
                }
                priceAxisViews(t, e) {
                    return this._areViewsAvailableForPane(t) ? t.findTargetPriceAxisViews(this, e, this._regularPriceAxisViews, this._externalPriceAxisViews) : []
                }
                priceScale() {
                ...
                _createTradedSymbol() {
                    ...
                    t !== this._symbol && (this._clearTradedSymbol(), null === t || this._hibernated.value() || this._initTradedSymbol(t))
                }
                _initTradedSymbol(t) {
                ...
                _updateRealtimeData(t, e, i) {
                    const s = e.ask,
                        o = e.bid;
                    s === o ? (this._ask = null, this._bid = null) : ((0, r.isNumber)(s) && (this._ask = s), (0, r.isNumber)(o) && (this._bid = o)), (this._model.mainSeries().properties().childs().bidAsk.childs().visible.value() || this._model.properties().childs().scalesProperties.childs().showBidAskLabels.value()) && (this.updateAllViews((0, f.sourceChangeEvent)(this.id())), this._model.updateSource(this))
                }
                _areViewsAvailableForPane(t) {
                    return !this._model.isInReplay().value() && this._model.paneForSource(this._model.mainSeries()) === t
                }
            }
        }
    }
