(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
    [1584], {
        ...
        718736: (t, e, n) => {
            ...
            function i(t) {
                const e = (0, r.useMemo)((() => function(t) {
                        const e = n => {
                            t(n), e.current = n
                        };
                    ...
                    u = (0, r.useRef)(i);
                return u.current = i, (0, o.useIsomorphicLayoutEffect)((() => {
        ...
        855393: (t, e, n) => {
            ...
            function o(t, e) {
                ("undefined" == typeof window ? r.useEffect : r.useLayoutEffect)(t, e)
            }
        },
        778199: (t, e, n) => {
            "use strict";
            ...
            function i(t, e) {
                return class extends r.PureComponent {
                    render() {
                        ...
                        if (!n) return null;
                        const s = r.createElement(t, { ...this.props,
                            ref: this.props.componentRef,
                            zIndex: 150
                        });
                        return "parent" === i ? s : r.createElement(o.Portal, {
                            shouldTrapFocus: e
                        }, s)
                    }
                }
        ...
        545399: (t, e, n) => {
            ...
            class a {
                constructor(t, e, n, o) {
                    ...
                    }, this._onDestroy = n, this._onShow = o, this._activeElement = document.activeElement, this._returnFocus = e.returnFocus, this._takeFocus = e.takeFocus, this._menuElementRef = r.createRef(), this._doNotCloseOn = e.doNotCloseOn, e.manager && (this._manager = e.manager)
                }
                show(t) {
                    this._onShow && this._onShow(), this._isShown = !0, this._render({ ...this._props,
                        position: e => {
                            ...
                            const a = t.marginX ? ? 0,
                                c = t.marginY ? ? 0;
                            let l, h;
                            switch (l = void 0 === t.attachToXBy ? (0, s.isRtl)() ? "right" : "left" : "auto" === t.attachToXBy ? (0, s.isRtl)() ? u.x - a - n >= 0 ? "right" : "left" : u.x + u.w + a + n <= o ? "left" : "right" : t.attachToXBy, l) {
                                case "left":
                                    h = u.x + u.w + a;
                                    break;
                                case "right":
                ...
                _unmount() {
                    this._isShown = !1, o.unmountComponentAtNode(this._root), this._onDestroy && this._onDestroy(), this._returnFocus && this._activeElement instanceof HTMLElement && this._activeElement.focus({
                        preventScroll: !0
                    })
                }
                _render(t) {
                    o.render(r.createElement(u.SlotContext.Provider, {
                        value: this._manager
