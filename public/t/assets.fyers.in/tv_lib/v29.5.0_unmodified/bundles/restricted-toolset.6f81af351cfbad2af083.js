(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
    [5516, 9685, 9937], {
        ...
        908783: (e, t, n) => {
            ...
            function s(e) {
                const {
                    ...
                    handler: r,
                    reference: h
                } = e, c = (0, i.useRef)(null), d = (0, i.useRef)("undefined" == typeof window ? 0 : new window.CustomEvent("timestamp").timeStamp);
        ...
        823030: (e, t, n) => {
            ...
            function o(e) {
                const [t, n] = (0, i.useState)(null), o = (0, i.useRef)(null), s = (0, i.useRef)(new Map);
        ...
        730654: (e, t, n) => {
            ...
            class h extends i.PureComponent {
                ...
                render() {
                    ...
                    return t && ("string" == typeof t ? e.classList.add(t) : e.classList.add(...t)), this.props.shouldTrapFocus && !e.hasAttribute(l.FOCUS_TRAP_DATA_ATTRIBUTE) && e.setAttribute(l.FOCUS_TRAP_DATA_ATTRIBUTE, "true"), this.props["aria-hidden"] && e.setAttribute("aria-hidden", "true"), a.createPortal(i.createElement(c.Provider, {
                        value: this
        ...
        984950: (e, t, n) => {
            ...
            function m(e) {
                const t = (0,
                        a.useContext)(l.CustomBehaviourContext),
                    {
                        size: n,
                        intent: i = "default",
                        checked: s,
                ...
                }, a.createElement("input", { ...M,
                    type: "checkbox",
                    className: o(v().input, c && v().activeStylesEnabled, s && v().checked, u && v().disabled),
                    role: C,
                    "aria-checked": s,
                    checked: s,
                    onKeyDown: e => {
                ...
                moveToTop(e) {
                    if (this.getZindex(e) !== this._index) {
                        ...
                        this._windows.forEach(((e, n) => {
                            e.hasAttribute(a.FOCUS_TRAP_DATA_ATTRIBUTE) && e.setAttribute(a.FOCUS_TRAP_DATA_ATTRIBUTE, e === t ? "true" : "false")
        ...
        285089: (e, t, n) => {
            ...
            function r(e) {
                ...
                if (e && 1 == ++s) {
                    ...
                    "hidden" !== e.toLowerCase() && t.scrollHeight > t.offsetHeight && ((0, i.setStyle)(n, "right", `${(0,i.getScrollbarWidth)()}px`), t.style.paddingRight = `${a+(0,i.getScrollbarWidth)()}px`, l = !0), t.classList.add("i-no-scroll")
                } else if (!e && s > 0 && 0 == --s && (t.classList.remove("i-no-scroll"), l)) {
                    (0, i.setStyle)(n, "right", "0px");
                    let e = 0;
                    e = n ? (r = (0, i.getContentWidth)(n), a() ? 0 : o() ? 45 : Math.min(Math.max(r, 45), 450)) : 0, t.scrollHeight <= t.clientHeight && (e -= (0, i.getScrollbarWidth)()), t.style.paddingRight = (e < 0 ? 0 : e) + "px", l = !1
                }
                var r
            }
        },
            ...
            function c(e) {
                ...
                return (0, i.useLayoutEffect)((() => {
                    const e = (0, a.ensureNotNull)(t.current),
                        n = () => {
                            const n = (0, o.queryTabbableElements)(e).sort(o.navigationOrderComparator);
                            if (0 === n.length || n[0].parentElement && !v(n[0].parentElement, (0, a.ensureNotNull)(t.current))) {
                                const i = function(e) {
                    ...
                    } else l = (v = a, Array.from(v.querySelectorAll("button:not([disabled]):not([aria-disabled])")).filter((0, r.createScopedVisibleElementFilter)(v))).sort(o.navigationOrderComparator), c = l.indexOf(i);
                    var v;
                    ...
                    switch (p) {
                        ...
                        case "blockNext":
                            (n => {
                                ...
                                if (!o) return;
                                const s = Array.from(o.children).indexOf(document.activeElement);
                                if (-1 === s) return;
                                const l = i["blockNext" === n ? i.indexOf(o) + 1 : i.indexOf(o) - 1];
                                if (!l) return;
                                t.preventDefault();
        ...
        759339: (e, t, n) => {
            ...
            function v(e) {
                const {
                    ...
                    className: v,
                    theme: p = d
                } = e, g = (0, a.ensureNotNull)((0, i.useContext)(r.DrawerContext)), [b] = (0, i.useState)((() => (0, s.randomHash)())), w = (0, i.useRef)(null), f = (0, i.useContext)(h.CloseDelegateContext);
                return (0, i.useLayoutEffect)((() => ((0, a.ensureNotNull)(w.current).focus({
                    preventScroll: !0
                }), f.subscribe(g, n), g.addDrawer(b), () => {
                    g.removeDrawer(b), f.unsubscribe(g, n)
                })), []), i.createElement(l.Portal, null, i.createElement("div", {
                    ref: u,
                    className: o(d.wrap, d[`position${t}`])
            ...
            class w extends i.PureComponent {
                constructor(e) {
                    super(e), this._containerRef = null, this._scrollWrapRef = null, this._raf = null, this._scrollRaf = null, this._scrollTimeout = void 0, this._manager = new d.OverlapManager, this._hotkeys = null, this._scroll = 0, this._handleContainerRef = e => {
                        ...
                        const {
                            position: n
                        } = this.props, i = (0, s.ensureNotNull)(this._containerRef);
                        ...
                        const d = a.height > c;
                        if (d) {
                            (0, s.ensureNotNull)(this._scrollWrapRef).style.overflowY = "scroll", a = i.getBoundingClientRect()
                        }
                        const {
                            width: u,
                            height: v
                        } = a, m = "function" == typeof n ? n({
                            contentWidth: u,
                            contentHeight: v,
                            availableWidth: r,
                            availableHeight: o
                        }) : n, p = m ? .indentFromWindow ? .left ? ? 0, g = r - (m.overrideWidth ? ? u) - (m ? .indentFromWindow ? .right ? ? 0), b = (0, l.clamp)(m.x, p, Math.max(p, g)), w = (m ? .indentFromWindow ? .top ? ? 0) + h, f = o - (m.overrideHeight ? ? v) - (m ? .indentFromWindow ? .bottom ? ? 0);
                        let C = (0, l.clamp)(m.y, w, Math.max(w, f));
                        if (m.forbidCorrectYCoord && C < m.y && (c -= m.y - C, C = m.y), t && void 0 !== this.props.closeOnScrollOutsideOffset && m.y <= this.props.closeOnScrollOutsideOffset) return void this._handleGlobalClose(!0);
                ...
                componentDidMount() {
                    ...
                    this._hotkeys || n || (this._hotkeys = u.createGroup({
                        desc: "Popup menu"
                    }), this._hotkeys.add({
                        desc: "Close",
                        hotkey: 27,
                ...
                render() {
                    ...
                    return i.createElement(m.MenuContext.Provider, {
                        value: this
                    }, i.createElement(v.SubmenuHandler, null, i.createElement(h.SlotContext.Provider, {
                        value: this._manager
                    }, i.createElement("div", {
                        id: e,
                        role: t,
                        ...
                        className: o()(b.scrollWrap, !this.props.noMomentumBasedScroll && b.momentumBased),
                        style: {
            ...
            function f(e) {
                ...
                return i.createElement("div", {
                    ...
                    onMouseOver: function(e) {
                        if (!(null !== t.current && e.target instanceof Node && (i = e.target, n.current ? .contains(i)))) return;
                        var i;
        ...
        917850: (e, t, n) => {
            ...
            function r(e) {
                ...
                return a.createElement("div", {
                    className: s()(l.separator, "small" === t && l.small, "normal" === t && l.normal, "large" === t && l.large, n),
                    role: "separator",
                    "aria-hidden": i
                })
            }! function(e) {
        ...
        742554: (e, t, n) => {
            ...
            const h = (0,
                ...
                return (0, i.useImperativeHandle)(t, (() => h.current)), (0, i.useLayoutEffect)((() => {
                    if (s.CheckMobile.iOS()) return r++, null !== h.current && (l ? 1 === r && (document.body.style.overscrollBehavior = "none") : (0, a.disableBodyScroll)(h.current, {
                        allowTouchMove: c(h)
                    })), () => {
                        r--, null !== h.current && (l ? 0 === r && (document.body.style.overscrollBehavior = "") : (0, a.enableBodyScroll)(h.current))
                    }
                }), []), i.createElement("div", {
                    ref: h,
                    ...o
        ...
        975598: (e, t, n) => {
            ...
            const l = (0, i.forwardRef)((function(e, t) {
                const {
                    ...
                    reference: h,
                    ...c
                } = e, d = (0, a.useFunctionalRefObject)(h ? ? null);
        ...
        628741: (e, t, n) => {
            ...
            const r = (0, i.forwardRef)((function(e, t) {
                ...
                return i.createElement(i.Fragment, null, i.createElement("div", { ...u,
                    ...
                    ref: t,
                    tabIndex: c
                }, a, i.createElement(s.ToolWidgetCaret, {
                    className: l.caret,
                    dropped: Boolean(n)
                })), n && r)
            }))
        ...
        840781: (e, t, n) => {
            ...
            function c(e) {
                const {
                    ...
                    isActive: a,
                    ...c
                } = e, [d, u] = (0, s.useRovingTabindexElement)(null), v = n ? r.removeTitlesMap[r.RemoveTitleType.Remove] : r.removeTitlesMap[r.RemoveTitleType.Add];
                return (0, i.useLayoutEffect)((() => {
                    const e = d.current;
                    e instanceof HTMLElement && e.dispatchEvent(new CustomEvent("common-tooltip-update"))
                }), [v, d]), i.createElement("button", {
                    ref: d,
                    tabIndex: u,
                    onClick: t,
                    ...
                    "aria-label": v,
                    "data-tooltip": v
                }, i.createElement(l.FavoriteButton, { ...c,
                    isFilled: n,
                    isActive: a,
                    title: ""
                }))
        ...
        372319: (e, t, n) => {
            ...
            function v(e) {
                const {
                    ...
                    switchRole: _,
                    icon: S
                } = e, [x, M] = (0, h.useRovingTabindexElement)(null), E = o()(C.label, n && !g && C.labelOn), T = o()(u, C.wrapper, n && C.wrapperWithOnLabel, p && C.wrapperWithDescription);
                return i.createElement("label", {
                    ...
                    onKeyDown: function(e) {
                        ...
                        13 !== t && 32 !== t || (e.preventDefault(), x.current instanceof HTMLElement && x.current.click())
                    },
                    tabIndex: M,
                    "data-role": "menuitem",
                    "aria-disabled": e.disabled || void 0,
                    "aria-selected": n
                }, void 0 !== S && i.createElement(l.Icon, {
                    className: C.icon,
                    icon: S
                }), i.createElement("div", {
        ...
        455496: (e, t, n) => {
            ...
            function d(e) {
                const {
                    ...
                    onKeyDown: d,
                    ...u
                } = e, [v, m] = (0, l.useRovingTabindexElement)(null);
                return i.createElement("button", {
                    ...
                    type: "button"
                }, i.createElement(r.RemoveButton, { ...u,
                    isActive: a,
                    title: "",
                    icon: h
                }))
            ...
            function h(e, t) {
                return n => {
                    const {
                        ...
                        contentHeight: c,
                        availableHeight: d
                    } = n, u = (0, l.ensureNotNull)(e).getBoundingClientRect(), {
                    ...
                    w === i.AutoStrict && (d < u.y + u.height + g + c ? (w = i.Top, f = o.FromBottomToTop) : (w = i.Bottom, f = o.FromTopToBottom));
            ...
            const l = s,
                r = i.forwardRef(((e, t) => {
                    const {
                        ...
                        "data-tooltip": x,
                        ...M
                    } = e, E = a(C, f.button, (w || x) && "apply-common-tooltip", {
                        [f.isActive]: h,
                        [f.isOpened]: c,
                        ...
                        [f.hover]: v,
                        [f.clicked]: m
                    }), T = l && ("string" == typeof l ? i.createElement(o.Icon, {
                        className: f.icon,
                        icon: l
                    }) : i.cloneElement(l, {
                        className: a(f.icon, l.props.className)
                    }));
                    return "button" === n ? i.createElement("button", { ...M,
                        ref: t,
                        type: "button",
                    ...
                    }, g), T, !b && g && i.createElement("div", {
                        className: a("js-button-text", f.text)
                    }, g)) : i.createElement("div", { ...M,
                        ref: t,
                        "data-role": "button",
                        className: E,
                        onClick: d ? void 0 : p,
        ...
        679458: (e, t, n) => {
            ...
            class f extends i.PureComponent {
                constructor(e) {
                    super(e), this._wrapperRef = null, this._controller = i.createRef(), this._onPopupCloseOnClick = e => {
                        ...
                        (m.enabled("skip_event_target_check") || e.target instanceof Node) && e.currentTarget.contains(e.target) && (this._handleToggleDropdown(void 0, (0, p.isKeyboardClick)(e)), this.props.onClick && this.props.onClick(e, !this.state.isOpened))
                        ...
                        const {
                            ...
                            isOpened: a
                        } = this.state, o = "boolean" == typeof e ? e : !a;
                        this.setState({
                            isOpened: o,
                            shouldReturnFocus: !!o && t
                        }), o && i && i(), !o && n && n()
                    }, this._handleClose = () => {
                        this.close()
                ...
                render() {
                    ...
                    return "button" === e ? i.createElement("button", {
                        type: "button",
                        id: t,
                    ...
                    }, _, n && i.createElement("div", {
                        className: p.arrow
                    }, i.createElement("div", {
                        className: p.arrowWrap
                    }, i.createElement(r.ToolWidgetCaret, {
                        dropped: f
                    }))), this.state.isOpened && (g ? i.createElement(v.MatchMedia, {
                        rule: g
                    }, (e => this._renderContent(e))) : this._renderContent(l))) : i.createElement("div", {
                        id: t,
                        className: y,
                ...
                _renderContent(e) {
                    ...
                    }, g = Boolean(m && e && r), b = C(h) ? h({
                        isDrawer: g
                    }) : h;
                    return g ? i.createElement(c.DrawerManager, null, i.createElement(d.Drawer, {
                        reference: this.props.drawerReference,
                        onClose: this._handleClose,
                        position: r,
                        "data-name": t
                    }, b)) : i.createElement(l.PopupMenu, {
        ...
        939157: (e, t, n) => {
            ...
            const s = (0, i.forwardRef)((function(e, t) {
                ...
                return i.createElement(o.AccessibleIconButton, { ...e,
                    ref: n,
                    tabIndex: s
                })
            }))
        ...
        843833: (e, t, n) => {
            ...
            const r = (0, i.forwardRef)((function(e, t) {
                const {
                    ...
                    ...h
                } = e, [c, d] = (0, o.useRovingTabindexElement)(null), u = (0, a.useFunctionalRefObject)(r);
        ...
        719338: (e, t, n) => {
            ...
            class w extends a.PureComponent {
                ...
                render() {
                    ...
                    return a.createElement(g.ToolbarButton, { ...d,
                        icon: t,
                        text: i,
                        tooltip: n,
                        isDisabled: o,
            ...
            function A(e) {
                ...
                return a.createElement("div", { ...i,
                    ...
                    onKeyDown: (0, E.createSafeMulticastEventHandler)((function(e) {
                        ...
                        const i = (a = e.currentTarget, Array.from(a.querySelectorAll('[role="radio"]:not([disabled]):not([aria-disabled])')).filter((0, H.createScopedVisibleElementFilter)(a))).sort(k.navigationOrderComparator);
                        var a;
            ...
            class O extends a.PureComponent {
                constructor(e, t) {
                    ...
                    } = t, a = n.activeChartStyle.value(), s = i.get(), l = new Set((0, x.allChartStyles)());
                    this.state = {
                        activeStyle: a,
                        favorites: s,
                        styles: D.reduce(((e, t) => {
                ...
                render() {
                    ...
                    return a.createElement(C.MatchMedia, {
                        ...
                        const t = u.map(((t, n) => t === W ? a.createElement(f.PopupMenuSeparator, {
                            key: `separator-${n}`
                        ...
                        })))), a.createElement(d.ToolbarMenuButton, {
                            arrow: Boolean(b),
                            content: b ? void 0 : a.createElement(p, null, a.createElement(s.Icon, {
                                icon: c.SERIES_ICONS[o]
                            })),
                            tooltip: b ? l.t(null, void 0, n(127246)) : (0, M.getTranslatedChartStyleName)(o),
                            className: N.menu,
                            isDrawer: e,
                ...
                _renderPopupMenuItem(e, t, n) {
                    ...
                    return a.createElement(I.AccessibleMenuItem, {
                        ...
                        toolbox: i && a.createElement(R.MenuFavoriteButton, {
                            isActive: t,
                            isFilled: o,
            ...
            const U = ["medium", "small"],
                P = (0, a.forwardRef)((function(e, t) {
                    ...
                    return a.createElement(B.ToolWidgetButton, { ...l,
                        ref: t,
                        text: r ? n : void 0,
            ...
            function z(e) {
                const {
                    tooltip: t,
                    ...n
                } = e, [i, o] = (0, F.useRovingTabindexElement)(null);
                return a.createElement(P, {
                    "aria-label": t,
                    ...n,
                    tag: "button",
            ...
            class j extends a.PureComponent {
                ...
                render() {
                    ...
                    return a.createElement(z, { ...this.props,
                        icon: q,
                        isOpened: e,
                        onClick: this._handleClick,
            ...
            class ae extends a.PureComponent {
                constructor(e, t) {
                    super(e, t), this._updateState = () => {
                        this.setState({
                            icon: ie(this.context.chartWidgetCollection)
                        })
                    }, this._handleClick = () => {
                        const {
                            chartWidgetCollection: e
            ...
            function ce(e) {
                ...
                return e.forEach((e => {
                ...
                })), 0 !== a.size && t.push((0, re.studyMetaInfoRepository)().findAllJavaStudies().then((e => {
                    const t = new Map;
                    for (const n of e) !n.is_hidden_study && a.has(n.id) && t.set(n.id, {
                        name: n.description,
                    ...
                    return t.items
                }))), Promise.all(t).then((e => (he.logNormal("Requesting favorites info finished"), e.reduce(((e, t) => e.concat(t)), []))))
            }
            var de = n(128492),
                ue = n(651407),
                ve = n(531600),
            ...
            class Ce extends a.PureComponent {
                constructor(e, t) {
                    super(e, t), this._promise = null, this._menu = a.createRef(), this._menuItemsContainer = a.createRef(), this._favoriteFundamentalsModel = null, this._setActiveState = e => {
                        this.setState({
                            isActive: e
                        })
                    }, this._handleClick = e => {
                        ...
                        } = this.context, t = [...(0, oe.ensureDefined)(e).favorites()];
                        this.setState({
                            favorites: t
                        }), this._clearCache()
                ...
                componentDidMount() {
                    ...
                    e.visible().subscribe(this._setActiveState), void 0 !== t && (t.favoritesChanged().subscribe(this, this._handleFavoriteIndicatorsChange), n.activeChartWidget.subscribe(this._handleChangeActiveWidget)), pe.on("TVScriptRenamed", this._handleScriptRenamed, null)
                }
                componentWillUnmount() {
                    const {
                        studyMarket: e
                    ...
                    e.visible().unsubscribe(this._setActiveState), void 0 !== t && (t.favoritesChanged().unsubscribe(this, this._handleFavoriteIndicatorsChange), n.activeChartWidget.unsubscribe(this._handleChangeActiveWidget)), pe.unsubscribe("TVScriptRenamed", this._handleScriptRenamed, null), this._promise = null
                }
                render() {
                    const {
                        isActive: e,
                    ...
                    return a.createElement(a.Fragment, null, a.createElement(p, {
                    ...
                    }), Boolean(t.length > 0 || i ? .size) && a.createElement(C.MatchMedia, {
                        rule: "(max-width: 440px)"
                    }, (e => a.createElement(d.ToolbarMenuButton, {
                        ...
                        className: v()(be.dropdown, e && be.smallWidthWrapper)
                    }, a.createElement(me.ToolWidgetMenuSummary, {
                        className: e && be.smallWidthTitle
                    }, l.t(null, void 0, n(952530))), o && a.createElement(ve.ToolWidgetMenuSpinner, null), !o && a.createElement(a.Fragment, null, this.state.infos.length > 0 ? this.state.infos.map((t => a.createElement(I.AccessibleMenuItem, {
                        role: "menuitem",
                        ...
                        label: a.createElement("span", {
                            className: v()(!e && be.label, e && be.smallWidthLabel, "apply-overflow-tooltip")
                        }, ye(t))
                    }))) : null !== this._promise && a.createElement(se.PopupMenuItem, {
                        isDisabled: !0,
                ...
                _prefetchFavorites() {
                    ...
                    const t = this._promise = Promise.all([ce(this.state.favorites), void 0]).then((e => {
                        ...
                        let a = [...n];
                        if (i) {
                            const e = i.filter((e => this.state.favoriteFundamentals ? .has(e.scriptIdPart))).map(this._mapFundamentalToFavoriteItemInfo);
                            a.push(...e)
                        }
                        a = [...a].sort(((e, t) => ye(e).localeCompare(ye(t)))), this.setState({
                            infos: a,
                            isLoading: !1
                        }, (() => {
                            this._menu.current ? .update(), this._menuItemsContainer.current && document.activeElement === this._menuItemsContainer.current && (0, le.focusFirstMenuItem)(this._menuItemsContainer.current)
                        }))
                    }))
                }
                _trackClick() {
            ...
            function Me(e) {
                return a.createElement("div", {
                    className: u(xe.value, {
                        [xe.selected]: e.isSelected
                    })
                }, e.value, e.metric)
            }
            var Ee = n(522224),
            ...
            function Ae(e) {
                const {
                    ...
                    ...b
                } = e, [w, f] = (0, Ee.useHover)(), C = a.useCallback((e => u(n, e)), [u, n]), y = a.useCallback((() => m(n)), [m, n]), S = (0, a.useRef)(null);
                ...
                }), [c, g]), a.createElement("div", { ...f,
                    ref: S
                }, a.createElement(I.AccessibleMenuItem, { ...b,
                    role: t,
                    className: v()(He.menuItem, p && He.smallWidthMenuItem, c && He.signal),
            ...
            const Ie = {
                [Se.ResolutionKind.Ticks]: l.t(null, {
                    context: "interval_group_name"
                }, n(570784)),
                [Se.ResolutionKind.Seconds]: l.t(null, {
                    context: "interval_group_name"
                }, n(432116)),
                [Se.ResolutionKind.Minutes]: l.t(null, {
                    context: "interval_group_name"
                }, n(921551)),
                [Se.SpecialResolutionKind.Hours]: l.t(null, {
                    context: "interval_group_name"
                }, n(418817)),
                [Se.ResolutionKind.Days]: l.t(null, {
                    context: "interval_group_name"
                }, n(957252)),
                [Se.ResolutionKind.Weeks]: l.t(null, {
                    context: "interval_group_name"
                }, n(241815)),
                [Se.ResolutionKind.Months]: l.t(null, {
                    context: "interval_group_name"
                }, n(289506)),
                [Se.ResolutionKind.Range]: l.t(null, {
                    context: "interval_group_name"
                }, n(27514)),
            ...
            function Oe(e) {
                ...
                return a.createElement(We.CollapsibleSection, { ...n,
                    ref: i,
                    tabIndex: o,
                    "data-role": "menuitem",
            ...
            const Ue = {
                ...
                Ke = new Ne.Delegate,
                Qe = a.lazy((async () => ({
                    default: (await Promise.all([n.e(1025), n.e(4524), n.e(5816), n.e(1356), n.e(9258), n.e(5480), n.e(5387), n.e(3799), n.e(6445), n.e(9296), n.e(8222), n.e(2106), n.e(422), n.e(2234), n.e(8859), n.e(9216), n.e(4013)]).then(n.bind(n, 116102))).ToolWidgetIntervalsAddDialog
                })));
            class qe extends a.PureComponent {
                constructor(e, t) {
                    super(e, t), this._menu = a.createRef(), this._menuItemsContainerRef = a.createRef(), this._drawerContainerRef = a.createRef(), this._renderChildren = (e, t) => {
                        const n = this._customIntervals ? 1 : 0,
                            i = function(e) {
                                ...
                                return e.forEach((e => {
                                    ...
                                    l.isMinuteHours() ? a.items.push(e) : l.isMinutes() ? (0, Se.isHour)(Number(l.multiplier())) ? a.items.push(e) : i.items.push(e) : l.isSeconds() ? n.items.push(e) : l.isDWM() ? o.items.push(e) : l.isRange() ? s.items.push(e) : l.isTicks() && t.items.push(e)
                                })), [t, n, i, a, o, s].filter((e => 0 !== e.items.length))
                            }(e),
                            a = i.length + n;
                        return [...this._createIntervalItem(t, a), ...this._createMenuItems(i, t, n, a)]
                        ...
                        void 0 !== e && e !== r.linking.interval.value() && this.context.chartWidgetCollection.setResolution(e), e && (0, K.trackEvent)("GUI", "Time Interval", e)
                    }, this._handleClickFavorite = e => {
                        ...
                        const {
                            ...
                            menuViewState: a
                        } = this.state, o = n.add(e, t);
                        if (o) {
                            this.setState({
                                lastAddedInterval: o
                            });
                            const e = Se.Interval.parseExt(o);
                            if (e.interval.isMinuteHours()) return void i.set({ ...a,
                                [Se.SpecialResolutionKind.Hours]: !1
                            });
                            const t = e.guiResolutionKind;
                            if (t === Se.ResolutionKind.Days || t === Se.ResolutionKind.Weeks || t === Se.ResolutionKind.Months) return void i.set({ ...a,
                    ...
                    const c = r.linking.interval.value(),
                        ...
                        m = h.get();
                    this._defaultIntervals = n.defaultResolutions().filter(_e.isIntervalEnabled).map(_e.normalizeIntervalString), this.state = {
                        isOpenedFormMenu: !1,
                        activeInterval: d,
                        favorites: u,
                        customs: v,
                ...
                componentDidMount() {
                    ...
                    e.getOnChange().subscribe(this, this._handleChangeFavorites), n.getOnChange().subscribe(this, this._handleChangeMenuViewState), t.getOnChange().subscribe(this, this._handleChangeCustoms), r.linking.interval.subscribe(this._handleChangeInterval), r.linking.intraday.subscribe(this._bindedForceUpdate), r.linking.seconds.subscribe(this._bindedForceUpdate), r.linking.ticks.subscribe(this._bindedForceUpdate), r.linking.range.subscribe(this._bindedForceUpdate), r.linking.supportedResolutions.subscribe(this._bindedForceUpdate), r.linking.dataFrequencyResolution.subscribe(this._bindedForceUpdate), Ve.globalCloseDelegate.subscribe(this, this._handleGlobalClose)
                }
                componentWillUnmount() {
                    const {
                        favoriteIntervalsService: e,
                ...
                render() {
                    ...
                    } = this.state, l = this._getQuicks(), r = (0, _e.sortResolutions)([...l]);
                    ...
                    (void 0 !== n ? v.concat(n) : v).filter(_e.isAvailable).forEach((e => c[e] = !0));
                    const m = void 0 !== n ? (0, _e.getTranslatedResolutionModel)(n) : null;
                    return a.createElement(p, {
                        id: t
                    }, h && a.createElement(A, {
                        className: Be.group,
                        ...
                        rule: y.DialogBreakpoints.TabletSmall
                    }, (e => a.createElement(a.Fragment, null, a.createElement(Ze.CloseDelegateContext.Provider, {
                        value: Ke
                    }, a.createElement(d.ToolbarMenuButton, {
                        arrow: Boolean(h),
                        closeOnClickOutside: !s,
                        content: h || null === m ? void 0 : a.createElement(p, {
                    ...
                    }, this._renderChildren(v, e)))), s && a.createElement(a.Suspense, {
                        fallback: null
                    }, a.createElement(Qe, {
                ...
                _createMenuItems(e, t, n, i) {
                    const a = e.map(((e, a, o) => this._renderResolutionsGroup(e, 1 === o.length, t, a + 1 + n, i)));
                    return function(e) {
                        let t = !1;
                        return e.filter(((e, n, i) => {
                            let a = !0;
                            return e.type === f.PopupMenuSeparator && (0 !== n && n !== i.length - 1 || (a = !1), t && (a = !1)), t = e.type === f.PopupMenuSeparator, a
                        }))
                    }([].concat(...a))
                }
                _createIntervalItem(e, t) {
                    return this._customIntervals ? [a.createElement(Ge, {
                        key: "add-dialog",
                        "aria-level": 1,
                        "aria-posinset": 1,
                        "aria-setsize": t,
                ...
                _renderResolutionsGroup(e, t = !1, n, i, o) {
                    const s = [],
                        l = t ? 1 : 2,
                        r = e.items.map(((t, i) => this._renderPopupMenuItem(t, n, i + 1, e.items.length, l)));
                    if (t) s.push(...r);
                    else if (n) {
                        const t = a.createElement(je, {
                            key: e.id,
                            title: e.name
                        }, r);
                        s.push(t)
                    ...
                    return (!e.mayOmitSeparator || e.items.length > 1) && (s.unshift(a.createElement(f.PopupMenuSeparator, {
                        key: `begin-${e.name}`
                    })), s.push(a.createElement(f.PopupMenuSeparator, {
                        key: `end-${e.name}`
                    }))), s
                }
                ...
                _renderPopupMenuItem(e, t, n, i, o) {
                    const {
                        ...
                        activeInterval: l,
                        lastAddedInterval: r
                    } = this.state, h = e === l, c = (0, _e.isAvailable)(e), d = this._isIntervalFavorite(e), u = this._isIntervalDefault(e), v = (0, _e.getTranslatedResolutionModel)(e);
            ...
            function Ge(e) {
                ...
                return a.createElement(I.AccessibleMenuItem, { ...s,
                    key: "add-dialog",
                    role: "row",
                    "aria-haspopup": "dialog",
            ...
            function je(e) {
                ...
                return a.createElement("div", {
                    ...
                    className: Be.smallTabletSectionTitle
                }, n), t)
            }
            qe.contextType = ze;
            var Xe = n(236488),
                ...
                constructor(e, t) {
                    super(e, t), this._handleClick = () => {
                        ...
                        const a = function() {
                            ...
                            return delete t.show_popup_button,
                                e.hash = `#${encodeURIComponent(JSON.stringify(t))}`, e.toString()
                        }();
                        i.withModel(null, (() => {
            ...
            class nt extends a.PureComponent {
                constructor(e, t) {
                    super(e, t), this._updateState = e => {
                        ...
                        const {
                            chartWidgetCollection: t
                        } = this.context, n = t.activeChartWidget.value();
                        (0, K.trackEvent)("GUI", "Chart Header Toolbar", "chart properties"), n.showGeneralChartProperties(void 0, {
                            shouldReturnFocus: (0, Q.isKeyboardClick)(e)
                        })
                    }, (0, S.validateRegistry)(t, {
                        chartWidgetCollection: o.any.isRequired
                ...
                render() {
                    ...
                    return a.createElement(X.ToolbarIconButton, { ...this.props,
                        icon: et,
                        isOpened: e,
                        onClick: this._handleClick,
            ...
            const ft = i.enabled("widget"),
                ...
                St = ((0, st.mergeThemes)(se.DEFAULT_POPUP_MENU_ITEM_THEME, {
                    toolbox: bt.toolbox
            ...
            class kt extends a.PureComponent {
                constructor(e) {
                    super(e), this._copyElRef = a.createRef(), this._menuRef = a.createRef(), this._handleCopyLinkClick = () => Promise.resolve(), this._handleCloneClick = () => {
                ...
                render() {
                    ...
                    let x = [];
                    mt.showFavoriteLayouts && w && f && (x = w.filter((e => f[e.id])).sort(((e, t) => e.name.localeCompare(t.name))));
                    ...
                    return a.createElement(p, null, t ? a.createElement(p, null, a.createElement(z, {
                        id: e,
                        displayMode: i,
                        icon: a.createElement(s.Icon, {
                            icon: pt
                        }),
                        isDisabled: o,
                        ...
                        collapseWhen: Mt,
                        tooltip: St
                    })) : a.createElement(p, null, a.createElement(z, {
                        id: e,
                        ...
                        collapseWhen: Mt,
                        isOpened: b,
                        tooltip: M ? l.t(null, void 0, n(289771)) : l.t(null, void 0, n(415356)),
                        ...
                        menuRole: "grid"
                    }, this._renderMenuItems(Boolean(v))), mt.showFavoriteLayouts && C && x.length > FAVORITE_LAYOUTS_LIMIT && a.createElement(a.Suspense, {
                        fallback: null
                    }, a.createElement(Tt, {
                        onClick: y,
                        onAdditionalClick: _,
                ...
                _renderMenuItems(e) {
                    const {
                        ...
                        isAuthenticated: y,
                        favorites: S
                    } = this.props, x = e ? _.multilineLabelWithIconAndToolboxTheme : _t, M = e ? void 0 : (0,
                        Y.humanReadableHash)(Y.Modifiers.Mod + 83), E = e ? void 0 : l.t(null, {
                        context: "hotkey"
                    }, n(23821)), T = [];
                    return T.push(a.createElement(I.AccessibleMenuItem, {
                        key: "save",
                        role: "row",
                    ...
                    })), void 0 !== o && T.push(a.createElement(I.AccessibleMenuItem, {
                        key: "rename",
                        role: "row",
                        icon: void 0,
                        ...
                        "aria-haspopup": "dialog"
                    })), T.push(a.createElement(f.PopupMenuSeparator, {
            ...
            class At extends a.PureComponent {
                ...
                componentDidMount() {
                    ...
                    t ? i.on("change", this._syncState) : (o.getOnChange().subscribe(this, this._onChangeHasChanges), a.metaInfo.name.subscribe(this._onChangeTitle), a.metaInfo.id.subscribe(this._onChangeId), this._hotkeys = (0, it.createGroup)({
                        desc: "Save/Load"
                    }), this._hotkeys.add({
                        desc: l.t(null, void 0, n(929517)),
                        handler: this._handleHotkey,
                        hotkey: 190
                    }), e.chartSaved().subscribe(this, this._onChartSaved), e.chartAboutToBeSaved().subscribe(this, this._onChartAboutToBeSaved), window.loginStateChange.subscribe(this, this._onLoginStateChange), this.context.saveChartService.getCreateController().visible().subscribe(this._onSaveDialogVisibleChange), this._loadChartServiceState.subscribe(this._updateState), mt.showFavoriteLayouts && h.refreshChartList())
                }
                componentDidUpdate(e, t) {
                ...
                componentWillUnmount() {
                    ...
                    t ? n.off("change", this._syncState) : (a.getOnChange().unsubscribe(this, this._onChangeHasChanges), i.metaInfo.name.unsubscribe(this._onChangeTitle), i.metaInfo.id.unsubscribe(this._onChangeId), (0, oe.ensureDefined)(this._hotkeys).destroy(), e.chartSaved().unsubscribe(this, this._onChartSaved), e.chartAboutToBeSaved().unsubscribe(this, this._onChartAboutToBeSaved), window.loginStateChange.unsubscribe(this, this._onLoginStateChange), this._recentLayoutsAbortController ? .abort(), this.context.saveChartService.getCreateController().visible().unsubscribe(this._onSaveDialogVisibleChange), this._loadChartServiceState.unsubscribe(this._updateState))
                }
                render() {
                    const {
                        isReadOnly: e,
                ...
                _onLoginStateChange() {
                    ...
                    this.setState({
                        isAuthenticated: e
                    }), mt.showFavoriteLayouts && this.context.loadChartService.refreshChartList()
                }
                _trackEvent(e) {
                    0
                }
            ...
            const Zt = new Rt.DateTimeFormatter({
                ...
                Vt = {
                    takeSnapshot: l.t(null, void 0, n(487972))
                },
            ...
            function Ot(e, t, i) {
                return async function(e, t, i) {
                    const a = URL.createObjectURL(new Blob([`<!doctype html><html style="background-color:${getComputedStyle(document.documentElement).backgroundColor}"><head><meta charset="utf-8"><title>${l.t(null,void 0,n(493292))}</title></head><body style="background-color:${getComputedStyle(document.body).backgroundColor}"></body></html>`], {
                        type: "text/html"
                    }));
                    try {
            ...
            function Lt(e) {
                ...
                return a.createElement("div", null, a.createElement("span", {
                    className: t
                }, e.children), a.createElement("span", {
                    className: n
            ...
            function Xt(e) {
                const {
                    ...
                    clientSnapshot: i,
                    hideShortcuts: o
                } = e, [s, r] = (0, a.useState)(!1), [h, c] = (0, a.useState)(!1), [d, v] = (0, a.useState)(!1), [m, p] = (0, a.useState)(!1), [g, b] = (0, a.useState)(!1), w = (0, Ut.useIsMounted)(), f = (0, a.useCallback)((async () => {
                    const e = i(),
                        t = e.then((e => new Promise((t => e.canvas.toBlob((e => {
                            null !== e && t(e)
                        }))))));
                    try {
                        await (0, at.writePromiseUsingApi)(t, "image/png"), pe.emit("onClientScreenshotCopiedToClipboard")
                    } catch (t) {
                        const {
                            canvas: n
                        } = await e;
                        window.open() ? .document.write(`<img width="100%" src="${n.toDataURL()}"/>`)
                    }
                }), [i]), C = (0, a.useCallback)((async () => {
                    const e = await i(),
                        t = await
                    function(e) {
                ...
                }), [i]), y = e => Ot(e.then((e => e.imageUrl))), _ = (0, a.useCallback)((async (e = !1) => {
                    const n = t();
                    try {
                        if (e) await y(n);
                        else {
                            ...
                            await (0, at.writePromiseUsingApi)(e, "text/plain"), pe.emit("onServerScreenshotCopiedToClipboard")
                        }
                        return !0
                    } catch (e) {
                        return y(n), !0
                    ...
                    try {
                        const t = 720,
                            n = e.then((async e => {
                                const n = await snapshoter().getSnapshot(e.symbol, new Set(["description"])),
                                    i = "error" !== n.status ? n.values.description : e.symbol,
                                    a = e.imageUrl.match(/\/x\/([0-9a-zA-Z]{8})/) ? .[1] ? ? "",
                                    o = createSnapshotImageUrls(a) ? .url;
                                return new Blob([`<img width="${t}" loading="lazy" src="${o}"/><p><a href="https://www.tradingview.com${getSymbolPagePath({shortName:e.symbol})}">${i} chart</a> by TradingView</p>`], {
                                    type: "text/plain"
                                })
                            }));
                        return await (0, at.writePromiseUsingApi)(n, "text/plain"), pe.emit("onServerScreenshotEmbedCodeCopiedToClipboard"), !0
                    } catch (t) {
                        return y(e), !0
                    } finally {
                    ...
                    p(!0);
                    const [e, i] = await Promise.all([n.e(4665).then(n.bind(n, 375243)), t()]);
                    e.Twitter.shareSnapshotInstantly(i.symbol, i.imageUrl), w.current && (p(!1), (0, Ve.globalCloseMenu)())
                }), [t]));
                const x = (e.snapshotUrl && e.snapshotUrl.length > 0) ? ? !1;
                return a.createElement(a.Fragment, null, a.createElement(me.ToolWidgetMenuSummary, null, l.t(null, void 0, n(458425))), a.createElement(I.AccessibleMenuItem, {
                    role: "row",
                    ...
                    theme: jt
                }), x && !(0, ot.onWidget)() && a.createElement(I.AccessibleMenuItem, {
                    role: "row",
                    "data-name": "copy-link-to-the-chart-image",
                    label: a.createElement(Lt, {
                        isLoading: s
                    ...
                    theme: jt
                }), !1, x && !(0, ot.onWidget)() && !(0, ot.isSymphonyEmbed)() && a.createElement(I.AccessibleMenuItem, {
                    role: "row",
                    ...
                    theme: jt
                }), x && !(0, ot.onWidget)() && !(0, ot.isSymphonyEmbed)() && a.createElement(I.AccessibleMenuItem, {
                    role: "row",
            ...
            function Yt(e) {
                const [t, n] = (0, a.useState)(!1), i = (0, Ut.useIsMounted)(), o = (0, a.useCallback)((async () => {
            ...
            var Jt = n(272644);
            const en = (tn = function(e) {
                return (0, $t.isOnMobileAppPage)("any") ? a.createElement(Yt, { ...e,
                    icon: Jt
                }) : a.createElement(d.ToolbarMenuButton, {
                ...
                constructor(e, t) {
                    super(e, t), this._clientSnapshot = async () => {
                        ...
                        const e = this.context.chartWidgetCollection.activeChartWidget.value().model().mainSeries().actualSymbol(),
                            ...
                            n = void 0 !== this.context.snapshotUrl ? t : (0, It.convertImageNameToUrl)(t);
                        return {
                            symbol: (0, Nt.shortName)(e),
                            imageUrl: n
                        }
                    }, (0, S.validateRegistry)(t, {
                        chartWidgetCollection: o.any.isRequired
            ...
            class ln {
                async show(e) {
                    ...
                    if (ln._currentShowingInstance) throw new DOMException("SymbolSearchUI is already shown", "InvalidStateError");
                    try {
                        ln._currentShowingInstance = this, ln.preload();
                        const t = await ln._implementation;
                        return (0, oe.assert)(null !== t), new Promise((n => {
                ...
                static preload() {
                    null === this._provider && null === this._implementation && (this._implementation = (0, sn.loadNewSymbolSearch)())
                }
            }
            ln._currentShowingInstance = null, ln._provider = null, ln._implementation = null;
            var rn = n(321303),
                hn = n(529142),
                cn = n(592876);
            ...
            class vn extends a.PureComponent {
                constructor(e, t) {
                    super(e, t), this._openSymbolSearchDialog = async e => {
                        if ((0, Y.modifiersFromEvent)(e) === Y.Modifiers.Alt) return void(0, at.getClipboard)().writeText(this.state.symbol);
                        if (this.state.isOpened) return;
                        const {
                            chartWidgetCollection: t
                        ...
                        try {
                            ...
                            await (new ln).show({
                                ...
                                shouldReturnFocus: (0, Q.isKeyboardClick)(e),
                                defaultValue: t,
                                showSpreadActions: (0, an.canShowSpreadActions)() && this.props.isActionsVisible,
                                source: "searchBar",
                                enableOptionsChain: i.enabled("symbol_search_option_chain_selector"),
                                footer: Te.mobiletouch ? void 0 : a.createElement(on.SymbolSearchDialogFooter, null, l.t(null, void 0, n(250021)))
                            })
                        } catch (e) {}
                ...
                componentDidMount() {
                    r.linking.proSymbol.subscribe(this._onSymbolChanged), i.enabled("use_symbol_name_for_header_toolbar") && r.linking.getChartWidget() ? .model().mainSeries().symbolResolved().subscribe(null, this._onSymbolInfoResolved, !1), ln.preload()
                }
                componentWillUnmount() {
                    r.linking.proSymbol.unsubscribe(this._onSymbolChanged), i.enabled("use_symbol_name_for_header_toolbar") && r.linking.getChartWidget() ? .model().mainSeries().symbolResolved().unsubscribe(null, this._onSymbolInfoResolved)
                }
                render() {
                    const {
                        id: e,
                    ...
                    return a.createElement(g.ToolbarButton, {
                        id: e,
                        className: v()(t, i.enabled("uppercase_instrument_names") && cn.uppercase, cn.smallLeftPadding),
                        theme: dn,
                        icon: hn,
            ...
            function _n(e) {
                const {
                    ...
                    ...p
                } = e, g = p, [b, w] = (0, Ee.useHover)(), f = r ? fn : wn, C = r ? yn : Cn, y = (0, a.useCallback)((() => h(i)), [h, i]), _ = (0, a.useCallback)((e => c(i, e)), [c, i]), S = (0, a.useCallback)((() => {
                    d && d(i)
                }), [d, i]);
                return a.createElement("div", { ...w,
                    ...g,
                    className: v()(n, bn.wrap)
                }, a.createElement(I.AccessibleMenuItem, {
                    role: t,
                    theme: f,
                    label: a.createElement(lt.LeadingEmojiText, {
                        text: i.name
                    }),
                    ...
                    onClick: y,
                    isActive: u,
                    toolbox: a.createElement(a.Fragment, null, !i.isDefault && a.createElement(ke.MenuRemoveButton, {
                        key: "remove",
                        hidden: !Te.touch && !b,
                        onClick: _,
                        className: v()(bn.remove, u && bn.active)
                    }), Boolean(d) && l && a.createElement(R.MenuFavoriteButton, {
                        key: "favorite",
                        isFilled: Boolean(s),
                        onClick: S
                    }))
                }), o && a.createElement(se.PopupMenuItem, {
                    theme: C,
                    label: a.createElement(gn, {
                        className: v()(bn.description, r && bn.descriptionTabletSmall)
                    }, o),
                    onClick: y,
                    isHovered: b,
                    isActive: u,
            ...
            function xn(e) {
                ...
                }, o = t.meta_info, s = o ? (0, Sn.getStudyTemplateDescString)(o.indicators) : void 0;
                return a.createElement(_n, { ...e,
                    ...i,
                    description: s,
                    item: n
                })
            ...
            function Tn(e) {
                ...
                return a.createElement(I.AccessibleMenuItem, { ...r,
                    theme: En,
            ...
            function Zn(e) {
                ...
                } = e, m = (0, a.useMemo)((() => t.filter((e => e.is_default))), [t]), p = (0, a.useMemo)((() => t.filter((e => !e.is_default))), [t]), g = (0, a.useContext)(An), b = (0, a.useContext)(Hn.MenuContext), w = (0, kn.useForceUpdate)();
                (0, a.useEffect)((() => {
                    if (null !== g) {
                        const e = {};
                ...
                const C = (e, t) => a.createElement(xn, {
                    key: e.name,
                    role: "row",
                    item: e,
                ...
                return a.createElement("div", {
                    ...
                    "aria-haspopup": "dialog"
                }), d && a.createElement(a.Fragment, null, a.createElement(f.PopupMenuSeparator, null), a.createElement(ve.ToolWidgetMenuSpinner, null)), !d && (c ? a.createElement(Vn, {
                    defaults: m,
                    customs: p,
                    recents: i,
                    render: C
            ...
            function Vn(e) {
                ...
                return a.createElement(a.Fragment, null, i.length > 0 && a.createElement(a.Fragment, null, a.createElement(f.PopupMenuSeparator, null), a.createElement(me.ToolWidgetMenuSummary, {
                    className: Nn.menuItemHeaderTabletSmall
                }, l.t(null, void 0, n(183300))), i.map((e => s(e)))), t.length > 0 && a.createElement(a.Fragment, null, a.createElement(f.PopupMenuSeparator, null), a.createElement(me.ToolWidgetMenuSummary, {
                    className: Nn.menuItemHeaderTabletSmall
                }, l.t(null, void 0, n(846838))), t.map((e => s(e)))))
            }
            ...
            function Wn(e) {
                ...
                }, l.t(null, void 0, n(183300))), i.map((e => s(e)))), i.length > 0 && t.length > 0 && r && a.createElement(a.Fragment, null, a.createElement(f.PopupMenuSeparator, null), a.createElement(Oe, {
                    role: "row",
                ...
                }, t.map((e => s(e))))), 0 === i.length && t.length > 0 && a.createElement(a.Fragment, null, a.createElement(f.PopupMenuSeparator, null), a.createElement(me.ToolWidgetMenuSummary, {
                    className: Nn.menuItemHeader
                }, l.t(null, void 0, n(846838))), t.map((e => s(e)))))
            }
            var Dn = n(240534),
            ...
            class Fn {
                constructor(e, t) {
                    this._isFavoriteEnabled = i.enabled("items_favoriting"), this.handleFavorTemplate = e => {
                        ...
                        null !== i ? this._removeFavoriteTemplate(t, n) : this._addFavoriteTemplate(t, n)
                ...
                _removeFavoriteTemplate(e, t) {
                    const n = t ? On.backend.favorStandardStudyTemplate : On.backend.favorStudyTemplate;
                    this._replaceOldFavoriteStudyTemplate(e, null, t), n(e, !1)
                }
                _addFavoriteTemplate(e, t) {
                    const n = this.getSortedFavoritesStudyTemplates(this._state.value().studyTemplatesList),
                        i = n.length ? n[n.length - 1].favorite_date : 0,
                        a = window.is_authenticated ? Date.now() : i + 1,
                        o = t ? On.backend.favorStandardStudyTemplate : On.backend.favorStudyTemplate;
                    this._replaceOldFavoriteStudyTemplate(e, a, t), o(e, !0)
                }
                _replaceOldFavoriteStudyTemplate(e, t, n) {
                    const i = this._state.value().studyTemplatesList.map((i => i.id === e && i.is_default === n ? { ...i,
                        favorite_date: t
                    } : i));
                    this._setState({
            ...
            function Un(e) {
                const {
                    ...
                    href: l,
                    target: r
                } = e, h = i.name ? .trim() ? ? " ", [c, d] = (0, F.useRovingTabindexElement)(null), v = l ? "a" : o ? "button" : "div", m = i.tooltip ? ? h, p = (0, Bn.getLeadingEmojiHtml)(m);
                return a.createElement(v, {
                    ref: c,
                    type: o && !l ? "button" : void 0,
                    className: u(t, Ln.item, Ln.accessible, "apply-common-tooltip", "common-tooltip-html"),
                    onClick: function(e) {
                ...
                }, n || a.createElement(lt.LeadingEmojiText, {
                    text: h,
                    firstSegmentOnly: !0
                })))
            }
            ...
            class Qn extends a.PureComponent {
                constructor(e, t) {
                    ...
                    const {
                        recentStudyTemplatesService: n,
                        studyTemplates: i
                    } = t;
                    this._model = new Fn(i, n), this.state = { ...this._model.state().value(),
                        isActive: !1
                    }
                }
                componentDidMount() {
                ...
                render() {
                    ...
                    return a.createElement(An.Provider, {
            ...
            function qn(e) {
                ...
                } = e, f = (0, a.useRef)(null), _ = (0, a.useRef)(null), S = v()(i, zn.wrap, {
                    [zn.full]: "full" === o,
                    [zn.medium]: "medium" === o
                ...
                return a.createElement(p, {
                    ...
                    rule: y.DialogBreakpoints.TabletSmall
                }, (t => a.createElement(d.ToolbarMenuButton, {
                    ref: f,
                    menuReference: _,
                    onOpen: e.onMenuOpen,
                    isDrawer: t,
                ...
                function M(e, t) {
                    if (t && (0, Q.isKeyboardClick)(t) && _.current) {
                        ...
                        b(e, null, (() => {
                            if (-1 !== n && _.current) {
                                const e = t[n + 1] ? ? t[n - 1];
                                e ? e.focus() : (0, le.focusFirstMenuItem)(_.current), f.current ? .update()
                            }
                        }))
                    } else b(e)
                }
            ...
            function Gn(e) {
                return a.createElement(a.Fragment, null, e.favorites.map(((t, n, i) => a.createElement(Un, {
                    key: t.name,
                    item: t,
            ...
            function li(e) {
                const {
                    ...
                    onClick: r,
                    isFirstItemInRow: h
                } = e, [c, d] = (0, F.useRovingTabindexElement)(null);
                return a.createElement("button", {
                    role: "menuitemradio",
                    className: u(o, oi.layoutButtonWrap, i && oi.smallWidth, oi.accessible),
                    type: "button",
                    "aria-checked": t,
                    "aria-label": l,
                    ...
                    className: u(oi.layoutButton, t && oi.isActive, i && oi.smallWidthLayoutButton)
                }, a.createElement(s.Icon, {
                    icon: n
                })))
            }
            ...
            var Ki = n(393998);
            const Qi = (0, st.mergeThemes)(ct, {
                label: Ki.switcherLabel
            });
            ...
            let $i = [{
                ...
                layouts: ["1-4", "5s", "2-3", "3-2", "5h", "5v"],
                title: "5"
            }, {
                layouts: ["6", "6c", "2-4", "6h", "6v"],
                title: "6"
            }, {
                layouts: ["7h"],
                title: "7"
            ...
            i.enabled("additional_multichart_layouts") && ($i = [...$i, {
                layouts: ["9s", "9h", "9v"],
                title: "9"
            }, {
                layouts: ["10c5", "10h", "10v"],
                title: "10"
            }, {
                layouts: ["12c6", "12c4"],
                title: "12"
            ...
            function Ji(e) {
                const {
                    chartWidgetCollection: t,
                    isSmallWidth: n
                } = e, [i, o] = (0, a.useState)("s"), [s, l] = (0, Gi.useRowsNavigation)(!0);
                return (0, a.useEffect)((() => {
                    function e(e) {
                        o(e || t.layout.value())
                    }
                    return t.layout.subscribe(e, {
                        callWithLast: !0
                ...
                }, n && a.createElement(ai, {
                    text: Yi.layoutType
                }), $i.map(((e, t) => a.createElement(si, {
                    key: e.title,
                    isSmallWidth: n,
                    title: e.title,
                    separator: t !== $i.length - 1 && a.createElement(f.PopupMenuSeparator, null)
                }, e.layouts.map(((e, t) => a.createElement(li, {
                    key: e,
                    layout: e,
                    icon: zi[e],
                    onClick: h,
                ...
                })))))))), a.createElement("div", null, n && a.createElement(f.PopupMenuSeparator, {
                    size: "normal"
                })), a.createElement("div", null, a.createElement(ai, {
                ...
                function h(e) {
                    (0, Ve.globalCloseMenu)(), t.layout.value() === e ? t.revertToInline() : t.setChartLayoutWithUndo(e)
                }
            }
            ...
            function ea(e) {
                const {
                    ...
                    hint: n,
                    isSmallWidth: i
                } = e, [o, l] = (0, F.useRovingTabindexElement)(null);
                return a.createElement("div", {
                    className: Xi.switchLabelWrap
                }, a.createElement("span", {
                    role: "rowheader",
                    className: Xi.switchLabel
                }, t), !i && a.createElement("span", {
                    role: "cell",
                    className: u(Xi.iconWrap, "apply-common-tooltip", Xi.accessibleLabel),
                    title: n,
                    "aria-label": n,
                    onFocus: () => (0, ni.showOnElement)((0, oe.ensureNotNull)(o.current)),
                    onBlur: () => (0, ni.hide)(),
                    tabIndex: l,
                    ref: o
                }, a.createElement(s.Icon, {
                    className: Xi.infoIcon,
                    icon: ji
                })))
            }
            ...
            class na extends a.PureComponent {
                ...
                render() {
                    ...
                    return a.createElement(C.MatchMedia, {
                        rule: y.DialogBreakpoints.TabletSmall
                    }, (r => a.createElement(d.ToolbarMenuButton, {
                        id: i,
                        arrow: !1,
            ...
            function oa(e) {
                ...
                return a.createElement(d.ToolbarMenuButton, {
                    content: a.createElement(P, {
                    ...
                    arrow: !1,
                    tooltip: n.tooltip
                }, n.items.map(((e, t) => a.createElement(se.PopupMenuItem, {
                    key: t,
                    label: e.title,
                    icon: e.icon,
                    onClick: () => e.onSelect(),
            ...
            function ma() {
                let e;
                return e = i.enabled("header_layouttoggle") ? na : void 0, {
        ...
        244693: (e, t, n) => {
            ...
            function r(e) {
                ...
                return l(n, t), i.createElement(s.Provider, {
                    value: n
                }, e.children)
            }
        ...
        652100: e => {
            e.exports = '<svg xmlns="http://www.w3.org/2000/svg" viewBox="-1 -1 21 19" width="21" height="19"><path fill="currentColor" fill-rule="evenodd" d="M1 2.5C1 1.67 1.67 1 2.5 1h14c.83 0 1.5.67 1.5 1.5V8H1V2.5ZM1 9v5.5c0 .83.67 1.5 1.5 1.5H9V9H1Zm9 7h6.5c.83 0 1.5-.67 1.5-1.5V9h-8v7ZM2.5 0A2.5 2.5 0 0 0 0 2.5v12A2.5 2.5 0 0 0 2.5 17h14a2.5 2.5 0 0 0 2.5-2.5v-12A2.5 2.5 0 0 0 16.5 0h-14Z"/></svg>'
        },
        232217: e => {
            e.exports = '<svg xmlns="http://www.w3.org/2000/svg" viewBox="-1 -1 21 19" width="21" height="19"><path fill="currentColor" fill-rule="evenodd" d="M1 2.5C1 1.67 1.67 1 2.5 1h14c.83 0 1.5.67 1.5 1.5V8H1V2.5ZM1 9v5.5c0 .83.67 1.5 1.5 1.5H6V9H1Zm6 7h5V9H7v7Zm6 0h3.5c.83 0 1.5-.67 1.5-1.5V9h-5v7ZM2.5 0A2.5 2.5 0 0 0 0 2.5v12A2.5 2.5 0 0 0 2.5 17h14a2.5 2.5 0 0 0 2.5-2.5v-12A2.5 2.5 0 0 0 16.5 0h-14Z"/></svg>'
        },
        989959: e => {
            e.exports = '<svg xmlns="http://www.w3.org/2000/svg" viewBox="-1 -1 21 19" width="21" height="19"><path fill="currentColor" fill-rule="evenodd" d="M1 2.5C1 1.67 1.67 1 2.5 1h14c.83 0 1.5.67 1.5 1.5V8H1V2.5ZM1 9v5.5c0 .83.67 1.5 1.5 1.5H4V9H1Zm4 7h4V9H5v7Zm5 0h4V9h-4v7Zm5 0h1.5c.83 0 1.5-.67 1.5-1.5V9h-3v7ZM2.5 0A2.5 2.5 0 0 0 0 2.5v12A2.5 2.5 0 0 0 2.5 17h14a2.5 2.5 0 0 0 2.5-2.5v-12A2.5 2.5 0 0 0 16.5 0h-14Z"/></svg>'
        },
        994598: e => {
            e.exports = '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 21 19" width="21" height="19"><path fill="currentColor" fill-rule="evenodd" d="M2 3.5C2 2.67 2.67 2 3.5 2H4v7H2V3.5ZM2 10v5.5c0 .83.67 1.5 1.5 1.5H4v-7H2Zm3 7h3v-7H5v7Zm4 0h3v-7H9v7Zm4 0h3v-7h-3v7Zm4 0h.5c.83 0 1.5-.67 1.5-1.5V10h-2v7Zm2-8V3.5c0-.83-.67-1.5-1.5-1.5H17v7h2Zm-3-7h-3v7h3V2Zm-4 0H9v7h3V2ZM8 2H5v7h3V2ZM3.5 1A2.5 2.5 0 0 0 1 3.5v12A2.5 2.5 0 0 0 3.5 18h14a2.5 2.5 0 0 0 2.5-2.5v-12A2.5 2.5 0 0 0 17.5 1h-14Z"/></svg>'
        },
        535956: e => {
            e.exports = '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 21 19" width="21" height="19"><path fill="currentColor" fill-rule="evenodd" d="M2 3.5C2 2.67 2.67 2 3.5 2H7v3H2v1h5v3H2v1h5v3H2v1h5v3H3.5A1.5 1.5 0 0 1 2 15.5v-12ZM8 14v3h5v-3H8Zm6 0v3h3.5c.83 0 1.5-.67 1.5-1.5V14h-5Zm5-1h-5v-3h5v3Zm-6 0H8v-3h5v3ZM8 9h5V6H8v3Zm6 0h5V6h-5v3Zm-1-4H8V2h5v3Zm1 13H3.5A2.5 2.5 0 0 1 1 15.5v-12A2.5 2.5 0 0 1 3.5 1h14A2.5 2.5 0 0 1 20 3.5v12a2.5 2.5 0 0 1-2.5 2.5H14Zm0-13V2h3.5c.83 0 1.5.67 1.5 1.5V5h-5Z"/></svg>'
        },
        686963: e => {
        ...
        359473: e => {
            e.exports = '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 21 19" width="21" height="19"><path fill="currentColor" fill-rule="evenodd" d="M3.5 2C2.67 2 2 2.67 2 3.5v12c0 .83.67 1.5 1.5 1.5H5v-3H2v-1h3v-3H2V9h3V6H2V5h3V2H3.5ZM6 14v3h4v-3H6Zm4-1H6v-3h4v3Zm1 1v3h4v-3h-4Zm4-1h-4v-3h4v3Zm1 1v3h1.5c.83 0 1.5-.67 1.5-1.5V14h-3Zm3-1h-3v-3h3v3Zm-8-4h4V6h-4v3Zm5-3v3h3V6h-3ZM6 9h4V6H6v3Zm0-4h4V2H6v3Zm10 13H3.5A2.5 2.5 0 0 1 1 15.5v-12A2.5 2.5 0 0 1 3.5 1h14A2.5 2.5 0 0 1 20 3.5v12a2.5 2.5 0 0 1-2.5 2.5H16Zm0-13V2h1.5c.83 0 1.5.67 1.5 1.5V5h-3Zm-1-3h-4v3h4V2Z"/></svg>'
        },
        112466: e => {
            e.exports = '<svg xmlns="http://www.w3.org/2000/svg" viewBox="-1 -1 21 19" width="21" height="19"><path fill="currentColor" fill-rule="evenodd" d="M1 2.5C1 1.67 1.67 1 2.5 1H9v7H1V2.5ZM1 9v5.5c0 .83.67 1.5 1.5 1.5h14c.83 0 1.5-.67 1.5-1.5V9H1Zm17-1V2.5c0-.83-.67-1.5-1.5-1.5H10v7h8ZM2.5 0A2.5 2.5 0 0 0 0 2.5v12A2.5 2.5 0 0 0 2.5 17h14a2.5 2.5 0 0 0 2.5-2.5v-12A2.5 2.5 0 0 0 16.5 0h-14Z"/></svg>'
        },
        451754: e => {
            e.exports = '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 21 19" width="21" height="19"><path fill="currentColor" fill-rule="evenodd" d="M3.5 2C2.67 2 2 2.67 2 3.5v12c0 .83.67 1.5 1.5 1.5H6V2H3.5ZM11 17H7V2h4v15Zm1 0h5.5c.83 0 1.5-.67 1.5-1.5V10h-7v7Zm7-8V3.5c0-.83-.67-1.5-1.5-1.5H12v7h7ZM1 3.5A2.5 2.5 0 0 1 3.5 1h14A2.5 2.5 0 0 1 20 3.5v12a2.5 2.5 0 0 1-2.5 2.5h-14A2.5 2.5 0 0 1 1 15.5v-12Z"/></svg>'
        },
        938926: e => {
            e.exports = '<svg xmlns="http://www.w3.org/2000/svg" viewBox="-1 -1 21 19" width="21" height="19"><path fill="currentColor" fill-rule="evenodd" d="M1 2.5C1 1.67 1.67 1 2.5 1H9v7H1V2.5ZM1 9v3h17V9H1Zm17-1V2.5c0-.83-.67-1.5-1.5-1.5H10v7h8Zm0 5H1v1.5c0 .83.67 1.5 1.5 1.5h14c.83 0 1.5-.67 1.5-1.5V13ZM2.5 0A2.5 2.5 0 0 0 0 2.5v12A2.5 2.5 0 0 0 2.5 17h14a2.5 2.5 0 0 0 2.5-2.5v-12A2.5 2.5 0 0 0 16.5 0h-14Z"/></svg>'
        },
        259806: e => {
            e.exports = '<svg xmlns="http://www.w3.org/2000/svg" viewBox="-1 -1 21 19" width="21" height="19"><path fill="currentColor" fill-rule="evenodd" d="M1 2.5C1 1.67 1.67 1 2.5 1H9v7H1V2.5ZM1 9v5.5c0 .83.67 1.5 1.5 1.5H6V9H1Zm6 7h5V9H7v7Zm6 0h3.5c.83 0 1.5-.67 1.5-1.5V9h-5v7Zm5-8V2.5c0-.83-.67-1.5-1.5-1.5H10v7h8ZM2.5 0A2.5 2.5 0 0 0 0 2.5v12A2.5 2.5 0 0 0 2.5 17h14a2.5 2.5 0 0 0 2.5-2.5v-12A2.5 2.5 0 0 0 16.5 0h-14Z"/></svg>'
        },
        328649: e => {
            e.exports = '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 21 19" width="21" height="19"><path fill="currentColor" fill-rule="evenodd" d="M1 3.5A2.5 2.5 0 0 1 3.5 1h14A2.5 2.5 0 0 1 20 3.5v12a2.5 2.5 0 0 1-2.5 2.5h-14A2.5 2.5 0 0 1 1 15.5v-12ZM11 2h6.5c.83 0 1.5.67 1.5 1.5V9h-8V2Zm-1 0H3.5C2.67 2 2 2.67 2 3.5V9h8V2Zm-8 8v5.5c0 .83.67 1.5 1.5 1.5H5v-7H2Zm4 7h4v-7H6v7Zm5 0h4v-7h-4v7Zm5 0h1.5c.83 0 1.5-.67 1.5-1.5V10h-3v7Z"/></svg>'
        },
        272279: e => {
            e.exports = '<svg xmlns="http://www.w3.org/2000/svg" viewBox="-1 -1 21 19" width="21" height="19"><path fill="currentColor" fill-rule="evenodd" d="M1 2.5C1 1.67 1.67 1 2.5 1H9v15H2.5A1.5 1.5 0 0 1 1 14.5v-12ZM10 16h6.5c.83 0 1.5-.67 1.5-1.5v-12c0-.83-.67-1.5-1.5-1.5H10v15ZM2.5 0A2.5 2.5 0 0 0 0 2.5v12A2.5 2.5 0 0 0 2.5 17h14a2.5 2.5 0 0 0 2.5-2.5v-12A2.5 2.5 0 0 0 16.5 0h-14Z"/></svg>'
        },
        135106: e => {
            e.exports = '<svg xmlns="http://www.w3.org/2000/svg" viewBox="-1 -1 21 19" width="21" height="19"><path fill="currentColor" fill-rule="evenodd" d="M1 2.5C1 1.67 1.67 1 2.5 1h14c.83 0 1.5.67 1.5 1.5V8H1V2.5ZM1 9v5.5c0 .83.67 1.5 1.5 1.5h14c.83 0 1.5-.67 1.5-1.5V9H1Zm1.5-9A2.5 2.5 0 0 0 0 2.5v12A2.5 2.5 0 0 0 2.5 17h14a2.5 2.5 0 0 0 2.5-2.5v-12A2.5 2.5 0 0 0 16.5 0h-14Z"/></svg>'
        },
        459702: e => {
            e.exports = '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 21 19" width="21" height="19"><path fill="currentColor" fill-rule="evenodd" d="M2 3.5C2 2.67 2.67 2 3.5 2H7v7H2V3.5ZM2 10v5.5c0 .83.67 1.5 1.5 1.5h14c.83 0 1.5-.67 1.5-1.5V10h-8v7h-1v-7H2Zm17-1V3.5c0-.83-.67-1.5-1.5-1.5H14v7h5Zm-6-7H8v7h5V2ZM3.5 1A2.5 2.5 0 0 0 1 3.5v12A2.5 2.5 0 0 0 3.5 18h14a2.5 2.5 0 0 0 2.5-2.5v-12A2.5 2.5 0 0 0 17.5 1h-14Z"/></svg>'
        },
        758180: e => {
            e.exports = '<svg xmlns="http://www.w3.org/2000/svg" viewBox="-1 -1 21 19" width="21" height="19"><path fill="currentColor" fill-rule="evenodd" d="M1 2.5C1 1.67 1.67 1 2.5 1H6v15H2.5A1.5 1.5 0 0 1 1 14.5v-12ZM7 16h5V1H7v15Zm6-15v15h3.5c.83 0 1.5-.67 1.5-1.5v-12c0-.83-.67-1.5-1.5-1.5H13ZM2.5 0A2.5 2.5 0 0 0 0 2.5v12A2.5 2.5 0 0 0 2.5 17h14a2.5 2.5 0 0 0 2.5-2.5v-12A2.5 2.5 0 0 0 16.5 0h-14Z"/></svg>'
        },
        710757: e => {
            e.exports = '<svg xmlns="http://www.w3.org/2000/svg" viewBox="-1 -1 21 19" width="21" height="19"><path fill="currentColor" fill-rule="evenodd" d="M1 2.5C1 1.67 1.67 1 2.5 1H9v7H1V2.5ZM1 9v5.5c0 .83.67 1.5 1.5 1.5H9V9H1Zm9 7h6.5c.83 0 1.5-.67 1.5-1.5v-12c0-.83-.67-1.5-1.5-1.5H10v15ZM2.5 0A2.5 2.5 0 0 0 0 2.5v12A2.5 2.5 0 0 0 2.5 17h14a2.5 2.5 0 0 0 2.5-2.5v-12A2.5 2.5 0 0 0 16.5 0h-14Z"/></svg>'
        },
        910997: e => {
            e.exports = '<svg xmlns="http://www.w3.org/2000/svg" viewBox="-1 -1 21 19" width="21" height="19"><path fill="currentColor" fill-rule="evenodd" d="M1 2.5C1 1.67 1.67 1 2.5 1H9v15H2.5A1.5 1.5 0 0 1 1 14.5v-12ZM10 16h6.5c.83 0 1.5-.67 1.5-1.5V9h-8v7Zm8-8V2.5c0-.83-.67-1.5-1.5-1.5H10v7h8ZM2.5 0A2.5 2.5 0 0 0 0 2.5v12A2.5 2.5 0 0 0 2.5 17h14a2.5 2.5 0 0 0 2.5-2.5v-12A2.5 2.5 0 0 0 16.5 0h-14Z"/></svg>'
        },
        687037: e => {
            e.exports = '<svg xmlns="http://www.w3.org/2000/svg" viewBox="-1 -1 21 19" width="21" height="19"><path fill="currentColor" fill-rule="evenodd" d="M1 2.5C1 1.67 1.67 1 2.5 1h14c.83 0 1.5.67 1.5 1.5V5H1V2.5ZM1 6v5h17V6H1Zm17 6H1v2.5c0 .83.67 1.5 1.5 1.5h14c.83 0 1.5-.67 1.5-1.5V12ZM2.5 0A2.5 2.5 0 0 0 0 2.5v12A2.5 2.5 0 0 0 2.5 17h14a2.5 2.5 0 0 0 2.5-2.5v-12A2.5 2.5 0 0 0 16.5 0h-14Z"/></svg>'
        },
        330273: e => {
            e.exports = '<svg xmlns="http://www.w3.org/2000/svg" viewBox="-1 -1 21 19" width="21" height="19"><path fill="currentColor" fill-rule="evenodd" d="M1 2.5C1 1.67 1.67 1 2.5 1H9v7H1V2.5ZM1 9v5.5c0 .83.67 1.5 1.5 1.5H9V9H1Zm9 7h6.5c.83 0 1.5-.67 1.5-1.5V9h-8v7Zm8-8V2.5c0-.83-.67-1.5-1.5-1.5H10v7h8ZM2.5 0A2.5 2.5 0 0 0 0 2.5v12A2.5 2.5 0 0 0 2.5 17h14a2.5 2.5 0 0 0 2.5-2.5v-12A2.5 2.5 0 0 0 16.5 0h-14Z"/></svg>'
        },
        49011: e => {
            e.exports = '<svg xmlns="http://www.w3.org/2000/svg" viewBox="-1 -1 21 19" width="21" height="19"><path fill="currentColor" fill-rule="evenodd" d="M1 2.5C1 1.67 1.67 1 2.5 1H4v15H2.5A1.5 1.5 0 0 1 1 14.5v-12ZM5 16h4V1H5v15Zm5-15v15h4V1h-4Zm5 0v15h1.5c.83 0 1.5-.67 1.5-1.5v-12c0-.83-.67-1.5-1.5-1.5H15ZM2.5 0A2.5 2.5 0 0 0 0 2.5v12A2.5 2.5 0 0 0 2.5 17h14a2.5 2.5 0 0 0 2.5-2.5v-12A2.5 2.5 0 0 0 16.5 0h-14Z"/></svg>'
        },
        521176: e => {
            e.exports = '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 21 19" width="21" height="19"><path fill="currentColor" fill-rule="evenodd" d="M2 3.5C2 2.67 2.67 2 3.5 2H11v4H2V3.5ZM2 7v5h9V7H2Zm0 6v2.5c0 .83.67 1.5 1.5 1.5H11v-4H2Zm10 4h5.5c.83 0 1.5-.67 1.5-1.5v-12c0-.83-.67-1.5-1.5-1.5H12v15ZM3.5 1A2.5 2.5 0 0 0 1 3.5v12A2.5 2.5 0 0 0 3.5 18h14a2.5 2.5 0 0 0 2.5-2.5v-12A2.5 2.5 0 0 0 17.5 1h-14Z"/></svg>'
        },
        663962: e => {
            e.exports = '<svg xmlns="http://www.w3.org/2000/svg" viewBox="-1 -1 21 19" width="21" height="19"><path fill="currentColor" fill-rule="evenodd" d="M1 2.5C1 1.67 1.67 1 2.5 1H9v15H2.5A1.5 1.5 0 0 1 1 14.5v-12ZM10 16h6.5c.83 0 1.5-.67 1.5-1.5V12h-8v4Zm8-5V6h-8v5h8Zm0-6V2.5c0-.83-.67-1.5-1.5-1.5H10v4h8ZM2.5 0A2.5 2.5 0 0 0 0 2.5v12A2.5 2.5 0 0 0 2.5 17h14a2.5 2.5 0 0 0 2.5-2.5v-12A2.5 2.5 0 0 0 16.5 0h-14Z"/></svg>'
        },
        236421: e => {
            e.exports = '<svg xmlns="http://www.w3.org/2000/svg" viewBox="-1 -1 21 19" width="21" height="19"><path fill="currentColor" fill-rule="evenodd" d="M1 2.5C1 1.67 1.67 1 2.5 1h14c.83 0 1.5.67 1.5 1.5V4H1V2.5ZM1 5v3h17V5H1Zm17 4H1v3h17V9Zm0 4H1v1.5c0 .83.67 1.5 1.5 1.5h14c.83 0 1.5-.67 1.5-1.5V13ZM2.5 0A2.5 2.5 0 0 0 0 2.5v12A2.5 2.5 0 0 0 2.5 17h14a2.5 2.5 0 0 0 2.5-2.5v-12A2.5 2.5 0 0 0 16.5 0h-14Z"/></svg>'
        },
        570309: e => {
            e.exports = '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 21 19" width="21" height="19"><path fill="currentColor" fill-rule="evenodd" d="M19 3.5c0-.83-.67-1.5-1.5-1.5H17v15h.5c.83 0 1.5-.67 1.5-1.5v-12Zm-17 12c0 .83.67 1.5 1.5 1.5H4V2h-.5C2.67 2 2 2.67 2 3.5v12ZM1.01 3.24A2.5 2.5 0 0 1 3.5 1h14A2.5 2.5 0 0 1 20 3.5v12a2.5 2.5 0 0 1-2.5 2.5h-14A2.5 2.5 0 0 1 1 15.5v-12l.01-.26ZM5 17h3V2H5v15Zm11 0h-3V2h3v15ZM12 2v15H9V2h3Z"/></svg>'
        },
        978222: e => {
            e.exports = '<svg xmlns="http://www.w3.org/2000/svg" viewBox="-1 -1 21 19" width="21" height="19"><path fill="currentColor" fill-rule="evenodd" d="M1 2.5C1 1.67 1.67 1 2.5 1H9v15H2.5A1.5 1.5 0 0 1 1 14.5v-12ZM10 16h6.5c.83 0 1.5-.67 1.5-1.5V13h-8v3Zm8-4V9h-8v3h8Zm0-4V5h-8v3h8Zm0-4V2.5c0-.83-.67-1.5-1.5-1.5H10v3h8ZM2.5 0A2.5 2.5 0 0 0 0 2.5v12A2.5 2.5 0 0 0 2.5 17h14a2.5 2.5 0 0 0 2.5-2.5v-12A2.5 2.5 0 0 0 16.5 0h-14Z"/></svg>'
        },
        73257: e => {
            e.exports = '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 21 19" width="21" height="19"><path fill="currentColor" fill-rule="evenodd" d="M1 3.5A2.5 2.5 0 0 1 3.5 1h14A2.5 2.5 0 0 1 20 3.5v12a2.5 2.5 0 0 1-2.5 2.5h-14A2.5 2.5 0 0 1 1 15.5v-12ZM3.5 2h14c.83 0 1.5.67 1.5 1.5V4H2v-.5C2 2.67 2.67 2 3.5 2ZM2 5v2h17V5H2Zm17 3H2v3h17V8Zm0 4H2v2h17v-2Zm0 3H2v.5c0 .83.67 1.5 1.5 1.5h14c.83 0 1.5-.67 1.5-1.5V15Z"/></svg>'
        },
        280088: e => {
            e.exports = '<svg xmlns="http://www.w3.org/2000/svg" viewBox="-1 -1 21 19" width="21" height="19"><path fill="currentColor" fill-rule="evenodd" d="M1 2.5C1 1.67 1.67 1 2.5 1H6v7H1V2.5ZM1 9v5.5c0 .83.67 1.5 1.5 1.5H6V9H1Zm6 7h5V9H7v7Zm6 0h3.5c.83 0 1.5-.67 1.5-1.5V9h-5v7Zm5-8V2.5c0-.83-.67-1.5-1.5-1.5H13v7h5Zm-6-7H7v7h5V1ZM2.5 0A2.5 2.5 0 0 0 0 2.5v12A2.5 2.5 0 0 0 2.5 17h14a2.5 2.5 0 0 0 2.5-2.5v-12A2.5 2.5 0 0 0 16.5 0h-14Z"/></svg>'
        },
        44836: e => {
            e.exports = '<svg xmlns="http://www.w3.org/2000/svg" viewBox="-1 -1 21 19" width="21" height="19"><path fill="currentColor" fill-rule="evenodd" d="M1 2.5C1 1.67 1.67 1 2.5 1H9v4H1V2.5ZM1 6v5h8V6H1Zm0 6v2.5c0 .83.67 1.5 1.5 1.5H9v-4H1Zm9 4h6.5c.83 0 1.5-.67 1.5-1.5V12h-8v4Zm8-5V6h-8v5h8Zm0-6V2.5c0-.83-.67-1.5-1.5-1.5H10v4h8ZM2.5 0A2.5 2.5 0 0 0 0 2.5v12A2.5 2.5 0 0 0 2.5 17h14a2.5 2.5 0 0 0 2.5-2.5v-12A2.5 2.5 0 0 0 16.5 0h-14Z"/></svg>'
        },
        502992: e => {
            e.exports = '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 21 19" width="21" height="19"><path fill="currentColor" fill-rule="evenodd" d="M2 3.5C2 2.67 2.67 2 3.5 2H4v15h-.5A1.5 1.5 0 0 1 2 15.5v-12ZM5 17h2V2H5v15ZM8 2v15h2V2H8Zm3 0v15h2V2h-2Zm3 0v15h2V2h-2Zm3 0v15h.5c.83 0 1.5-.67 1.5-1.5v-12c0-.83-.67-1.5-1.5-1.5H17ZM3.5 1A2.5 2.5 0 0 0 1 3.5v12A2.5 2.5 0 0 0 3.5 18h14a2.5 2.5 0 0 0 2.5-2.5v-12A2.5 2.5 0 0 0 17.5 1h-14Z"/></svg>'
        },
        114950: e => {
            e.exports = '<svg xmlns="http://www.w3.org/2000/svg" viewBox="-1 -1 21 19" width="21" height="19"><path fill="currentColor" fill-rule="evenodd" d="M1 2.5C1 1.67 1.67 1 2.5 1H4v7H1V2.5ZM1 9v5.5c0 .83.67 1.5 1.5 1.5H4V9H1Zm4 7h4V9H5v7Zm5 0h4V9h-4v7Zm5 0h1.5c.83 0 1.5-.67 1.5-1.5V9h-3v7Zm3-8V2.5c0-.83-.67-1.5-1.5-1.5H15v7h3Zm-4-7h-4v7h4V1ZM9 1H5v7h4V1ZM2.5 0A2.5 2.5 0 0 0 0 2.5v12A2.5 2.5 0 0 0 2.5 17h14a2.5 2.5 0 0 0 2.5-2.5v-12A2.5 2.5 0 0 0 16.5 0h-14Z"/></svg>'
        },
        605018: e => {
            e.exports = '<svg xmlns="http://www.w3.org/2000/svg" viewBox="-1 -1 21 19" width="21" height="19"><path fill="currentColor" fill-rule="evenodd" d="M1 2.5C1 1.67 1.67 1 2.5 1H9v3H1V2.5ZM1 5v3h8V5H1Zm0 4v3h8V9H1Zm0 4v1.5c0 .83.67 1.5 1.5 1.5H9v-3H1Zm9 3h6.5c.83 0 1.5-.67 1.5-1.5V13h-8v3Zm8-4V9h-8v3h8Zm0-4V5h-8v3h8Zm0-4V2.5c0-.83-.67-1.5-1.5-1.5H10v3h8ZM2.5 0A2.5 2.5 0 0 0 0 2.5v12A2.5 2.5 0 0 0 2.5 17h14a2.5 2.5 0 0 0 2.5-2.5v-12A2.5 2.5 0 0 0 16.5 0h-14Z"/></svg>'
        },
        2043: e => {
            e.exports = '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 21 19" width="21" height="19"><path fill="currentColor" fill-rule="evenodd" d="M3.5 1A2.5 2.5 0 0 0 1 3.5v12A2.5 2.5 0 0 0 3.5 18h14a2.5 2.5 0 0 0 2.5-2.5v-12A2.5 2.5 0 0 0 17.5 1h-14ZM7 2H3.5C2.67 2 2 2.67 2 3.5V6h5V2Zm1 0v4h5V2H8Zm0 5h5v5H8V7Zm-1 5V7H2v5h5Zm-5 1h5v4H3.5A1.5 1.5 0 0 1 2 15.5V13Zm6 0h5v4H8v-4Zm6 0v4h3.5c.83 0 1.5-.67 1.5-1.5V13h-5Zm5-1V7h-5v5h5ZM14 2v4h5V3.5c0-.83-.67-1.5-1.5-1.5H14Z"/></svg>'
        },
        534557: e => {
            e.exports = '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 21 19" width="21" height="19" fill="none"><rect width="18" height="16" stroke="currentColor" rx="2" x="1.5" y="1.5"/><path fill="currentColor" d="M19 10H2V9h17v1Z"/><path fill="currentColor" d="M4 17V2h1v15H4Z"/><path fill="currentColor" d="M7 17V2h1v15H7Z" opacity=".85"/><path fill="currentColor" d="M10 17V2h1v15h-1Z" opacity=".65"/><path fill="currentColor" d="M13 17V2h1v15h-1Z" opacity=".25"/><path fill="currentColor" d="M16 18V2h1v16h-1Z" opacity=".05"/></svg>'
        },
        652632: e => {
        ...
        841785: e => {
            e.exports = '<svg xmlns="http://www.w3.org/2000/svg" viewBox="-1 -1 21 19" width="21" height="19"><path fill="currentColor" d="M2.5 1C1.67 1 1 1.67 1 2.5v12c0 .83.67 1.5 1.5 1.5h14c.83 0 1.5-.67 1.5-1.5v-12c0-.83-.67-1.5-1.5-1.5h-14ZM0 2.5A2.5 2.5 0 0 1 2.5 0h14A2.5 2.5 0 0 1 19 2.5v12a2.5 2.5 0 0 1-2.5 2.5h-14A2.5 2.5 0 0 1 0 14.5v-12Z"/></svg>'
        },
        831246: e => {
