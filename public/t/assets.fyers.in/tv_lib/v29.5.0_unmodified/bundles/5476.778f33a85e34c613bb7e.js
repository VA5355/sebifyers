(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
    [5476], {
        ...
        185934: (e, t, n) => {
            ...
            function s(e, t = 2, n) {
                return o(l().logo, l()[e], n, 0 === t || 1 === t ? o(r.skeletonTheme.wrapper, l().skeleton) : l().letter, 1 === t && r.skeletonTheme.animated)
            }
        ...
        708886: (e, t, n) => {
            ...
            function c(e) {
                const {
                    ...
                    onMeasureCallback: f,
                    forceUpdate: h = !1
                } = e, [b, m] = (0, l.useRefsMap)(), p = (0, o.useRef)(null), g = (0, o.useRef)({
                    widthsMap: new Map,
                    containerWidth: 0,
                    moreButtonWidth: 0
                }), [v, C] = (0, o.useState)({
                    visible: t,
                    hidden: []
                }), k = (0, o.useMemo)((() => t.reduce(((e, t, n) => (d(t) && e.push(n), e)), [])), [t, d]), x = (0,
                    o.useCallback)((() => {
                ...
                }), [g, C, v, k, c]), E = (0, o.useCallback)((() => {
                    g.current.moreButtonWidth = p.current ? (0, i.outerWidth)(p.current, !0) : 0;
                ...
                }), [g, t, n, b, f]), M = (0, o.useRef)(null), w = (0, o.useCallback)((([e]) => {
                    e.contentRect.width !== g.current.containerWidth && (M.current && cancelAnimationFrame(M.current), g.current.containerWidth = e.contentRect.width, M.current = requestAnimationFrame((() => {
                        x()
                    })))
                }), [g, x]), S = (0, o.useRef)(null), y = (0, o.useCallback)((([e]) => {
                    S.current && cancelAnimationFrame(S.current), E(), S.current = requestAnimationFrame((() => {
                        x()
                    }))
                }), [E, x]), I = (0, r.useResizeObserver)(y), F = (0, r.useResizeObserver)(w), R = (0, o.useRef)(null), A = (0, a.mergeRefs)([F, R]), H = (0, o.useRef)(t), T = (0, o.useRef)(!0), P = (0, o.useRef)([]);
                return (0, s.useIsomorphicLayoutEffect)((() => {
                    !h && !T.current && u(H.current, t) && u(k, P.current) || (x(), T.current = !1, H.current = t, P.current = k)
                }), [t, x, k, h]), {
        ...
        772069: (e, t, n) => {
            ...
            function c(e) {
                const {
                    ...
                    onBlur: f,
                    onClick: h
                } = e, [b, m] = (0, o.useState)(!1), [p, g] = (0, l.useFocus)(), v = p || b, C = n ? ? void 0 !== t ? (0, a.createDomId)(t, "listbox") : void 0, k = (0, o.useRef)(null), x = (0, o.useCallback)((e => k.current ? .focus(e)), [k]), E = (0, o.useRef)(null), M = (0, o.useCallback)((() => (0, r.ensureNotNull)(E.current).focus()), [E]), w = (0, o.useCallback)((() => m(!0)), [m]), S = (0, o.useCallback)(((e = !1, t = !1) => {
                    m(!1);
                    const {
                        activeElement: n
                    } = document;
                    n && (0, i.isTextEditingField)(n) || t || x({
                        preventScroll: e
                    })
                }), [m, x]), y = (0, o.useCallback)((() => {
                    b ? S() : w()
                }), [b, S, w]), I = c ? [] : [d, g.onFocus], F = c ? [] : [f, g.onBlur], R = c ? [] : [h, y], A = (0, s.createSafeMulticastEventHandler)(...I), H = (0, s.createSafeMulticastEventHandler)(...F), T = (0, s.createSafeMulticastEventHandler)(...R);
                return {
                    listboxId: C,
                    isOpened: b,
                    isFocused: v,
        ...
        648621: (e, t, n) => {
            ...
            function a(e, t, n, o, a, c, u = {}, d, f) {
                ...
                return (0, i.useComposedKeyboardActionHandlers)((0, i.useKeyboardActionHandler)(v, h, f ? .next ? ? (() => !0), e), (0, i.useKeyboardActionHandler)(C, b, f ? .previous ? ? (() => !0), e), (0, i.useKeyboardActionHandler)(k, m, (() => !0), e), (0, i.useKeyboardActionHandler)(x, p, (() => !0), e))
            }
        },
        930617: (e, t, n) => {
            "use strict";
        ...
        984164: (e, t, n) => {
            ...
            function h(e) {
                ...
                return (0, a.assert)(t === n, "Activation type must be invariant."), "automatic" === t ? function(e) {
                    const {
                        ...
                        a(e), b(e) || h(e)
                    }), [a, h, b]), g = !l && i ? f(n, n.findIndex(s)) : void 0;
                    return (0, c.useKeyboardEventHandler)([(0, u.useItemsKeyboardNavigation)(m, t, n, s, p, l, {}, void 0, g)], r, i)
                }(e) : function(e) {
                    const {
                        isRtl: t,
                        items: n,
                        ...
                        onActivate: d,
                        orientation: h
                    } = e, b = n.findIndex(s), m = n[b], p = (0, o.useCallback)((() => {
                        void 0 !== m && d(m)
                    }), [m, d]), g = !l && i ? f(n, b) : void 0, v = (0, o.useCallback)((e => a(e)), [a]), C = (0, u.useItemsKeyboardNavigation)(h, t, n, s, v, l, {}, void 0, g), k = (0, c.useKeyboardActionHandler)([13, 32], p);
            ...
            function p(e) {
                ...
                } = e, R = (0, b.useMobileTouchState)(), A = S ? null : a || "horizontal", H = (0, o.useRef)(e.itemsRefs ? .current ? ? new Map), [T, P] = (0, o.useState)(), [O, L] = (0, l.useFocus)(), _ = n.find(x), z = (0, o.useCallback)((e => !u && !e.disabled && e === T), [u, T]), N = (0, o.useCallback)((e => {
                    const t = H.current.get(e);
                    p && void 0 !== t && t !== document.activeElement && t.focus()
                }), [p]), W = (0, o.useRef)(), K = (0, o.useCallback)(((e, t) => {
                    u || e.disabled || (P(e), "number" == typeof t ? (clearTimeout(W.current), W.current = setTimeout((() => N(e)), t)) : N(e))
                }), [u, P, N, S]), D = (0, o.useCallback)((e => {
                ...
                (0, o.useEffect)((() => {
                    ...
                    O || P(void 0)
                }), [O]), (0, o.useEffect)((() => () => clearTimeout(W.current)), []);
                const Q = k ? .additionalScroll ? ? 0,
                    [j, q] = (0, s.useKeepActiveItemIntoView)({ ...k,
                    ...
                    {
                        firstEdgeItemIndex: U,
                        lastEdgeItemIndex: $
                    } = (0, r.findEdgesTab)(n, M);
                return {
                    tabsBindings: n.map(((e, t) => {
                        ...
                        return { ...(0, r.getTabAttributes)(e.id, l, o, e.tabpanelId, i, y, "", F),
                            highlighted: n,
                            active: o,
                            handleItemRef: J
                        }
                    })),
                    tablistBinding: { ...(0, r.getTabListAttributes)(t, a, u, d, f, y),
                        onBlur: L.onBlur,
        ...
        192063: (e, t, n) => {
            ...
            function f(e) {
                const {
                    ...
                    trackRightClick: $,
                    ...G
                } = e, X = (0, o.useRef)(null), Y = (0, o.useMemo)((() => function(e) {
                    function t(t) {
                        const {
                            reference: n,
                            ...r
                ...
                return o.createElement(Z, { ...G,
                    ...
                    onClick: function(e) {
                        ...
                        j && j(q, e);
                        Q || (e.currentTarget.dispatchEvent(new CustomEvent("popup-menu-close-event", {
                            bubbles: !0,
                            detail: {
                    ...
                    onContextMenu: function(e) {
                        J && $ && (0, i.trackEvent)(J.category, J.event, `${J.label}_rightClick`)
                    },
                    ...
                    onKeyDown: L,
                    tabIndex: N
                }, V && o.createElement(s.CircleLogo, { ...B,
                    ...
                    className: r(z.label, b)
                }, w)), (void 0 !== p || g) && o.createElement("span", {
                    className: z.shortcut
                }, (ee = p) && ee.split("+").join(" + ")), void 0 !== A && o.createElement("span", {
                    role: H,
                    onClick: _ ? d : void 0,
        ...
        624216: (e, t, n) => {
            ...
            function f(e) {
                const {
                    ...
                    ...C
                } = e, k = (0, o.useContext)(a.CloseDelegateContext), x = o.useContext(d), E = (0, o.useContext)(c), M = (0, u.useOutsideEvent)({
                    handler: function(e) {
                        m && m(e);
                        if (!h) return;
                ...
                return f ? o.createElement(l.Portal, {
                    top: "0",
                    left: "0",
                    right: "0",
                    bottom: "0",
        ...
        586240: e => {
            "use strict";
            e.exports = JSON.parse('{"size-header-height":"64px","media-phone":"all and (max-width: 767px)","media-phone-vertical":"all and (max-width: 479px)","media-extreme-thin":"all and (max-width: 329px)","media-mf-phone-landscape":"all and (min-width: 568px)"}')
        }
    }
]);