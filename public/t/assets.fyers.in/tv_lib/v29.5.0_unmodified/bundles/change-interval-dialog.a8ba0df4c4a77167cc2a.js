    ...
    [2077], {
        ...
        34735: (e, t, n) => {
            ...
            function p(e, t, n, o) {
                const {
                    ...
                    noReadonlyStyles: v,
                    isFocused: w
                } = e, C = h(s ? ? (0, c.getGroupCellRemoveRoundBorders)(n));
                return r(d().container, d()[`container-${u}`], d()[`intent-${a}`], d()[`border-${l}`], u && d()[`size-${u}`], C, p && d()["with-highlight"], m && d().disabled, f && !v && d().readonly, w && d().focused, g && d().stretch, t && d().grouped, !o && d()["adjust-position"], n.isTop && d()["first-row"], n.isLeft && d()["first-col"], i)
            }
            ...
            function m(e, t, n) {
                ...
                const i = h(s ? ? (0, c.getGroupCellRemoveRoundBorders)(t));
            ...
            function v(e, t) {
                ...
                } = (0, o.useContext)(l.ControlGroupContext), I = function(e, t = null, n) {
        ...
        654936: (e, t, n) => {
            ...
            function v(e) {
                const {
                    ...
                    onContainerFocus: V,
                    ...K
                } = e, $ = (0, s.filterProps)(K, g), q = { ...(0, s.filterAriaProps)(K),
                    ...(0, s.filterDataProps)(K),
                    id: t,
                    title: n,
                    role: i,
                    tabIndex: a,
                ...
                return o.createElement(h.ControlSkeleton, { ...$,
                    ...
                    readonly: U,
                    tabIndex: k,
                    className: r(f().container, O),
                    size: F,
                    ref: H,
                    onFocus: V,
                    startSlot: B,
                    middleSlot: o.createElement(p.MiddleSlot, null, o.createElement("input", { ...q,
                        className: r(f().input, f()[`size-${F}`], L, B && f()["with-start-slot"], j && f()["with-end-slot"]),
                        disabled: Z,
                        readOnly: U,
                        ref: G
                    })),
            ...
            function w(e) {
                ...
                } = e, f = (0, o.useRef)(null), g = (0, o.useRef)(null), [w, C] = (0, u.useFocus)(), R = t ? void 0 : w ? -1 : r, x = t ? void 0 : w ? r : -1, {
                    isMouseDown: y,
                    handleMouseDown: b,
                    handleMouseUp: S
                } = (0, d.useIsMouseDown)(), E = (0, i.createSafeMulticastEventHandler)(C.onFocus, (function(e) {
                    n && !y.current && (0, a.selectAllContent)(e.currentTarget)
                }), s), D = (0, i.createSafeMulticastEventHandler)(C.onBlur, h), N = (0, o.useCallback)((e => {
        ...
        21778: (e, t, n) => {
            ...
            function s(e) {
                const {
                    ...
                    highlight: i,
                    disabled: a
                } = e, [l, c] = (0, r.useFocus)(void 0, a), u = (0, o.createSafeMulticastEventHandler)(a ? void 0 : c.onFocus, t), d = (0, o.createSafeMulticastEventHandler)(a ? void 0 : c.onBlur, n);
                return { ...e,
        ...
        908783: (e, t, n) => {
            ...
            function i(e) {
                const {
                    ...
                    handler: l,
                    reference: c
                } = e, u = (0, o.useRef)(null), d = (0, o.useRef)("undefined" == typeof window ? 0 : new window.CustomEvent("timestamp").timeStamp);
        ...
        730654: (e, t, n) => {
            ...
            class c extends o.PureComponent {
                ...
                render() {
                    ...
                    return t && ("string" == typeof t ? e.classList.add(t) : e.classList.add(...t)), this.props.shouldTrapFocus && !e.hasAttribute(a.FOCUS_TRAP_DATA_ATTRIBUTE) && e.setAttribute(a.FOCUS_TRAP_DATA_ATTRIBUTE, "true"), this.props["aria-hidden"] && e.setAttribute("aria-hidden", "true"), r.createPortal(o.createElement(u.Provider, {
                        value: this
        ...
        285089: (e, t, n) => {
            ...
            const r = () => !window.matchMedia("(min-width: 768px)").matches,
                s = () => !window.matchMedia("(min-width: 1280px)").matches;
            let i = 0,
                a = !1;
            ...
            function l(e) {
                ...
                if (e && 1 == ++i) {
                    ...
                    "hidden" !== e.toLowerCase() && t.scrollHeight > t.offsetHeight && ((0, o.setStyle)(n, "right", `${(0,o.getScrollbarWidth)()}px`), t.style.paddingRight = `${r+(0,o.getScrollbarWidth)()}px`, a = !0), t.classList.add("i-no-scroll")
                } else if (!e && i > 0 && 0 == --i && (t.classList.remove("i-no-scroll"), a)) {
                    (0, o.setStyle)(n, "right", "0px");
                    let e = 0;
                    e = n ? (l = (0, o.getContentWidth)(n), r() ? 0 : s() ? 45 : Math.min(Math.max(l, 45), 450)) : 0, t.scrollHeight <= t.clientHeight && (e -= (0, o.getScrollbarWidth)()), t.style.paddingRight = (e < 0 ? 0 : e) + "px", a = !1
                }
                var l
            }
        },
        ...
        151300: (e, t, n) => {
            ...
            var o = n(50959),
                ...
                d = n(878112),
                h = n(785508);
            const p = i.t(null, void 0, n(279290)),
                m = i.t(null, void 0, n(696941));
            ...
            function R(e) {
                const {
                    ...
                    selectOnInit: r,
                    onClose: d
                } = e, h = (0, o.useRef)(null), [p, m] = (0, o.useState)(t.toUpperCase()), R = (0, o.useMemo)((() => v.Interval.parse(p)), [p]), x = function(e, t) {
                    return (0, o.useMemo)((() => {
                        if (!t.isValid() || !(0, g.intervalIsSupported)(e)) return !1;
                        const n = v.Interval.normalize(e);
                        return null !== n && (0, g.isResolutionMultiplierValid)(n)
                    }), [e, t])
                }(p, R), y = (0, o.useMemo)((() => {
                    if (!x) return null;
                    return (0, g.getTranslatedResolutionModel)(R.value()).hint
                }), [x, R]);
                return (0, o.useLayoutEffect)((() => {
                    r ? h.current ? .select() : h.current ? .focus()
                }), [r]), o.createElement(u.PopupDialog, {
                    className: w.dialog,
                    ...
                    className: w.dialogInner
                }, o.createElement("div", {
                    className: w.titleWrapper
                }, o.createElement("div", {
                    className: w.title
                }, i.t(null, void 0, n(102569))), o.createElement(f, {
                    className: w.infoHint,
                    isSecondsEnabled: (0, g.isSecondsEnabled)()
                })), o.createElement("form", {
                    className: w.form,
                    onSubmit: function(e) {
                        e.preventDefault();
                        const t = c.linking.interval.value(),
                            n = v.Interval.normalize(p);
                        n && t !== n && x && c.linking.interval.setValue(n);
                        d ? .()
                    }
                }, o.createElement(a.InputControl, {
                    className: s()(w.inputWrapper, l.InputClasses.FontSizeLarge),
                    inputClassName: w.input,
                    type: "text",
                    size: "large",
                    reference: h,
                    value: p,
                    maxLength: C,
                    intent: x ? void 0 : "danger",
                    onChange: function(e) {
                        const {
                            value: t
                        } = e.target;
                    ...
                    className: s()(w.hint, w.error)
                }, i.t(null, void 0, n(787859)))))
            }
            var x = n(63192),
                y = n(651674);

            function b(e) {
                if (x.dialogsOpenerManager.isOpened("ChangeIntervalDialog") || x.dialogsOpenerManager.isOpened("SymbolSearch")) return;
                const t = document.createElement("div"),
                    ...
                    i = o.createElement(R, {
                        ...
                        selectOnInit: r,
                        onClose: function() {
                            a.unmount(), x.dialogsOpenerManager.setAsClosed("ChangeIntervalDialog"), s ? .()
                        }
                    }),
                    a = (0, y.createReactRoot)(i, t);
                x.dialogsOpenerManager.setAsOpened("ChangeIntervalDialog")
            }
        },
        785508: e => {
