    ...
    [8687], {
        ...
        611031: (e, t, n) => {
            ...
            function l(e) {
                const {
                    ...
                    hideIcon: m,
                    ...p
                } = e, v = t || !n || m ? "" : a, b = s(c().box, c()[`intent-${h}`], !t && c().check, !!t && c().dot, -1 === i && c().noOutline, l, n && c().checked, u && c().disabled, d && c().disableActiveStyles);
                return o.createElement("span", {
                    className: b,
                    ...p
        ...
        879091: (e, t, n) => {
            ...
            var b = n(930202),
                f = n(865266),
                g = n(136110);
            const E = (0, o.forwardRef)((function(e, t) {
                const {
                    className: n,
                    ...s
            ...
            class x extends o.PureComponent {
                constructor(e) {
                    ...
                    }, this._calcSubMenuPos = e => (0, c.calcSubMenuPos)(e.contentWidth, this._itemRef), this._updateState = e => {
                        this.setState(e.getState())
                    }, this._setItemRef = e => {
                        this._itemRef = e
                    }, this._handleMenuRef = e => {
                        this._menuRef = e
                    }, this._registerSubmenu = () => this.context ? .registerSubmenu(this.props.action.id, (e => (0, s.ensureNotNull)(this._itemRef).contains(e) || null !== this._menuElementRef.current && this._menuElementRef.current.contains(e))), this.state = { ...this.props.action.getState()
                    }
                }
                componentDidMount() {
                ...
                render() {
                    ...
                    }) : o.createElement(E, { ...(0, w.filterDataProps)(this.props),
            ...
            x.contextType = l.SubmenuContext
        },
        871923: (e, t, n) => {
            "use strict";
            n.d(t, {
            ...
            class w extends o.PureComponent {
                ...
                render() {
                    const {
                        ...
                        jsxLabel: v,
                        styledLabel: g
                    } = this.props, w = this.props.checkable && this.props.checkboxInput ? "label" : "div";
                    return o.createElement(o.Fragment, null, o.createElement("tr", { ...(0, m.filterDataProps)(this.props),
                        ...(0, m.filterAriaProps)(this.props),
                        id: this.props.id,
                        className: s(this.props.className, c.item, !this.props.noInteractive && c.interactive, this.props.hovered && c.hovered, this.props.disabled && c.disabled, this.props.active && c.active, this.props.selected && c.selected, c[d]),
                        ...
                        onKeyDown: h
                    }, E && void 0 !== i && o.createElement("td", {
                        className: c.favoriteActionCell
                    }, o.createElement(l.FavoriteButton, {
                        id: `${this.props.id}-favorite`,
                        className: c.favourite,
                        isFilled: i,
                        onClick: this.props.onFavouriteClick,
                        "data-role": "list-item-action"
                    })), o.createElement("td", {
                        className: s(c.iconCell),
                        "data-icon-cell": !0
                    }, this._icon(c)), o.createElement("td", {
                        className: c.contentCell
                    }, o.createElement(w, {
                        className: c.content
                    }, o.createElement("span", {
                        className: s(c.label, this.props.checked && c.checked),
                        "data-label": !0
                    }, !v && g ? g.map((({
                        text: e,
                        ...t
                        ...
                        key: n,
                        style: t
                    }, e))) : v ? ? p), this._toolbox(c), e && o.createElement("span", {
                        ...
                        className: s(r && c.invisibleHotkey),
                        text: t
                ...
                _renderToolboxContent() {
                    return this.props.toolbox && this.props.toolbox.type === d.ToolboxType.Delete ? o.createElement(c.RemoveButton, {
                        icon: p,
        ...
        820883: (e, t, n) => {
            ...
            function g(e) {
                ...
                }), []), o.createElement(v.ContextMenuItem, { ...n,
                    onClick: function(e) {
            ...
            function x(e) {
                ...
                return o.createElement(E.EmptyIconsContext.Provider, {
                    value: r
            ...
            class _ extends o.PureComponent {
                ...
                render() {
                    ...
                    return e && n.length > 0 ? o.createElement(d.DrawerManager, null, o.createElement(l.KeyboardDocumentListener, {
                        keyCode: 27,
                        eventType: "keyup",
                    ...
                    }, o.createElement(c.OutsideEvent, {
                ...
                update() {
                    this._menuRef.current && this._menuRef.current.update(), this.props.isKeyboardEvent && this.props.menuElementReference ? .current && document.activeElement === this.props.menuElementReference.current && (0, y.focusFirstMenuItem)(this.props.menuElementReference.current)
                }
                _isDrawer(e) {
        ...
        729624: (e, t, n) => {
            ...
            function p(e) {
                const {
                    ...
                    jsxLabel: N,
                    size: I = "normal"
                } = e, D = (0, o.useContext)(c.EmptyIconsContext), L = !!k.length;
                return s ? o.createElement("li", {
                    ...
                    key: n,
                    style: t
                }, e))) : N ? ? y), !!S && o.createElement(a.Icon, {
                    onClick: function() {
                        S && S.action()
                    },
                    className: m.remove,
                    icon: h
                }), !L && x && o.createElement(l.Hint, {
        ...
        759339: (e, t, n) => {
            ...
            function m(e) {
                const {
                    ...
                    className: m,
                    theme: v = d
                } = e, b = (0, s.ensureNotNull)((0, o.useContext)(c.DrawerContext)), [f] = (0, o.useState)((() => (0, a.randomHash)())), g = (0, o.useRef)(null), E = (0, o.useContext)(l.CloseDelegateContext);
                return (0, o.useLayoutEffect)((() => ((0, s.ensureNotNull)(g.current).focus({
                    preventScroll: !0
                }), E.subscribe(b, n), b.addDrawer(f), () => {
                    b.removeDrawer(f), E.unsubscribe(b, n)
        ...
        598448: (e, t, n) => {
            ...
            const r = {
                [o.Add]: s.t(null, void 0, n(869207)),
                [o.Remove]: s.t(null, void 0, n(685106))
            }
        },
        577687: (e, t, n) => {
            "use strict";
            ...
            function h(e) {
                const {
                    ...
                    title: m,
                    ...p
                } = e, [v, b] = (0, c.useActiveDescendant)(null), f = m ? ? (n ? i.removeTitlesMap[i.RemoveTitleType.Remove] : i.removeTitlesMap[i.RemoveTitleType.Add]);
                return (0, o.useLayoutEffect)((() => {
                    const e = v.current;
                    e instanceof HTMLElement && f && e.dispatchEvent(new CustomEvent("common-tooltip-update"))
                }), [f, v]), o.createElement(a.Icon, { ...p,
            ...
            function s(e, t, n = {
                ...
                if (t) {
                    const {
                        ...
                        right: s,
                        top: r
                    } = t.getBoundingClientRect(), a = document.documentElement.clientWidth, i = {
                        x: n - e,
                        y: r
                    }, c = {
                        x: s,
                    ...
                    return (0, o.isRtl)() ? n <= e ? c : i : a - s >= e ? c : i
                }
                return n
            }
        },
        72621: (e, t, n) => {
            ...
            function d(e) {
                const {
                    ...
                    icon: b,
                    ...f
                } = e, [g, E] = (0, c.useActiveDescendant)(null);
                return s.createElement(i.Icon, { ...f,
                    "data-name": v,
                    className: a()(u.button, "apply-common-tooltip", r && u.active, p && u.hidden, E && u.focused, t),
                    icon: b || l,
                    onClick: d,
                    onMouseDown: h,
                    title: m ? ? o.t(null, void 0, n(767410)),
                    ariaLabel: m ? ? o.t(null, void 0, n(767410)),
                    ref: g
                })
            }
        },
        742554: (e, t, n) => {
            ...
            const l = (0, o.forwardRef)(((e, t) => {
                ...
                return (0, o.useImperativeHandle)(t, (() => l.current)), (0, o.useLayoutEffect)((() => {
                    if (a.CheckMobile.iOS()) return c++, null !== l.current && (i ? 1 === c && (document.body.style.overscrollBehavior = "none") : (0, s.disableBodyScroll)(l.current, {
                        allowTouchMove: u(l)
                    })), () => {
                        c--, null !== l.current && (i ? 0 === c && (document.body.style.overscrollBehavior = "") : (0, s.enableBodyScroll)(l.current))
                    }
                }), []), o.createElement("div", {
                    ref: l,
                    ...r
        ...
        994567: (e, t, n) => {
            ...
            function l(e) {
                ...
                switch ((0, o.mapKeyCodeToDirection)(t)) {
                    case "inlinePrev":
                        if (!u.length) return;
                        e.preventDefault(), f(0 === v ? a[l] : b ? d(u, v, -1) : u[u.length - 1]);
                        break;
                    case "inlineNext":
                        if (!u.length) return;
                        e.preventDefault(), v === u.length - 1 ? f(a[l]) : f(b ? d(u, v, 1) : u[0]);
                        break;
                    case "blockPrev":
                        {
                            e.preventDefault();
