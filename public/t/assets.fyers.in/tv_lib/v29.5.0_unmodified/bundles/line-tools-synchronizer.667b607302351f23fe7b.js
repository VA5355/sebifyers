...
(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
    [7129, 5565], {
        ...
        49078: (e, t, i) => {
            ...
            class m {
                constructor(e, t, i) {
                    this._pendingRequests = new Map, this._startRequestingDebounced = (0, o.default)((() => this._startNextRequest()), 500), this._layoutId = e, this._chartId = t, this._ownerSourceId = i
                }
            ...
            class w extends I.StudyStub {
                constructor(e, t, i) {
                    super(e, { ...t,
                        ownFirstValue: null
                    }, i), this._linkKey = new b.WatchedValue(t.linkKey ? ? null)
                }
                linkKey() {
            ...
            class V {
                constructor(e, t, i, s) {
                    this._invalidatedLineToolsAndStudyStubs = new Map, this._allLineToolsAndStudyStubs = new Map, this._originalLineToolSharingMode = new Map, this._invalidatedLineToolGroups = new Map, this._originalLineToolGroupsSharingMode = new Map, this._ignoreInvalidatingEventsDepth = 0, this._saveChartService = null, this._debouncedSave = (0, o.default)((() => this._saveInvalidatedIfRequired(!1)), 500), this._currentlyLoadedSymbol = new Map, this._linkKeyResolver = null, this._brokerName = "", this._lastBanTime = null, this._invalidateViaSync = 0, this._savingAbortControllersBySharingMode = new Map, this._onChangeAutosave = e => {
                        e && this._debouncedSave()
                    }, this._origin = e, this._chartModel = t, this._options = i, this._hasChanges = s, this._assignAllLineTools(this._chartModel.panes()), this._chartModel.panesCollectionChanged().subscribe(this, this._processPanesCollectionChanged.bind(this)), this._chartModel.dataSourceCollectionChanged().subscribe(this, this._processDataSourceCollectionChanged.bind(this)), this._chartModel.lineToolsGroupModel().onChanged().subscribe(this, this._processLineToolsGroupModelChanged.bind(this)), this._chartModel.mainSeries().dataEvents().symbolResolved().subscribe(this, this._onSymbolResolved.bind(this)), this._chartModel.sourcePropertiesChanged().subscribe(this, this._processPropertiesChanged.bind(this)), this._chartModel.sourceZOrderChanged().subscribe(this, this._processPropertiesChanged.bind(this)), this._linkKeyResolver = new m(e.layoutId, e.chartId, t.mainSeries().id()), this._brokerIdSession = new C("broker_id_session", !1), k.forEach((e => {
                        0 === e && this._loadAndMergeLineToolsOnStudies(e, !1), this._loadAndMergeLineToolsWithoutSymbol(e, !1)
                    }))
                }
                destroy() {
                    this._brokerIdSession.destroy(), this._chartModel.mainSeries().dataEvents().symbolResolved().unsubscribeAll(this), this._chartModel.sourcePropertiesChanged().unsubscribeAll(this), this._chartModel.sourceZOrderChanged().unsubscribeAll(this), this._chartModel.panesCollectionChanged().unsubscribeAll(this), this._chartModel.dataSourceCollectionChanged().unsubscribeAll(this), this._chartModel.lineToolsGroupModel().onChanged().unsubscribeAll(this), this._saveChartService ? .autoSaveEnabled().unsubscribe(this._onChangeAutosave)
                }
                reloadAllLineTools() {
                    this._currentlyLoadedSymbol.clear(), k.forEach((e => {
                ...
                resetInvalidated(e, t, i, o) {
                    ...
                    const {
                        ...
                        groupsToValidate: l
                    } = t, d = N(this._invalidatedLineToolsAndStudyStubs, e, new Set(a ? ? r.keys()));
                    this._invalidatedLineToolsAndStudyStubs = d.stillInvalidated, d.validated.forEach(s.bind(this, this._originalLineToolSharingMode, this._setOriginalLineToolSharingMode.bind(this), r));
                    const h = N(this._invalidatedLineToolGroups, e, new Set(l ? ? n.keys()));
                    d.validated.forEach(s.bind(this, this._originalLineToolGroupsSharingMode, this._setOriginalLineToolGroupsSharingMode.bind(this), n)), this._invalidatedLineToolGroups = h.stillInvalidated, Array.from(r.keys()).forEach((e => {
                        const t = this._chartModel.dataSourceForId(e);
                        t && (void 0 !== o ? t.setServerUpdateTime(o) : null === t.serverUpdateTime() && t.setServerUpdateTime((new Date).valueOf()))
                    })), this._recalculateHasChanges()
                }
                applyLineToolUpdateNotification(e, t) {
                    ...
                    i.clientId === this._origin.clientId && i.chartId === this._origin.chartId || (void 0 !== e.symbol && null === e.sources ? this._withoutInvalidating((() => {
                        const i = this._chartModel.dataSources().filter(S.isLineTool).filter((i => i.sharingMode().value() === t && i.symbol() === e.symbol));
                ...
                endApplyingLineToolUpdateNotification() {
                    this._ignoreInvalidatingEventsDepth--, this._ignoreInvalidatingEventsDepth < 0 && (G.logError("Logic error, startApplyingLineToolUpdateNotification/endApplyingLineToolUpdateNotification mismatch, autofixing"), this._ignoreInvalidatingEventsDepth = 0)
                }
                ...
                _assignAllLineTools(e) {
                    e.forEach((e => {
                        const t = e.dataSources().filter(q).map((e => [e.id(), e.linkKey().value()])),
                            i = new Map(t);
                ...
                _processPanesCollectionChanged(e) {
                    ...
                    Array.from(this._allLineToolsAndStudyStubs.keys()).filter((e => !i.has(e))).forEach((e => {
                        ...
                        e.dataSources().filter(q).forEach((e => this._invalidateLineToolOrStudyStub(e.id(), o)))
                ...
                _processDataSourceCollectionChanged(e) {
                    ...
                    if (this._allLineToolsAndStudyStubs.has(e.id())) {
                        ...
                        s = t.filter((e => !i.has(e.id()))), s.forEach((e => this._invalidateLineToolOrStudyStub(e.id(), n))), Array.from(i.entries()).filter((e => !o.has(e[0]))).forEach((e => {
                ...
                _unloadLineTools(e, t, i) {
                    const o = e.filter((e => !this._invalidatedLineToolsAndStudyStubs.has(e))).map((e => this._chartModel.dataSourceForId(e))).filter(S.isLineTool).filter(v.notNull).filter((e => e.sharingMode().value() === i)).filter(t).filter((e => {
                        const t = this._chartModel.lineToolsGroupModel().groupForLineTool(e);
                    ...
                    const o = this.prepareDTO(e),
                        s = k.map((e => {
                            ...
                            if (t.sources.size || t.groups.size) {
                                ...
                                return this._savingAbortControllersBySharingMode.set(e, s), t.sources.forEach(((t, i) => {
                                    t && this._setOriginalLineToolSharingMode(i, e)
                                })), (0, c.ensureNotNull)(this._saveChartService).saveChartLineTools(this._origin.chartId, t, e, s.signal).then((({
                                    serverUpdateTime: i
                                }) => {
                                    this.resetInvalidated(r, t, e, i)
                                })).catch((async t => {
                                    t instanceof p.SavingLineToolsError && t.shouldBeCooled && (this._lastBanTime = performance.now()); {
                                        const {
                                            SavingLineToolsLibraryError: e
                                        } = await Promise.resolve().then(i.bind(i, 362453));
                ...
                async _savePromise(e, t) {
                    return this._isAutosaveEnabled() ? this._debouncedSave ? .flush() ? ? Promise.resolve() : this._saveInvalidatedIfRequired(e, t)
                }
                _seriesLineToolsUnloader(e, t, i) {
                    const o = this._chartModel.mainSeries();
                    "mainSeriesLineTools" === e.requestType && o.symbolSameAsCurrent(e.symbol) && (this._unloadLinesOnSeries(i, e.sharingMode, t), this._currentlyLoadedSymbol.set(e.sharingMode, e.symbol))
                }
                ...
                _onSymbolResolved(e) {
                    ...
                    Promise.all(t).then((() => {
                        this._withoutInvalidating((() => {
                            this._chartModel.dataSources().filter(S.isLineTool).filter((e => 0 === e.sharingMode().value() && e.linkKey().value())).forEach((e => {
                ...
                async _makeLoadRequestAndMerge(e, t, i) {
                    ...
                    return this._savePromise("mainSeriesLineTools" === e.requestType).catch((() => {})).then((() => n.loadLineToolsAndGroups(this._origin.layoutId, this._origin.chartId, e, i))).catch((() => null)).then((async i => {
                        if (null !== i && null !== i.sources) {
                            const o = i.sources;
                            t((e => o.has(e))), await this._applyLineToolsAndGroupsDTO(i, e.sharingMode), i.serverRequestId && console.log(`PROCESSED:${i.serverRequestId}`)
                        }
                    }))
                }
                _restoreGroups(e, t, i, o) {
                    const s = new Map;
                    return (t.groups || new Map).forEach(((t, n) => {
                        ...
                        if (null === t) {
                            if (r) {
                                ...
                                r.lineTools()[0].sharingMode().value() === i && (e && 0 !== i || (new M.ExcludeLineToolsFromGroupUndoCommand(this._chartModel, r, r.lineTools()).redo(), this._setOriginalLineToolGroupsSharingMode(n, null)))
                            }
                        } else {
                ...
                _restoreLineTool(e, t, i, o) {
                    ...
                    if (null === s && t.state.linkKey && (s = this._chartModel.lineToolByLinkKey(t.state.linkKey)), null !== s && !(0, S.isLineTool)(s)) return null;
                    if (this._origin.clientId === o ? .clientId && !s) return null;
                    if (s && t.serverUpdateTime) {
                        const n = t.serverUpdateTime,
                            r = s.serverUpdateTime();
                        if (null !== e && e >= n || null !== r && r >= n) return 0 !== i && (s.share(i), this._setOriginalLineToolSharingMode(s.id(), i)), this._restoreLineToolAlert(s, t.state.alertId), null;
                        this._origin.clientId !== o ? .clientId && (this._chartModel.restoreLineToolState(s, t.state, !1), s.sharingMode().value() !== i && (s.share(i), this._setOriginalLineToolSharingMode(s.id(), i)), s.calcIsActualSymbol())
                    }
                    ...
                    if (r && (n && this._invalidateLineToolOrStudyStub(t.id, performance.now(), !0), t.serverUpdateTime && r.setServerUpdateTime(t.serverUpdateTime), this._restoreLineToolAlert(r, t.state.alertId), 0 !== i && r.share(i), void 0 === o && (0, S.isEditableTextLineTool)(r))) {
                ...
                _removeTextLineToolIfEmpty(e) {
                    return !(!e.removeIfEditableTextIsEmpty() || 0 !== e.editableTextProperties().text.value().length) && (this._chartModel.removeSource(e), this._invalidateLineToolOrStudyStub(e.id(), performance.now(), !0), !0)
                }
                _restoreLineDTO(e, t, i, o, s, n) {
                    if (!this._invalidatedLineToolsAndStudyStubs.get(t))
                        if (null === e) {
                            ...
                            e.sharingMode().value() === s && this._origin.clientId !== n ? .clientId && (this._removeLineTool(t), this._setOriginalLineToolSharingMode(t, null))
                        } else {
                            ...
                            if (r) {
                                if (e.groupId) {
                                    ...
                                    if (null !== t && (t.excludeLineTool(r), 0 === t.lineTools().length && this._chartModel.lineToolsGroupModel().removeGroup(t)), o && !o.containsLineTool(r)) o.addLineTools([r]);
                                    ...
                                    this._chartModel.lineToolsGroupModel().removeLineTools([r]).forEach((e => {
                                        this._invalidateLineToolGroup(e, performance.now(), !0)
                                    }))
                                }
                                void 0 === this._originalLineToolSharingMode.get(t) && this._setOriginalLineToolSharingMode(t, s), this._setOriginalLineToolSharingMode(t, s)
                            }
                        }
                }
                async _applyLineToolsAndGroupsDTO(e, t, i) {
                    const o = this._chartModel.chartSaveTime(),
                        ...
                        r = new Set;
                    return (e.sources || new Map).forEach((e => {
                        e && r.add(e.state.type)
                    })), await Promise.all(Array.from(r).map((e => (0, S.initLineTool)(e)))), (0, g.perfMeasureOperation)(n, (() => this._withoutInvalidating((() => {
                        this._chartModel.bulkActionMacro((() => {
                            (e.sources || new Map).forEach(((e, n) => {
                                try {
                                    if (e && (0, O.isMtpPredictorToolName)(e.state.type)) return void G.logWarn(`No longer supported tool ${e.state.type} is skipped while restoring state`);
                                    this._restoreLineDTO(e, n, s, o, t, i)
                                } catch (t) {
                                    G.logError(`Error restoring line tool ${n} (${e?.state.type}): ${t}`), e ? .state.type && !r.has(e.state.type) && G.logError(`Line tool ${e.state.type} may need to be initialised first`)
                                }
                ...
                _invalidateLineToolOrStudyStub(e, t, i) {
                    ...
                    }), this._hasChanges.setValue(!0), this._debouncedSave()
                }
                        ...
                        if (!A(l))
                            if (null === l) {
                                ...
                                if (r) {
                                    ...
                                    }(l, this._chartModel)), null !== e && s.set(e.id, D(e, this._chartModel));
                                    else {
                ...
                _loadAndMergeLineToolsOnStudies(e, t) {
                    ...
                    this._makeLoadRequestAndMerge(i, (i => {
                        const s = t ? u(Array.from(this._allLineToolsAndStudyStubs.values()).map((e => Array.from(e.keys())))).filter((e => !i(e))) : [];
