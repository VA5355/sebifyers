(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
    [5789], {
        ...
        865266: (e, t, n) => {
            ...
            function a(e, t = []) {
                const [n, a] = (0, o.useState)(!1), i = (0, r.useFunctionalRefObject)(e);
            ...
            function m(e) {
                ...
                return (0, o.useLayoutEffect)((() => {
                    const e = (0, r.ensureNotNull)(t.current),
                        n = () => {
                            const n = (0, a.queryTabbableElements)(e).sort(a.navigationOrderComparator);
                            if (0 === n.length || n[0].parentElement && !h(n[0].parentElement, (0, r.ensureNotNull)(t.current))) {
                                const o = function(e) {
                                    const n = v(e).sort(a.navigationOrderComparator),
                                        o = n.find((e => h(e, (0, r.ensureNotNull)(t.current))));
                                    if (!o) return null;
                                ...
                                if (null === o) return;
                                if ((0, l.becomeMainElement)(o), n.length > 0)
                    ...
                    if (e) {
                        ...
                        l = e ? Array.from(e.children) : [], m = l.indexOf(o)
                    } else l = (h = r, Array.from(h.querySelectorAll("button:not([disabled]):not([aria-disabled])")).filter((0, c.createScopedVisibleElementFilter)(h))).sort(a.navigationOrderComparator), m = l.indexOf(o);
                    var h;
                    if (0 === l.length || -1 === m) return;
                    const p = (0, a.mapKeyCodeToDirection)(n);
                    switch (p) {
                        case "inlinePrev":
                            if (t.preventDefault(), !e && 0 === m) break;
                            d(u(l, m, -1));
                            break;
                        case "inlineNext":
                            if (t.preventDefault(), !e && m === l.length - 1) break;
                            d(u(l, m, 1));
                            break;
                        case "blockPrev":
                        case "blockNext":
                            (n => {
                                ...
                                if (!a) return;
                                const i = Array.from(a.children).indexOf(document.activeElement);
                                if (-1 === i) return;
                                const l = o["blockNext" === n ? o.indexOf(a) + 1 : o.indexOf(a) - 1];
                                if (!l) return;
                                t.preventDefault();
                                const c = Array.from(l.children);
                                c.length && (!e && i <= c.length - 1 ? d(c[i]) : d(c[0]))
                            })(p)
                    }
                }]
            }
        ...
        611005: (e, t, n) => {
            ...
            const g = ["😀", "😃", "😄", "😁", "😆", "😅", "😂", "🤣", "☺️", "😊", "😇", "🙂", "🙃", "😉", "😌", "😍", "🥰", "😘", "😗", "😙", "😚", "😋", "😛", "😝", "😜", "🤪", "🤨", "🧐", "🤓", "😎", "🤩", "🥳", "😏", "😒", "😞", "😔", "😟", "😕", "🙁", "☹️", "😣", "😖", "😫", "😩", "🥺", "😢", "😭", "😤", "😠", "😡", "🤬", "🤯", "😳", "🥵", "🥶", "😱", "😨", "😰", "😥", "😓", "🤗", "🤔", "🤭", "🤫", "🤥", "😶", "😐", "😑", "😬", "🙄", "😯", "😦", "😧", "😮", "😲", "🥱", "😴", "🤤", "😪", "😵", "🤐", "🥴", "🤢", "🤮", "🤧", "😷", "🤒", "🤕", "🤑", "🤠", "😈", "👿", "👹", "👺", "🤡", "💩", "👻", "💀", "☠️", "👽", "👾", "🤖", "🎃", "😺", "😸", "😹", "😻", "😼", "😽", "🙀", "😿", "😾", "👋", "🤚", "🖐", "✋", "🖖", "👌", "🤏", "✌️", "🤞", "🤟", "🤘", "🤙", "👈", "👉", "👆", "🖕", "👇", "☝️", "👍", "👎", "✊", "👊", "🤛", "🤜", "👏", "🙌", "👐", "🤲", "🤝", "🙏", "✍️", "💅", "🤳", "💪", "🦾", "🦵", "🦿", "🦶", "👂", "🦻", "👃", "🧠", "🦷", "🦴", "👀", "👁", "👅", "👄", "💋", "🩸", "👶", "🧒", "👦", "👧", "🧑", "👱", "👨", "🧔", "👨‍🦰", "👨‍🦱", "👨‍🦳", "👨‍🦲", "👩", "👩‍🦰", "🧑‍🦰", "👩‍🦱", "🧑‍🦱", "👩‍🦳", "🧑‍🦳", "👩‍🦲", "🧑‍🦲", "👱‍♀️", "👱‍♂️", "🧓", "👴", "👵", "🙍", "🙍‍♂️", "🙍‍♀️", "🙎", "🙎‍♂️", "🙎‍♀️", "🙅", "🙅‍♂️", "🙅‍♀️", "🙆", "🙆‍♂️", "🙆‍♀️", "💁", "💁‍♂️", "💁‍♀️", "🙋", "🙋‍♂️", "🙋‍♀️", "🧏", "🧏‍♂️", "🧏‍♀️", "🙇", "🙇‍♂️", "🙇‍♀️", "🤦", "🤦‍♂️", "🤦‍♀️", "🤷", "🤷‍♂️", "🤷‍♀️", "🧑‍⚕️", "👨‍⚕️", "👩‍⚕️", "🧑‍🎓", "👨‍🎓", "👩‍🎓", "🧑‍🏫", "👨‍🏫", "👩‍🏫", "🧑‍⚖️", "👨‍⚖️", "👩‍⚖️", "🧑‍🌾", "👨‍🌾", "👩‍🌾", "🧑‍🍳", "👨‍🍳", "👩‍🍳", "🧑‍🔧", "👨‍🔧", "👩‍🔧", "🧑‍🏭", "👨‍🏭", "👩‍🏭", "🧑‍💼", "👨‍💼", "👩‍💼", "🧑‍🔬", "👨‍🔬", "👩‍🔬", "🧑‍💻", "👨‍💻", "👩‍💻", "🧑‍🎤", "👨‍🎤", "👩‍🎤", "🧑‍🎨", "👨‍🎨", "👩‍🎨", "🧑‍✈️", "👨‍✈️", "👩‍✈️", "🧑‍🚀", "👨‍🚀", "👩‍🚀", "🧑‍🚒", "👨‍🚒", "👩‍🚒", "👮", "👮‍♂️", "👮‍♀️", "🕵", "🕵️‍♂️", "🕵️‍♀️", "💂", "💂‍♂️", "💂‍♀️", "👷", "👷‍♂️", "👷‍♀️", "🤴", "👸", "👳", "👳‍♂️", "👳‍♀️", "👲", "🧕", "🤵", "👰", "🤰", "🤱", "👼", "🎅", "🤶", "🦸", "🦸‍♂️", "🦸‍♀️", "🦹", "🦹‍♂️", "🦹‍♀️", "🧙", "🧙‍♂️", "🧙‍♀️", "🧚", "🧚‍♂️", "🧚‍♀️", "🧛", "🧛‍♂️", "🧛‍♀️", "🧜", "🧜‍♂️", "🧜‍♀️", "🧝", "🧝‍♂️", "🧝‍♀️", "🧞", "🧞‍♂️", "🧞‍♀️", "🧟", "🧟‍♂️", "🧟‍♀️", "💆", "💆‍♂️", "💆‍♀️", "💇", "💇‍♂️", "💇‍♀️", "🚶", "🚶‍♂️", "🚶‍♀️", "🧍", "🧍‍♂️", "🧍‍♀️", "🧎", "🧎‍♂️", "🧎‍♀️", "🧑‍🦯", "👨‍🦯", "👩‍🦯", "🧑‍🦼", "👨‍🦼", "👩‍🦼", "🧑‍🦽", "👨‍🦽", "👩‍🦽", "🏃", "🏃‍♂️", "🏃‍♀️", "💃", "🕺", "🕴", "👯", "👯‍♂️", "👯‍♀️", "🧖", "🧖‍♂️", "🧖‍♀️", "🧑‍🤝‍🧑", "👭", "👫", "👬", "💏", "👨‍❤️‍💋‍👨", "👩‍❤️‍💋‍👩", "💑", "👨‍❤️‍👨", "👩‍❤️‍👩", "👪", "👨‍👩‍👦", "👨‍👩‍👧", "👨‍👩‍👧‍👦", "👨‍👩‍👦‍👦", "👨‍👩‍👧‍👧", "👨‍👨‍👦", "👨‍👨‍👧", "👨‍👨‍👧‍👦", "👨‍👨‍👦‍👦", "👨‍👨‍👧‍👧", "👩‍👩‍👦", "👩‍👩‍👧", "👩‍👩‍👧‍👦", "👩‍👩‍👦‍👦", "👩‍👩‍👧‍👧", "👨‍👦", "👨‍👦‍👦", "👨‍👧", "👨‍👧‍👦", "👨‍👧‍👧", "👩‍👦", "👩‍👦‍👦", "👩‍👧", "👩‍👧‍👦", "👩‍👧‍👧", "🗣", "👤", "👥", "👣"],
                ...
                E = ["🍏", "🍎", "🍐", "🍊", "🍋", "🍌", "🍉", "🍇", "🍓", "🍈", "🍒", "🍑", "🥭", "🍍", "🥥", "🥝", "🍅", "🍆", "🥑", "🥦", "🥬", "🥒", "🌶", "🌽", "🥕", "🧄", "🧅", "🥔", "🍠", "🥐", "🥯", "🍞", "🥖", "🥨", "🧀", "🥚", "🍳", "🧈", "🥞", "🧇", "🥓", "🥩", "🍗", "🍖", "🌭", "🍔", "🍟", "🍕", "🥪", "🥙", "🧆", "🌮", "🌯", "🥗", "🥘", "🥫", "🍝", "🍜", "🍲", "🍛", "🍣", "🍱", "🥟", "🦪", "🍤", "🍙", "🍚", "🍘", "🍥", "🥠", "🥮", "🍢", "🍡", "🍧", "🍨", "🍦", "🥧", "🧁", "🍰", "🎂", "🍮", "🍭", "🍬", "🍫", "🍿", "🍩", "🍪", "🌰", "🥜", "🍯", "🥛", "🍼", "☕️", "🍵", "🧃", "🥤", "🍶", "🍺", "🍻", "🥂", "🍷", "🥃", "🍸", "🍹", "🧉", "🍾", "🧊", "🥄", "🍴", "🍽", "🥣", "🥡", "🥢", "🧂"],
                b = ["⚽️", "🏀", "🏈", "⚾️", "🥎", "🎾", "🏐", "🏉", "🥏", "🎱", "🪀", "🏓", "🏸", "🏒", "🏑", "🥍", "🏏", "🥅", "⛳️", "🪁", "🏹", "🎣", "🤿", "🥊", "🥋", "🎽", "🛹", "🛷", "⛸", "🥌", "🎿", "⛷", "🏂", "🪂", "🏋️", "🏋️‍♂️", "🏋️‍♀️", "🤼", "🤼‍♂️", "🤼‍♀️", "🤸‍♀️", "🤸", "🤸‍♂️", "⛹️", "⛹️‍♂️", "⛹️‍♀️", "🤺", "🤾", "🤾‍♂️", "🤾‍♀️", "🏌️", "🏌️‍♂️", "🏌️‍♀️", "🏇", "🧘", "🧘‍♂️", "🧘‍♀️", "🏄", "🏄‍♂️", "🏄‍♀️", "🏊", "🏊‍♂️", "🏊‍♀️", "🤽", "🤽‍♂️", "🤽‍♀️", "🚣", "🚣‍♂️", "🚣‍♀️", "🧗", "🧗‍♂️", "🧗‍♀️", "🚵", "🚵‍♂️", "🚵‍♀️", "🚴", "🚴‍♂️", "🚴‍♀️", "🏆", "🥇", "🥈", "🥉", "🏅", "🎖", "🏵", "🎗", "🎫", "🎟", "🎪", "🤹", "🤹‍♂️", "🤹‍♀️", "🎭", "🎨", "🎬", "🎤", "🎧", "🎼", "🎹", "🥁", "🎷", "🎺", "🎸", "🪕", "🎻", "🎲", "🎯", "🎳", "🎮", "🎰", "🧩"],
                z = ["🚗", "🚕", "🚙", "🚌", "🚎", "🏎", "🚓", "🚑", "🚒", "🚐", "🚚", "🚛", "🚜", "🦯", "🦽", "🦼", "🛴", "🚲", "🛵", "🏍", "🛺", "🚨", "🚔", "🚍", "🚘", "🚖", "🚡", "🚠", "🚟", "🚃", "🚋", "🚞", "🚝", "🚄", "🚅", "🚈", "🚂", "🚆", "🚇", "🚊", "🚉", "✈️", "🛫", "🛬", "🛩", "💺", "🛰", "🚀", "🛸", "🚁", "🛶", "⛵️", "🚤", "🛥", "🛳", "⛴", "🚢", "⚓️", "⛽️", "🚧", "🚦", "🚥", "🚏", "🗺", "🗿", "🗽", "🗼", "🏰", "🏯", "🏟", "🎡", "🎢", "🎠", "⛲️", "⛱", "🏖", "🏝", "🏜", "🌋", "⛰", "🏔", "🗻", "🏕", "⛺️", "🏠", "🏡", "🏘", "🏚", "🏗", "🏭", "🏢", "🏬", "🏣", "🏤", "🏥", "🏦", "🏨", "🏪", "🏫", "🏩", "💒", "🏛", "⛪️", "🕌", "🕍", "🛕", "🕋", "⛩", "🛤", "🛣", "🗾", "🎑", "🏞", "🌅", "🌄", "🌠", "🎇", "🎆", "🌇", "🌆", "🏙", "🌃", "🌌", "🌉", "🌁"],
            ...
            function k(e) {
                const t = (0, a.getFirstSegmentOrCodePointString)(e),
                    n = null !== t && I(t) ? t : "";
                return {
                    emoji: n,
                    emojiLessString: e.replace(n, "")
                }
            }

            function A(e, t, ...n) {
                const o = k((0, i.ensureNotNull)(e)).emojiLessString.trim(),
                    r = k((0, i.ensureNotNull)(t)).emojiLessString.trim();
            ...
            const S = () => [{
                ...
                emojis: [],
                content: o.createElement(l.IconItem, {
                    icon: c
                })
            }, {
                title: r.t(null, {
        ...
        198412: (e, t, n) => {
            ...
            function v(e) {
                ...
                if (t === s.EMPTY_EMOJI) return o.createElement(i.Icon, {
                    className: a()(r, m.clearButton, "apply-common-tooltip"),
                    icon: u,
                    title: l.t(null, void 0, n(647550))
                });
                const v = (0, c.getTwemojiUrl)(t, "png");
                return o.createElement("img", {
                    className: a()(r, m.emoji),
                    src: v,
                    decoding: "async",
                    width: "24",
                    height: "24",
        ...
        168233: (e, t, n) => {
            ...
            function f(e) {
                ...
                (0, o.useEffect)((() => t.current ? .resetAfterIndex(0, !0)), [a]);
                const w = (0, o.useCallback)((e => "title" === a[e].type ? d : i), [a, i]),
                    E = (0, o.useCallback)((({
                        visibleStartIndex: e
                    }) => {
                        const {
                    ...
                    b = Math.min(f - h, window.innerHeight - h);
            ...
            const g = o.memo((e => {
                ...
                } = (0, m.useEnsuredContext)(p);
                return "title" === a.type ? o.createElement("div", {
                    style: t
                }, o.createElement(c, {
        ...
        499547: (e, t, n) => {
            ...
            function d(e) {
                const {
                    ...
                    category: g,
                    emojiSize: w = h
                } = e, E = (0, o.useRef)(null), b = (0, o.useRef)(!1), [z, x] = (0, m.useRowsNavigation)(), [C, j] = (0, o.useState)(0), y = (0, o.useMemo)((() => function(e, t) {
                    if (0 === t) return [];
                    const n = [];
                    return e.forEach((({
                        title: e,
                        ...
                        let r = [];
                        for (const a of o) r.length < t ? r.push(a) : (n.push({
                            type: "emojiRow",
                            relatedTitle: e,
                            content: r
                        }), r = [a]);
                ...
                }(n, C)), [n, C]), M = (0, i.useResizeObserver)((function(e) {
                    const [t] = e, {
                        width: n
                    } = t.contentRect, o = Math.floor((n - v) / w);
                    j(o)
                }), [w]);
                (0, o.useEffect)((() => {
                    y.length && A(0)
                }), [g]);
                const [N, I] = (0, o.useState)(y[0] ? .relatedTitle || ""), k = (0, o.useCallback)((e => {
                    b.current || I(e)
                }), []);
                return o.createElement("div", {
                ...
                function A(e) {
                    s.CheckMobile.iOS() && z.current && (z.current.style.overflow = "hidden"), b.current = !0, E.current ? .scrollToItem(e, "start"), requestAnimationFrame((() => {
                        E.current ? .scrollToItem(e, "start"), s.CheckMobile.iOS() && z.current && (z.current.style.overflow = "auto"), b.current = !1
                    }))
                }
            }
        },
        723407: (e, t, n) => {
            ...
            const c = o.memo((e => {
                ...
                }, t.map((e => o.createElement(i.EmojiWrap, {
                    key: e,
        ...
        65559: (e, t, n) => {
            ...
            function s(e) {
                const {
                    ...
                    children: i,
                    className: s
                } = e, [m, u] = (0, l.useRovingTabindexElement)(null);
            ...
            function u(e) {
                ...
                return o.createElement(i.Toolbar, {
        ...
        994437: (e, t, n) => {
            ...
            function m(e) {
                const {
                    ...
                    size: r = s,
                    onClick: m,
                    ItemComponent: u = i.EmojiItem
                } = e, [v, h] = (0, l.useRovingTabindexElement)(null);
                return o.createElement("button", {
                    ref: v,
                    tabIndex: h,
                    onClick: function() {
                    ...
                    className: a()(c.button, c.wrapper, t),
                    type: "button"
                }, o.createElement(u, {
                    emoji: n
                }))
        ...
        602069: (e, t, n) => {
            ...
            const u = (0, o.forwardRef)((function(e, t) {
                const {
                    ...
                    blurOnClick: h = !0,
                    ...d
                } = e, p = (0, s.useFunctionalRefObject)(t);
                return (0, o.useLayoutEffect)((() => {
                ...
                }), []), o.createElement("div", { ...m.MouseClickAutoBlurHandler.attributes(h),
                    ...d,
                    role: "toolbar",
                    "aria-orientation": u,
                    ref: p,
        ...
        278765: (e, t, n) => {
            ...
            function r(e, t) {
                let n = "";
                return o.default.parse(e, (e => (n = o.default.base + ("svg" === t ? `svg/${e}.svg` : `72x72/${e}.png`), !1))), n
            }
